...
Deprecation Summary
*******************
- The Model Deployment interface has been deprecated and will be removed in 2.13, in order to allow
  the interface to mature.  The raw API will continue to be available as a "beta" API without full
...
- Some models now have Missing Value reports allowing users with access to uncensored blueprints to
  ...
  report.
- Time series projects now support multiseries as well as single series data.  See the
  :ref:`multiseries <multiseries>` section in the Time Series Projects documentation for more
  detail.
...
API Changes
***********
- New attributes supporting monotonic constraints have been added to the :py:class:`AdvancedOptions`, :py:class:`Project`, :py:class:`Model`, and :py:class:`Blueprint` classes. See :ref:`monotonic constraints<monotonic_constraints>` for more information on how to configure monotonic constraints.
- New parameters `predictions_start_date` and `predictions_end_date` added to
  :py:meth:`datarobot.models.Project.upload_dataset` to support bulk predictions upload for
...
- :py:meth:`datarobot.models.Project.create_from_mysql`,
  ...
  instead.
- :py:attr:`datarobot.FeatureSettings.a_priori` attribute has been deprecated and will be removed
  in 2.14. Use :py:attr:`datarobot.FeatureSettings.known_in_advance` instead.
- :py:attr:`datarobot.DatetimePartitioning.default_to_a_priori` attribute has been deprecated and
  will be removed in 2.14. Use :py:attr:`datarobot.DatetimePartitioning.known_in_advance` instead.
- :py:attr:`datarobot.DatetimePartitioningSpecification.default_to_a_priori` attribute has been
  deprecated and will be removed in 2.14.
  Use :py:attr:`datarobot.DatetimePartitioningSpecification.known_in_advance` instead.
