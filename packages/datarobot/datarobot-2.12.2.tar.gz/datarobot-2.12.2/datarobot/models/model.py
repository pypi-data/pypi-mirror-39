...
from ..enums import MONOTONICITY_FEATURELIST_DEFAULT
...
class Model(APIObject):
    ...
    supports_monotonic_constraints : bool
        optinonal, whether this model supports enforcing montonic constraints
    """
    ...
    def get_all_confusion_charts(self):
        ...
        response_data = self._client.get(url).json()
        return [ConfusionChart.from_server_data(lc_data) for lc_data in response_data['charts']]
    ...
    def get_missing_report_info(self):
        ...
        The report explains for numeric and categorical features how many times they were missing
        in the training data and how various tasks in the model handled the missing values.
