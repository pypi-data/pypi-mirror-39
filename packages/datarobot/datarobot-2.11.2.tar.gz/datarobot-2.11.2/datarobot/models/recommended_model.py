...
class ModelRecommendation(APIObject):
    ...
    _base_recommended_path_template = 'project/{}/recommendedModels/'
    _converter = t.Dict({
    ...
    def __repr__(self):
        return encode_utf8_if_py2(u'ModelRecommendation({}, {}, {})'.format(
            self.project_id,
            self.model_id,
    ...
    def get(cls, project_id):
        """
        Retrieves the simplest recommended model available.
