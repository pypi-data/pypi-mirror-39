...
import pytest
import responses
from datarobot import Job, ModelJob, Project, Blueprint, errors
...
class TestJobModel(SDKTestcase):
    ...
    mock_generic_job_data_completed = dict(mock_generic_job_data_inprogress,
                                           status='COMPLETED')
    ...
    def test_get_model_success(self):
        ...
        responses.add(
            responses.GET,
            self.final_model_location,
            status=200,
            body=self.fully_trained_model
        )
