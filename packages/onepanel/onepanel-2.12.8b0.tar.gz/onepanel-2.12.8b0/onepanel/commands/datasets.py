...
@click.option('-r', '--continue_listening', type=str, help='If true, thread will continue listening for \
                    new datset mounts. If false, it will stop as soon as there are no more to download.')
