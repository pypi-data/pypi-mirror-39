...
chi2pval: Opzionale, se chi2pval=True la funzione ritorna in ordine: parametri ottimali, matrice di 		covarianza, errori sui parametri, chi2, pvalue. default=False ovvero ritorna solamente parametri 	ottimali e matrice di covarianza
