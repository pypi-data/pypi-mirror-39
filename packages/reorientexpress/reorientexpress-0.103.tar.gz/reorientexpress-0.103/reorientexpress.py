...
if __name__ == '__main__':
	...
	parser.add_argument('-train', default = False, action = 'store_true', 
		help = 'Set true if you want to train a model.')
	parser.add_argument('-test', default = False, action = 'store_true', 
		help = 'Set true if you want to test a model.')
	parser.add_argument('-predict', default = False, action = 'store_true', 
		help = 'Set true if you want to use a model to make predictions')
	...
	parser.add_argument('-output', '--o', action = 'store', default = 'output',
		help = 'Where to store the outputs. Corresponding extensions will be added.')
