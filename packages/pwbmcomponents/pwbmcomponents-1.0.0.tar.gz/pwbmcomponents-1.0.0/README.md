...
1. Fork this repo
2. Find-and-replace:
    1. `pwbmcomponents` with your component library name.
    2. `pwbmcomponents` with your component library name.
    3. `Nick Janetos` with your name and `njanetos@wharton.upenn.edu` with your email address
    4. `MIT` with your license (e.g. `MIT`)
    5. Rename the folder `pwbmcomponents/` with your component library name
...
7. Create a production build and publish:
    ...
    ```
    pip install pwbmcomponents-0.0.1.tar.gz
    ```
...
# More details
- Include CSS files in your distribution folder (`pwbmcomponents`) and reference them in `MANIFEST.in`
