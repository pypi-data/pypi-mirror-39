...
Classes:\n
    DeviceProfile - Data class for storing device profile information
                    (a.k.a. SEP data).\n
    DeviceProfileList - List of DeviceProfiles.\n
    DeviceProfilePersistorBase - Abstract class used to load and save
                                 device profiles.\n
        DeviceProfilePersistorAesGcmFile - Key protected file persistor.\n
        DeviceProfilePersistorDefault - Platform default persistor.\n
        DeviceProfilePersistorPasswordFile - Password protected file
                                             persistor.\n
        DeviceProfilePersistorPlaintextFile - Unprotected file
                                              persistor.\n
    KeyAttributesDict - Default Dictionary of string Attribute names
                        with lists of string values.\n
    KeyData - Defines a data protection key as returned by Ionic.com.\n
    KeyDataList - List of KeyData with search functionality.\n
    MetadataDict - Dictionary of string to string data sent along with
                   HTTP requests.\n
"""
...
class DeviceProfileList(list):
    ...
    def SaveAllProfiles(self, devicePersistor):
        ...
        return _private.cLib.ionic_save_all_device_profiles(devicePersistor._cPersistor, cProfileArray, cNumProfiles, cActiveDeviceId)
