...
def label_subplots(fig, size=14):
	'''Adds letter labels to all subplots in a figureself.
	   Adjusts figure padding and left margin to make labels fitself.
	'''
	allaxes = fig.get_axes()
	sub_labels = gen_sub_label(paren=True)
	for ax in allaxes:
