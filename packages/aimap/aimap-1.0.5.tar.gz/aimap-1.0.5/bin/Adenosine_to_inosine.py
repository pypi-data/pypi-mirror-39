...
if __name__ == '__main__':
    ...
    if args.model == "paired":
        ...
        os.system(aimap_tools.construct_bwa_mem_single_cmdline(args.genomename, new_file1,args.outdirname,old_file1,args.threads))
        os.system(aimap_tools.construct_bwa_mem_single_cmdline(args.genomename, new_file2,args.outdirname,old_file2,args.threads))
        
        #Step4 Convert sam file to bam file.
        logger.info("Step4 Convert sam file to bam file.")
        insamfile1=args.outdirname+"/"+old_file1+".sam"        
        insamfile2=args.outdirname+"/"+old_file2+".sam"
        os.system(aimap_tools.construct_samtools_view_cmdline(insamfile1,args.outdirname,old_file1,args.threads))
        os.system(aimap_tools.construct_samtools_view_cmdline(insamfile2,args.outdirname,old_file2,args.threads)) 
                        
        #Step5 Sort the bam file.
        logger.info("Step5 Sort the bam file.")
        inbamfile1=args.outdirname+"/"+old_file1+".bam"
        inbamfile2=args.outdirname+"/"+old_file2+".bam"
        os.system(aimap_tools.construct_samtools_sort_cmdline(insamfile1,args.outdirname,old_file1,args.threads))
        os.system(aimap_tools.construct_samtools_sort_cmdline(insamfile2,args.outdirname,old_file2,args.threads))
        
        #Step6 Generate pileup for one or multiple BAM files.
        logger.info("Step6 Generate pileup for one or multiple BAM files.")
        sorted_bamfile1=args.outdirname+"/"+old_file1+"-sorted.bam"
        sorted_bamfile2=args.outdirname+"/"+old_file2+"-sorted.bam"
        os.system(aimap_tools.construct_samtools_mpileup_cmdline(sorted_bamfile1,args.genomename,args.outdirname,old_file1,args.threads))
        os.system(aimap_tools.construct_samtools_mpileup_cmdline(sorted_bamfile2,args.genomename,args.outdirname,old_file2,args.threads))
        
        #Step7 Convert pileup file to table.
        logger.info("Step7 Convert pileup file to table.")
        pileup_file1=args.outdirname+"/"+old_file1+".pileup"
        pileup_file2=args.outdirname+"/"+old_file2+".pileup"
        aimap_tools.convert_pileup_to_table(pileup_file1,args.outdirname,old_file1)
        aimap_tools.convert_pileup_to_table(pileup_file2,args.outdirname,old_file2)
     
        #Step8 Get a_i position.
        logger.info("Step8 Get a_i position.")
        all_info_file1=args.outdirname+"/"+old_file1+"_all_position_info.txt"
        all_info_file2=args.outdirname+"/"+old_file2+"_all_position_info.txt"
        all_info_file_flit=args.outdirname+"/"+args.outfile_name+"_all_info_file_flit.txt"
        aimap_tools.get_a_i_position(all_info_file1,all_info_file2,args.outdirname,args.outfile_name,args.reads_number)
        aimap_tools.get_a_i_map(all_info_file_flit,args.outdirname,args.outfile_name,args.coverage,args.editing_level)
