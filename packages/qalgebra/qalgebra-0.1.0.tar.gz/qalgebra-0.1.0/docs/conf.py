...
extlinks = {
    'issue': ('https://github.com/mabuchilab/qalgebra/issues/%s', '#'),
    'pr': ('https://github.com/mabuchilab/qalgebra/pull/%s', 'PR #'),
}
