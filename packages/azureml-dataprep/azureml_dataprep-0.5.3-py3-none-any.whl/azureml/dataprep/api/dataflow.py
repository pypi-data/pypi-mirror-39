            ...
            * Tuple of :class:`azureml.dataprep.FieldType.DATE` and List of format strings (single format string is also supported)
            ...
            .. note::
                ...
                If you choose to convert a column to :class:`azureml.dataprep.FieldType.DATE` and do not provide **format(s)** to use,
                    DataPrep will attempt to infer a format to use by pulling on the data. If a format could be inferred form the data
                    it will be used to convert values in the corresponding column. However if a format could not be inferred
                    this step will fail and you will need to either provide the format to use or use interactive builder
...
# >>> BEGIN GENERATED METHODS
    ...
    def to_number(self,
                  columns: MultiColumnSelection,
                  decimal_point: typedefinitions.DecimalMark = typedefinitions.DecimalMark.DOT) -> 'Dataflow':
        """
    ...
    def to_bool(self,
                ...
                mismatch_as: typedefinitions.MismatchAsOption = typedefinitions.MismatchAsOption.ASFALSE) -> 'Dataflow':
        """
