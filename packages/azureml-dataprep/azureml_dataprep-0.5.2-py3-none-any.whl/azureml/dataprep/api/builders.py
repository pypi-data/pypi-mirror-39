...
class ColumnTypesBuilder:
    ...
    def conversion_candidates(self) -> Dict[str, InferenceInfo]:
        ...
        .. remarks::
            ...
            * :class:`azureml.dataprep.InferenceInfo` (wraps a List of :class:`CandidateConverter`) - populated based on available data by running :func:`learn`.
            ...
            * Tuple of :class:`azureml.dataprep.FieldType.DATE` and List of format strings (single format string is also supported) - user override for date conversions.
            ...
            .. note::
                ...
                This will be populated automatically with inferred conversion candidates when :func:`azureml.dataprep.api.builders.ColumnTypesBuilder.learn` is called.
                Any modifications made to this dictionary will be discarded any time :func:`azureml.dataprep.api.builders.ColumnTypesBuilder.learn` is called
    ...
    def ambiguous_date_columns(self) -> List[str]:
        ...
        .. remarks::
            ...
            Each of the ambiguous date columns must be resolved before calling :func:`ColumnTypesBuilder.to_dataflow`. There are 3 ways to resolve
                ambiguity:
...
class FileFormatBuilder:
    ...
    :var file_format: Result of file format detection by calling :func:`azureml.dataprep.api.builders.FileFormatBuilder.learn`
    """
    ...
    def learn(self, fileformat_arguments: FileFormatArguments = None) -> None:
        """
        Learn the :func:`azureml.dataprep.api.builders.FiieFormatBuilder.file_format` of the files from the initial Dataflow.
...
class JoinBuilder:
    ...
    .. note::
        ...
        This builder has the ability to detect and suggest potential join arguments. In some cases, the builder can
            derive the join key in one of the Dataflows and use the derived key column to perform a join.
    """
    def __init__(self,
                 engine_api: EngineAPI,
