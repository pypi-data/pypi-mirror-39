...
class Ip2locationWebDB:
    ...
    def get_location(self, ip):
        ...
        try:
            ...
            self.__db_data = Ip2LocationWeb.get(ip)
    ...
    def add_to_map(self):
        ...
        """
        try:
            logger.debug("%s: Calling add_marker method for %s DB" % (__name__, Ip2LocationWeb.__name__))
            self.m.add_marker_commercial(Ip2LocationWeb.__name__, 
