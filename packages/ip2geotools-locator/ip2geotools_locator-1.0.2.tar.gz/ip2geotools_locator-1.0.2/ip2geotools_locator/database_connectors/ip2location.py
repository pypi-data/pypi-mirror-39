...
class Ip2LocationDB:
    ...
    def __init__(self, file_path):
        ...
        if file_path == None:
            logger.critical("%s: Database %s needs DB file!" % (__name__, Ip2Location.__name__))
    ...
    def add_to_map(self):
        ...
        """
        try:
            logger.debug("%s: Calling add_marker method for %s DB" % (__name__, Ip2Location.__name__))
