...
class SkyhookDB:
    ...
    def get_location(self, ip):
        ...
        try:
            ...
            self.__db_data = SkyhookContextAcceleratorIp.get(ip)
    ...
    def add_to_map(self):
        ...
        """
        try:
            logger.debug("%s: Calling add_marker method for %s DB" % (__name__, SkyhookContextAcceleratorIp.__name__))
            self.m.add_marker_commercial(SkyhookContextAcceleratorIp.__name__, 
