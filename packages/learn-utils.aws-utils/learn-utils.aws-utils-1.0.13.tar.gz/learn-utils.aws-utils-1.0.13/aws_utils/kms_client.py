...
class KMSCli(object):
    ...
    def __init__(self, endpoint_url=None, aws_access_key_id=None, aws_secret_access_key=None, region_name="sa-east-1"):
        """
        KMS initializer.
        ...
        *Default*=None
        ...
        :param endpoint_url: the kms endpoint url to be used.
        *DEFAULT*=None
        If default value boto3 will resolve the url endpoint and send all requests to the aws.

        """
        verify = False if endpoint_url is not None else True
