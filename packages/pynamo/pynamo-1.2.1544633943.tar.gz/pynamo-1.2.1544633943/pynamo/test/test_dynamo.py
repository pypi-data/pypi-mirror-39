...
def test_rewrite_same_key():
    ...
    pyn.rewrite_item('simple_table', TEST_KEY, new_item)
...
def test_rewrite_diff_both_key():
    ...
    pyn.rewrite_item('simple_table', TEST_KEY, new_return)
    get_response = pyn.get_item('simple_table', new_key)
...
#     rewrite_response = pyn.rewrite_item('test_table', old_key, new_item)
