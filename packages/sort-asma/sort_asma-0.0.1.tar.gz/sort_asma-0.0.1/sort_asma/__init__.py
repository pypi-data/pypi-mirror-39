...
#If the segement doesn't have the smallest value,add one to the counter. 
    ...
    return(res)
slist = [int(x) for x in input("please enter your list:").split()]#Take the input from the user and convert it into a list.
k= (int(input ("For how many ways would you like the algorithm to run: ")))
