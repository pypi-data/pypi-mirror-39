...
def venn3(labels, names=['A', 'B', 'C'], **options):
    ...
    dpi = options.get('dpi', 96)
    fontsize = options.get('fontsize', 14)
    w_h1 = options.get('w_h1', (0.5,0.5))
    w_h2 = options.get('w_h2', (0.4,0.4))
    w_h3 = options.get('w_h3', (0.2,0.2))
    ...
    # body
    draw_ellipse(fig, ax, 0.333, 0.633, w_h1[0], w_h1[1], 0.0, colors[0])
    draw_ellipse(fig, ax, 0.666-0.1, 0.633, w_h2[0], w_h3[1], 0.0, colors[1])
    draw_ellipse(fig, ax, 0.500, 0.310+0.2, w_h2[0], w_h3[1], 0.0, colors[2])
