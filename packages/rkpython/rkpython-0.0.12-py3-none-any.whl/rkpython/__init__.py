...
class csv_info:
    ...
    def __init__(self, file):
        ...
        with open(file, 'rb') as f:
            ...
            self.dialect = csv.Sniffer().sniff(self.rawdata[:2048].decode(self.encoding))
            ...
            self.columns = self.rawdata.decode(self.encoding).split(self.lineterminator)[0].split(self.separator)
