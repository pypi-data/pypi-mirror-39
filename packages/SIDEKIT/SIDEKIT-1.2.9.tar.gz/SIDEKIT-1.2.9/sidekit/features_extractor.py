...
def _add_noise(signal, noise_file_name, snr):
    """
    ...
    """
    # Open noise file
    noise, fs_noise = read_audio(noise_file_name)
...
class FeaturesExtractor(object):
    ...
    def extract(self, show, channel,
        ...
        if noise_file_name is not None:
            signal[:, channel] = _add_noise(signal[:, channel], noise_file_name, snr)
