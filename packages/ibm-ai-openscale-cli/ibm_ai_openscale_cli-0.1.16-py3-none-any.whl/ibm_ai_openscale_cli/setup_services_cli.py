...
from ibm_ai_openscale_cli.cloud_foundry_cli import getCFInstanceCredentials
from ibm_ai_openscale_cli.resource_controller_cli import getRCInstanceCredentials
