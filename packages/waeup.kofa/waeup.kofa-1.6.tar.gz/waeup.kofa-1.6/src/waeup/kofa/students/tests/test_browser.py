# -*- coding: utf-8 -*-
## $Id: test_browser.py 14896 2017-11-13 15:24:34Z henrik $
##
...
class StudentUITests(StudentsFullSetup):
    ...
    def test_student_ticket_update(self):
        ...
        self.assertTrue(
            ...
            'K1000000 - course tickets invalidated: COURSE1'
            in logcontent)
        return
...
class StudentDataExportTests(StudentsFullSetup, FunctionalAsyncTestCase):
    ...
    def test_datacenter_export_selected(self):
        ...
        self.assertTrue(
            ...
            'officer_comment,perm_address,personal_updated,phone,reg_number,'
            'sex,student_id,suspended,suspended_comment,transcript_comment,'
    ...
    def test_certificate_export(self):
        ...
        self.assertTrue(
            ...
            '- exported: students (2004, 100, None, None, None, CERT1, None, None), '
            'job_id=%s'
            % job_id in logcontent
            )
        self.assertTrue(
