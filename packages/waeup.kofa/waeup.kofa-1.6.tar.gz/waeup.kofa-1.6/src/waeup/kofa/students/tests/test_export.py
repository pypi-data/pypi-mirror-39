## $Id: test_export.py 14984 2018-04-05 15:30:08Z henrik $
##
...
class StudentStudyLevelExporterTest(StudentImportExportSetup):
    ...
    def test_export(self):
        ...
        self.assertEqual(
            ...
            'validated_by,validation_date,'
            'student_id,number_of_tickets,certcode\r\n'
            '0.00,100,2012,A,100,,,A111111,1,CERT1\r\n'
            )
        return
...
class CourseTicketExporterTest(StudentImportExportSetup):
    ...
    def test_export_empty(self):
        ...
        self.assertEqual(
            ...
            'mandatory,outstanding,passmark,score,semester,title,student_id,certcode,'
            'display_fullname\r\n'
            '0,0,,,,,,,,0,0,,,,,,,\r\n'
            )
        return
    ...
    def test_export_filtered(self):
        ...
        # We can set the course tickets level and level_session without code
...
class StudentUnpaidPaymentExporterTest(StudentImportExportSetup):

    layer = FunctionalLayer

    def setUp(self):
        super(StudentUnpaidPaymentExporterTest, self).setUp()
        self.setup_for_export()
        return
    ...
    def test_export_all(self):
        ...
        # set values we can expect in export file
        self.setup_student(self.student)
        exporter = StudentUnpaidPaymentExporter()
        exporter.export_all(self.app, self.outfile)
        result = open(self.outfile, 'rb').read()
