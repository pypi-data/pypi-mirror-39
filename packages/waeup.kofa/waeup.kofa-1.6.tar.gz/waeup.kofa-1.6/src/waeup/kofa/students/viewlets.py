## $Id: viewlets.py 14158 2016-09-05 08:31:02Z henrik $
##
...
from waeup.kofa.students.browser import (
    ...
    PaymentsManageFormPage, StudyCourseTranscriptPage, EditScoresPage)
...
class StudentPassportActionButton(ManageActionButton):
    ...
    @property
    def target_url(self):
        PORTRAIT_CHANGE_STATES = getUtility(
            IStudentsUtils).PORTRAIT_CHANGE_STATES
