...
def load_icd9to10():
    icd9to10 = pd.read_csv(pkg_resources.resource_string(__name__,'2018_I9gem.txt'),delim_whitespace=True,header=None,dtype=str)
...
#https://www.cms.gov/Medicare/Coding/ICD10/2018-ICD-10-CM-and-GEMs.html
def load_icd10to9():
    icd10to9 = pd.read_csv(pkg_resources.resource_string(__name__,'2018_I10gem.txt'),delim_whitespace=True,header=None,dtype=str)
...
def load_cci9():
    cci9 = pd.read_csv(pkg_resources.resource_string(__name__,'cci2015.csv'),skiprows=1)
...
def load_cci10():
    ...
    cci10 = pd.read_csv(pkg_resources.resource_string(__name__,'cci_icd10cm_2019_1.csv'))
...
def load_ccs9():
    ccs9 = pd.read_csv(pkg_resources.resource_string(__name__,'$dxref 2015.csv'))
    ...
    ccs9 = ccs9.iloc[:,0:4]    
    ccs9_labels = pd.read_csv(pkg_resources.resource_string(__name__,'dxlabel 2015.csv'))
...
def load_ccs10():
    ccs10 = pd.read_csv(pkg_resources.resource_string(__name__,'ccs_dx_icd10cm_2019_1.csv'))
