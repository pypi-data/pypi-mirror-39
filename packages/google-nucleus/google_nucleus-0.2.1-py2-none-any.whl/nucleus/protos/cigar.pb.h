...
#ifndef PROTOBUF_INCLUDED_nucleus_2fprotos_2fcigar_2eproto
#define PROTOBUF_INCLUDED_nucleus_2fprotos_2fcigar_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_nucleus_2fprotos_2fcigar_2eproto 

namespace protobuf_nucleus_2fprotos_2fcigar_2eproto {
...
class CigarUnit : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nucleus.genomics.v1.CigarUnit) */ {
 public:
  CigarUnit();
  virtual ~CigarUnit();
 ...
 private:
  ...
  friend struct ::protobuf_nucleus_2fprotos_2fcigar_2eproto::TableStruct;
};
// ===================================================================
...
inline ::std::string* CigarUnit::unsafe_arena_release_reference_sequence() {
  // @@protoc_insertion_point(field_unsafe_arena_release:nucleus.genomics.v1.CigarUnit.reference_sequence)
...
inline void CigarUnit::unsafe_arena_set_allocated_reference_sequence(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:nucleus.genomics.v1.CigarUnit.reference_sequence)
}
...
#endif  // PROTOBUF_INCLUDED_nucleus_2fprotos_2fcigar_2eproto
