...
#ifndef PROTOBUF_INCLUDED_nucleus_2fprotos_2fposition_2eproto
#define PROTOBUF_INCLUDED_nucleus_2fprotos_2fposition_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_nucleus_2fprotos_2fposition_2eproto 

namespace protobuf_nucleus_2fprotos_2fposition_2eproto {
...
class Position : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nucleus.genomics.v1.Position) */ {
 public:
  Position();
  virtual ~Position();
 ...
 private:
  ...
  friend struct ::protobuf_nucleus_2fprotos_2fposition_2eproto::TableStruct;
};
// ===================================================================
...
inline ::std::string* Position::unsafe_arena_release_reference_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:nucleus.genomics.v1.Position.reference_name)
...
inline void Position::unsafe_arena_set_allocated_reference_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:nucleus.genomics.v1.Position.reference_name)
}
...
#endif  // PROTOBUF_INCLUDED_nucleus_2fprotos_2fposition_2eproto
