...
class ConfigTest(ConfigBase):
    DB_URL_DIC = {
        ConfigBase.DB_SCHEMA_MD: 'mysql://mg:Dcba1234@localhost/' + ConfigBase.DB_SCHEMA_MD,
        ConBase.DB_SCHEMA_IBATS: 'mysql://mg:Dcba1234@localhost/' + ConBase.DB_SCHEMA_IBATS,
    }
