...
class FileValidationTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.smaller_than_10b_s3 = [cls.rel_path_test_data_s3 + "/" + file for file in cls.smaller_than_10b]
        cls.between_1kb_10b_s3 = [cls.rel_path_test_data_s3 + "/" + file for file in cls.between_1kb_10b]
        cls.larger_than_1kb_s3 = [cls.rel_path_test_data_s3 + "/" + file for file in cls.larger_than_1kb]
    ...
    def test_non_existent_bucket(self):
        ...
        with self.assertRaises(FileValidationException):
            obj.run_validator(path="s3://bucket-that-should-not-be/path-that-also-shouldnt-exist", glob_pattern="*")
    ...
    def test_link_with_double_slash_in_path(self):
        ...
        obj = FileValidation()
        with self.assertRaises(FileValidationException):
            obj.run_validator("s3://{}/something//something".format(self.s3loc.bucket))
    #
    ...
    def test_fails_with_appended_slash_on_url_or_with_prepending_glob_pattern(self):
