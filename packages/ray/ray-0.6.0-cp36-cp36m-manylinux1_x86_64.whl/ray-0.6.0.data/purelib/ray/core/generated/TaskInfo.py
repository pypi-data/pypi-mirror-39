...
def TaskInfoAddActorId(builder, actorId): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(actorId), 0)
def TaskInfoAddActorHandleId(builder, actorHandleId): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(actorHandleId), 0)
def TaskInfoAddActorCounter(builder, actorCounter): builder.PrependInt32Slot(8, actorCounter, 0)
def TaskInfoAddIsActorCheckpointMethod(builder, isActorCheckpointMethod): builder.PrependBoolSlot(9, isActorCheckpointMethod, 0)
def TaskInfoAddFunctionId(builder, functionId): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(functionId), 0)
