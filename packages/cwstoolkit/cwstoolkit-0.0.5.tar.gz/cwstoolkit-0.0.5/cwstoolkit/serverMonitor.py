...
if __name__ == '__main__':
	server = Server()
	server.threshold=1
	server.processname = 'ks-home-service'


	disk = server.checkDisk()
	print(disk)
	cpu  = server.checkCpu()
	print(cpu)
	memory = server.checkMemory()
	print(memory)
	load5 = server.checkLoad5()

	server_load = Server()
	server_load.threshold = 5
	load = server_load.checkLoad5()
	if load:
	    print('has value')
	print(load)
