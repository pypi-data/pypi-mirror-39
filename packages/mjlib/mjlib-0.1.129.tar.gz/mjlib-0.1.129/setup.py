...
setup(
    ...
    version='0.1.129',  # Start with a small number and increase it with every change you make
    ...
    download_url='https://github.com/mgroth0/matt_py_tools/releases/tag/0.1.129',  # I explain this later on
