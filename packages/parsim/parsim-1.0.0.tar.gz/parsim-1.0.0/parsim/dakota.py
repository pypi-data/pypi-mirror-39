...
def psm_dakota_driver():
    ...
    case = Case(project, case_name, study=study)
    case.create(template_path, user_parameters=user_parameters, caselist_parameters=dakota.var_dict)
