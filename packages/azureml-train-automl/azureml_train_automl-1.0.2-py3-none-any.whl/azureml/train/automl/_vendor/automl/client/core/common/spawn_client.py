...
def run_in_proc(timeout, f, args, **kwargs):
    """
    Invokes the specified function with the specified arguments in a separate
    process.
    """
    try:
        ...
        def create_file(name):
            """
            Creates a file that can be used for inter-process communication.
            """
