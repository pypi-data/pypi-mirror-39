...
class _AdbAutomlExperiment():
    ...
    def _create_client(self, client_type):
        authentication = AzureMlTokenAuthentication(self.aml_token)
    ...
    def _refresh_aml_token(self):
        ...
        try:
            token_obj = self.experiment_client._client.run.get_token(experiment_name=self.automl_settings.name,
