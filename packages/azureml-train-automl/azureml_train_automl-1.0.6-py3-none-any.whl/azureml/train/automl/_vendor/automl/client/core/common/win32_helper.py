...
class Win32Helper(object):
    ...
    def close_handle(self, handle):
        """
        Wrapper for the Win32 CloseHandle function.
    ...
    def get_process_id(self):
        """
        Wrapper for Win32 GetProcessId function.
        DWORD GetProcessId(
          HANDLE Process
        );
    ...
    def open_process(self, pid=None):
        """
        Wrapper for the Win32 OpenProcess function.
    ...
    def get_process_memory_info(self, pid=None):
        """
        Wrapper for the Win32 GetProcessMemoryInfo function.
    ...
    def assign_process_to_job_object(self, job, pid=None):
        """
        Wrapper for the Win32 AssignProcessToJobObject function.
    ...
    def is_process_in_job(self):
        """
        Wrapper for the Win32 IsProcessInJob function.
    ...
    def query_information_job_object(self, job_object_info_class, job_info_struct):
        """
        Wrapper for the Win32 QueryInformationJobObject function. Queries info for the job this process is in.
    ...
    def get_process_times(self, pid=None):
        """
        Wrapper for the Win32 GetProcessTimes function. Retrieves timing information for the specified process.
    ...
    def get_current_memory_usage(self):
        """
        Gets the physical and virtual memory usage of this process.
    ...
    def get_children_memory_usage(self):
        """
        Gets the physical and virtual memory usage of all of this process's children.
    ...
    def get_job_accounting_info(self):
        """
        Gets the basic accounting and I/O accounting information for the job this process is in.
    ...
    def get_job_process_list(self):
        """
        Gets the list of pids of all processes associated with the job this process is in.
    ...
    def get_child_process_times(self):
        """
        Gets the timing information for all currently running processes in this job, except this one.
    ...
    def get_resource_usage(self):
        """
        Gets resource usage for both this process and all child processes in this job.
    ...
    def get_error(api_name=None):
        """
        Convenience function to retrieve and format the last error generated by a Win32 API call.
