...
class UserModel(object):
    ...
    def __init__(self, user_email=None, first_name=None, last_name=None, api_key=None, phone=None, company=None, title=None, settings=None, reg_time=None, license_id=None, license_type=None, expiry=None):  # noqa: E501
