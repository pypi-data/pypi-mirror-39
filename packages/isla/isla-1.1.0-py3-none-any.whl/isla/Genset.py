...
class Genset(DispatchableComponent):
    ...
    def __init__(
        ...
        life=10.0, life_use=None, fail_prob=0.014, stat_data=None, **kwargs
    ):
        ...
        super().__init__(
            ...
            life, fail_prob, stat_data, fuel.is_re, **kwargs
        )
    ...
    def _noise_calc(self, hr):
        ...
        """
        return np.ones(self.num_case)  # probability of failure only
