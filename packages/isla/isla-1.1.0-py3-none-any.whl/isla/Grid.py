...
class Grid(GridComponent):
    ...
    def __init__(
        self, pow_maxret=100, capex=0.0, opex_fix=0.0, opex_var=0.2, opex_ret=0.1,
        opex_use=0.0, life=20.0, fail_prob=0.0001, stat_data=None, **kwargs
    ):
        ...
        super().__init__(
            ...
            life, fail_prob, stat_data, False
        )
