...
*/Object(_polymer_polymer_lib_legacy_polymer_fn_js__WEBPACK_IMPORTED_MODULE_4__.a)({_template:_polymer_polymer_lib_utils_html_tag_js__WEBPACK_IMPORTED_MODULE_5__.a`
    ...
    <slot></slot>
`,is:"paper-icon-item",behaviors:[_paper_item_behavior_js__WEBPACK_IMPORTED_MODULE_6__.a]})},214:function(module,__webpack_exports__,__webpack_require__){"use strict";var _Mathround=Math.round,_Mathabs=Math.abs,_Mathceil=Math.ceil,_Mathfloor=Math.floor,_Mathmax=Math.max,_Mathmin=Math.min,spacing=__webpack_require__(159),style=__webpack_require__(162),overlay=__webpack_require__(207),html_tag=__webpack_require__(1);const $_documentContainer=html_tag.a`<dom-module id="lumo-vaadin-overlay" theme-for="vaadin-overlay">
  <template>
    <style include="lumo-overlay">
      /* stylelint-disable no-empty-source */
    </style>
  </template>
</dom-module>`;document.head.appendChild($_documentContainer.content);var vaadin_overlay=__webpack_require__(200),menu_overlay=__webpack_require__(215);const vaadin_combo_box_dropdown_styles_$_documentContainer=document.createElement("template");vaadin_combo_box_dropdown_styles_$_documentContainer.innerHTML=`<dom-module id="lumo-combo-box-overlay" theme-for="vaadin-combo-box-overlay">
  <template>
...
</dom-module>`;document.head.appendChild(vaadin_combo_box_dropdown_styles_$_documentContainer.content);var color=__webpack_require__(173),font_icons=__webpack_require__(201),sizing=__webpack_require__(177),typography=__webpack_require__(180);const vaadin_item_styles_$_documentContainer=document.createElement("template");vaadin_item_styles_$_documentContainer.innerHTML=`<dom-module id="lumo-item" theme-for="vaadin-item">
  <template>
    <style>
      :host {
        display: flex;
...
</dom-module>`;document.head.appendChild(vaadin_item_styles_$_documentContainer.content);var polymer_element=__webpack_require__(10),vaadin_themable_mixin=__webpack_require__(161);/**
@license
...
Copyright (c) 2018 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/var polymer_legacy=__webpack_require__(3),iron_resizable_behavior=__webpack_require__(83),iron_scroll_target_behavior=__webpack_require__(262),mutable_data_behavior=__webpack_require__(86),polymer_fn=__webpack_require__(4),polymer_dom=__webpack_require__(0),templatizer_behavior=__webpack_require__(85),debounce=__webpack_require__(14),path=__webpack_require__(2),IOS=navigator.userAgent.match(/iP(?:hone|ad;(?: U;)? CPU) OS (\d+)/),IOS_TOUCH_SCROLLING=IOS&&8<=IOS[1],DEFAULT_PHYSICAL_COUNT=3,HIDDEN_Y="-10000px",SECRET_TABINDEX=-100,IS_V2=null!=flush.b,ANIMATION_FRAME=IS_V2?utils_async.a:0,IDLE_TIME=IS_V2?utils_async.b:1,MICRO_TASK=IS_V2?utils_async.c:2;/**
@license
...
//# sourceMappingURL=d609f1cdf5ac8b52f551.chunk.js.map