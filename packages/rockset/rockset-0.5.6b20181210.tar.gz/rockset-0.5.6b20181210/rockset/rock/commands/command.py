...
class Command(object):
    def _parse_yaml_file(self, fn):
        try:
            fh = open(fn, 'r')
            resources = self._parse_yaml_filehandle(fh)
    ...
    def _parse_yaml_filehandle(self, fh):
    ...
    def print_list(self, level, objs, field_order=[], header=True):
