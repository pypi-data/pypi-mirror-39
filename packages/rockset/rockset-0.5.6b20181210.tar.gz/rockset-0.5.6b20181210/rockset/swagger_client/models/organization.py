...
class Organization(object):
    ...
    def tier(self, tier):
        ...
        :type: str
        """
        allowed_values = ["STARTER", "PREMIUM", "ENTERPRISE"]  # noqa: E501
        if tier not in allowed_values and tier is not None:
            raise ValueError(
    ...
    def state(self, state):
        ...
        :type: str
        """
        allowed_values = ["NEW", "ACTIVE"]  # noqa: E501
        if state not in allowed_values and state is not None:
            raise ValueError(
