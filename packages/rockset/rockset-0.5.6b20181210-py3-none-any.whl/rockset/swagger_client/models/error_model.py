...
class ErrorModel(object):
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["AUTHEXCEPTION", "VERSIONEXCEPTION", "INTERNALERROR", "INVALIDINPUT", "NOTIMPLEMENTEDYET", "PROTOCOLERROR", "RESOURCEEXCEEDED", "RESOURCENAMETOOLONG", "ALREADYEXISTS", "NOTFOUND", "DEPENDENTRESOURCES", "PAUSED", "QUERY_ERROR", "QUERY_PARSE_ERROR", "NOT_READY", "FORBIDDEN"]  # noqa: E501
        if type not in allowed_values and type is not None:
            raise ValueError(
