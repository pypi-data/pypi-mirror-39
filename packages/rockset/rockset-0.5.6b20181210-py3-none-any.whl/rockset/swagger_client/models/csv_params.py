...
class CsvParams(object):
    ...
    def column_types(self, column_types):
        ...
        :type: list[str]
        """
        allowed_values = ["UNKNOWN", "BOOLEAN", "INTEGER", "FLOAT", "TIME", "DATE", "DATETIME", "TIMESTAMP", "STRING"]  # noqa: E501
        if column_types is not None and not set(column_types).issubset(set(allowed_values)):
            raise ValueError(
