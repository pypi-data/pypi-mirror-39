...
IDirEntryMaintenance_VERSION = "3.1.32813"
...
class IDirEntryMaintenance(BaseEndpoint):
    ...
    def getAvailableOperations (self):
        ...
        response = requests.get( self.base + postUri, params = queryParams, verify=False, headers = {'X-BM-ApiKey' : self.apiKey, 'Accept' : 'application/json', 'X-BM-ClientVersion' : IDirEntryMaintenance_VERSION}, data = json.dumps(__data__));
    ...
    def repair (self, opIdentifiers ):
        ...
        response = requests.post( self.base + postUri, params = queryParams, verify=False, headers = {'X-BM-ApiKey' : self.apiKey, 'Accept' : 'application/json', 'X-BM-ClientVersion' : IDirEntryMaintenance_VERSION}, data = json.dumps(__data__));
