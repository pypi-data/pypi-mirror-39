...
from autolens.data.imaging import hyper_image
    ...
    def output_pdf_plots(self):
        ...
        if plot_pdf_1d_params:
            ...
            for param_name in self.param_names:
                ...
                pdf_plot.export(fname=self.phase_path + 'regular/pdf_' + param_name + '_1D.png')
        ...
        if plot_pdf_triangle:
            ...
            try:
                ...
                pdf_plot.export(fname=self.phase_path + 'regular/pdf_triangle.png')
