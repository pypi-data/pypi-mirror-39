...
class TestCase:
    def test_integration(self):
        ...
        # Create a model_galaxy prior for the source model_galaxy. Here we are describing only the light profile of the source
        # model_galaxy which comprises an elliptical exponential and elliptical sersic light profile.
        ...
        # Create a model_galaxy prior for the source model_galaxy. Here we are describing both the light and mass profiles. We've
        # also stipulated that the centres of any galaxies generated using the model_galaxy prior should match.
        ...
        # Recover model_galaxy instances. We can pass the model instance to model_galaxy priors to recover a fully constructed
        # model_galaxy
