...
def print_help():
    ...
    arms yapi [infile] -o [outfile] : build yapi json-file from markdown
...
def run(*a, **b):
    ...
    elif len(a) == 2 and a[0] == 'yapi' and 'o' in b:
        run_yapi(infile=a[1], outfile=b['o'])
    else:
        print_help()
