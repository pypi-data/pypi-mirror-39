...
class ModelDefinition(object):
    """
    Definition of Realtime AI model.
    You should create a ModelDefinition, append stages to the pipeline and then call save.
    You can then register the file created in that location to Model Management and use it to deploy a webservice.
    """
    ...
    def json_dict(self):
        """
        Encodes information about the pipeline.
