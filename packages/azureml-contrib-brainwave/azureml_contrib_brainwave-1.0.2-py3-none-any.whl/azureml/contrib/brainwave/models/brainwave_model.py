...
class BrainwaveModel(ABC):
    """
    Abstract base class for Brainwave models. Brainwave models are specific neural networks that can be accelerated  on
    dedicated hardware.
    """
    _prefix = ""
    ...
    def import_graph_def(self, input_tensor=None, is_training=True):
        """
        Import the graph definition corresponding to this model into the currently active graph.
