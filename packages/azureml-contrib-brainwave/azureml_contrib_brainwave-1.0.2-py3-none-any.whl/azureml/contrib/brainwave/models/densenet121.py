...
class AbstractDensenet121(BrainwaveModel):
    """Abstract base class for densenet. This model is in RGB format, and has a scaling factor of 0.017"""
...
class Densenet121(AbstractDensenet121):
    """
    Float-32 Version of Densenet. This model is in RGB format, and has a scaling factor of 0.017
    """
    _modelname = "dn121"
    _modelver = "1.1.4"
...
class QuantizedDensenet121(AbstractDensenet121):
    """
    Quantized version of Densenet. This model is in RGB format.
    """
    ...
    def __init__(self, model_base_path, is_frozen=False, custom_weights_directory=None):
        """
        Create a version of Densenet quantized for Project Brainwave. This model is in RGB format.
        :param model_base_path: Path to download the model into. Used as a cache locally.
