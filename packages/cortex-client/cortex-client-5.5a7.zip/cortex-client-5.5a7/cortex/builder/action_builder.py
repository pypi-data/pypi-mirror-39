...
class ActionBuilder:
    ...
    def from_source(self, source_str: str, function_name: str = 'main'):
        """
        Build an Action from source.  The Python source code must contain a function with the specified name.
    ...
    def from_setup(self, setup_script: str, action_module: str, function_name: str = 'main'):
        """
        Build an Action from a source archive built using Python Setuptools.  This will build the source distribution
    ...
    def _deploy_job_image(self, source, func_name, global_code, cortex_sdk_version, source_archive=None, **kwargs):
        ...
        try:
            ...
            self._render_and_save(temp_dir, 'Dockerfile', _dockerfile_job, base_image=_base_image,
                                  cortex_sdk_version=_cortex_sdk_version, deploy_archive=deploy_archive)
