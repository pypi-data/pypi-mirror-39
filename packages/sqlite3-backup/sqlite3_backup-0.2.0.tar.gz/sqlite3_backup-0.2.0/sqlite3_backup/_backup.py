...
def get_sqlite3_backup_handle(source_connection, target_connection):
    ...
    handle = backup_init(target_c_pointer, b"main", source_c_pointer, b"main")
    return handle
...
def backup(source_connection, target_connection, pages=100):
    ...
    handle = get_sqlite3_backup_handle(source_connection, target_connection)
