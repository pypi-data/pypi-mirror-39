...
class TSIntegrale(BaseEstimator, TransformerMixin):
    """ Sum past values in different past periods.
        TODO
    """
    def __init__(self, past_period_start="5min", past_period_stop=None):
        """
            :param past_period_start: Used period offset to start integrating
            :param past_period_stop: Used period offset when to stop integrating
        """
        self.past_period_start = past_period_start
        self.past_period_stop = past_period_stop
