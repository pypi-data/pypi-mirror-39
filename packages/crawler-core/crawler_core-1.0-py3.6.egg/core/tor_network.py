            ...
            if result:
                ...
                if torrc_data:
                    try:
                        ...
                        # print("err01",torrc_data.get('ip'),torrc_data.get('control_port'), str(e))
                        try:
                            ...
                            # print("err02", torrc_data.get('ip'), torrc_data.get('control_port'), str(e))
                            pass
