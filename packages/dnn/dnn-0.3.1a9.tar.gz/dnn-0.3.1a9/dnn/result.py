...
class Result:
    ...
    def log (self, msg, type = "info"):
        ...
        print ("{} {}".format ((type and tc.critical or color) (header), msg))
    
    def pipe (self):
        msg = self._summaryfunc (self.phase, self.__make_summary (self.args.get ("summary", {})), True)
        msg and self.log (msg, None)
        return self
    update = pipe
