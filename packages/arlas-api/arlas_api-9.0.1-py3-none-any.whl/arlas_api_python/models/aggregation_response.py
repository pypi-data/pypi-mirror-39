...
class AggregationResponse(object):
    ...
    def __init__(self, query_time=None, total_time=None, totalnb=None, name=None, count=None, sumotherdoccounts=None, key=None, key_as_string=None, elements=None, metrics=None, geometry=None):
        """
