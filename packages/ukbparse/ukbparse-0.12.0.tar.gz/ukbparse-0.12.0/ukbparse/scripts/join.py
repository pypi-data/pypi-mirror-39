...
#
"""Generate the variable and data coding files by performing an outer
...
def main(args=None):
    ...
    with open(outfile, 'wt') as f:
        ...
        for rowi in range(len(data[0])):
            ...
            if rowi < 10 or rowi > len(data[0]) - 10:
                print('Row: {}'.format(' | '.join(rowelems)))
            elif rowi == len(data[0]) - 10:
                print('...')
