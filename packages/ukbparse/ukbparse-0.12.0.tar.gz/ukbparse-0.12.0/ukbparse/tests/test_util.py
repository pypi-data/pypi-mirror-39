...
def test_timed():
    with util.timed('abc'):
        pass
    with util.timed('abc', minutes=True):
        pass
    with util.timed('abc', fmt='abc', minutes=True):
        pass
    with util.timed('abc', fmt='abc'):
        pass
    with util.timed('abc', fmt='abc', minutes=True):
        pass
    with util.timed(fmt='abc'):
        pass
    with util.timed(fmt='abc', minutes=True):
        pass
