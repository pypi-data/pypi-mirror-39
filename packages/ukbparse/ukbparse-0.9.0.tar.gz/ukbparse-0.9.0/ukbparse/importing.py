...
def importData(datafiles,
    ...
    :returns:               A :class:`DataTable`, which contains references
                            to the data, and the variable and procesing tables.
    """
...
def columnsToLoad(datafiles,
    ...
    :returns:           A dict of ``{ file : [Column] }`` mappings, the
                        :class:`.Column` objects to load from each input file.
    """
