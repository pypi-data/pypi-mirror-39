...
def test_timed():
    with util.timed('abc'):
        pass
    with util.timed('abc', minutes=False):
        pass
    with util.timed('abc', fmt='abc %s %s', minutes=False):
        pass
    with util.timed('abc', fmt='abc %s %s %s'):
        pass
    with util.timed('abc', fmt='abc %s %s', minutes=False):
        pass
    with util.timed(fmt='abc %s %s %s'):
        pass
    with util.timed(fmt='abc %s %s', minutes=False):
        pass
