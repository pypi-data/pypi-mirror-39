...
def genColumnNames(dtable, colpat, colmap=None):
    ...
    for var in variables:
        ...
        for visit, instance in it.product(visits, instances):
            ...
            oldcol = dtable.columns(var, visit, instance)[0]
...
def exportData(dtable,
    ...
    if subjects   is None: subjects   = dtable.index

    if colpat is not None or colmap is not None:
