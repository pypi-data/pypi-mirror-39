...
class DataReference(Model):
    ...
    :type azure_sql_database_reference:
     ~swagger.models.AzureSqlDatabaseReference
    """
    ...
    _attribute_map = {
        ...
        'azure_sql_database_reference': {'key': 'AzureSqlDatabaseReference', 'type': 'AzureSqlDatabaseReference'},
    }

    def __init__(self, type=None, azure_blob_reference=None, azure_data_lake_reference=None, azure_files_reference=None, azure_sql_database_reference=None):
