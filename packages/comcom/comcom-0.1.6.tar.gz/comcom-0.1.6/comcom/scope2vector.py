...
def scope2list(scope_str_original):
    ...
    stop_list   = ml3.tools.load_json_file(os.path.join(module_path,"data","stop_list.json"))
    keywords    = ml3.tools.load_json_file(os.path.join(module_path,"data","keywords.json"))
    ignores     = ml3.tools.load_json_file(os.path.join(module_path,"data","ignores.json"))
    gbbs_dict   = ml3.tools.load_json_file(os.path.join(module_path,"data","gbt4547.json"))
    ...
    for rmap_file_name in files:
        ...
        rmap_json =  ml3.tools.load_json_file(os.path.join(module_path,"data",rmap_file_name))
