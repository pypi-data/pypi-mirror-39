...
def getcomlogoname(com_name):
    ...
    com_logo = ""
    #录入省/城市数据
    city_list = ml3.tools.load_json_file("city_list.json")
    ...
    #获取企业种类
    com_types = ml3.tools.load_json_file("com_types.json")
    ...
    com_tails = ml3.tools.load_json_file("com_tails.json")
    ...
    if len(com_feature) == 3:
        ...
        if com_tail_s1 != "":com_logo = com_feature + com_tail_s1
        else:
