...
Once this is done then you're all good to go, you can now simply register tasks with a simple decorator and easily 
manage them using django admin.


![Alt text](sidekick/static/images/SideKickAdmin.png?raw=true "Side Kick Admin Example")
