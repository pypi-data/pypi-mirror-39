...
class Request:   
    ...
    def parse(self):
        ...
        try:
            ...
            print("request data parsed failure!")
...
class Response:   
    ...
    def make_page(self, title=None, content=None):
        ...
        '''
        style = "*+*{box-sizing:border-box;margin:.5em 0}@media(min-width:35em){.col{display:table-cell}.\31{width:5%}.\33{width:22%}.\34{width:30%}.\35{width:40%}.\32{width:15%}.row{display:table;border-spacing:1em 0}}.row,.w-100{width:100%}.card:focus,hr{outline:0;border:solid #fa0}.card,pre{padding:1em;border:solid #eee}.btn:hover,a:hover{opacity:.6}.c{max-width:60em;padding:1em;margin:auto;font:1em/1.6 nunito}a{color:#fa0;text-decoration:none}.btn.primary{color:#fff;background:#fa0;border:solid #fa0}pre{overflow:auto}td,th{padding:1em;text-align:left;border-bottom:solid #eee}.btn{cursor:pointer;padding:1em;letter-spacing:.1em;text-transform:uppercase;background:#fff;border:solid;font:.7em nunito}"
        data = template.format(title=title, style=style, content=content)
        body = b'\r\n%s' % data
        self.response_data = firstline + header + body
    ...
    def send(self):
        if self.response_data:
            try:
                ...
                print("response data sent failure!")
...
class Board:
    ...
    def read(self, raw_tag):
        ...
        try:
            ...
            print("error for board data reading!")
    ...
    def write(self, raw_tag, raw_value):
        ...
        try:
            ...
            print(" error for board data writing!")
...
class Server:
    ...
    def _start_server(self, port=8888, accept_handler=None):
        ...
        try:
            ...
            print("appserver error occurred!")
