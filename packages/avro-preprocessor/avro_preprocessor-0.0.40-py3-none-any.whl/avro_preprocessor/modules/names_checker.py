...
class NamesChecker(PreprocessorModule):
    ...
    def check_property_names(self, schema: OrderedDict) -> None:
        ...
        if Avro.Name in schema:
            if Avro.Type in schema and schema[Avro.Type] in (Avro.Record, Avro.Enum):
