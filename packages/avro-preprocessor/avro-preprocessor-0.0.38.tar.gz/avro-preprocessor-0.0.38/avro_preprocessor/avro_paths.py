...
class AvroPaths:  # pylint: disable=R0902
    ...
    def is_event_resource(self, schema_namespace: str) -> bool:
        """
        Returns True if a schema namespace is not a type, i.e. it is not a reusable Avro resource
        not to be registered to a Kafka topic.
        :param schema_namespace: The namespace of this schema
        :return: bool
        """
        return self.types_namespace is None or not schema_namespace.startswith(self.types_namespace)
