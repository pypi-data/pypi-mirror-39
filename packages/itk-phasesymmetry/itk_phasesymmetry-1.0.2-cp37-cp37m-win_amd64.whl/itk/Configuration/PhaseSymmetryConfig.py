...
snake_case_functions = ('steerable_filter_freq_image_source', 'log_gabor_freq_image_source', 'phase_symmetry_image_filter', 'sinusoid_image_source', 'butterworth_filter_freq_image_source', )
