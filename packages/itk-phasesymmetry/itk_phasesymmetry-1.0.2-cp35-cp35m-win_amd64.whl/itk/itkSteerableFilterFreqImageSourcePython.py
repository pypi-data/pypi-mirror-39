...
class itkSteerableFilterFreqImageSourceIF2(itkImageSourcePython.itkImageSourceIF2):
    ...
    def SetSize(self, *args) -> "void":
        """
        SetSize(itkSteerableFilterFreqImageSourceIF2 self, unsigned long long const * values)
    ...
    def GetSize(self) -> "unsigned long long const *":
        """GetSize(itkSteerableFilterFreqImageSourceIF2 self) -> unsigned long long const *"""
...
class itkSteerableFilterFreqImageSourceIF3(itkImageSourcePython.itkImageSourceIF3):
    ...
    def SetSize(self, *args) -> "void":
        """
        SetSize(itkSteerableFilterFreqImageSourceIF3 self, unsigned long long const * values)
    ...
    def GetSize(self) -> "unsigned long long const *":
        """GetSize(itkSteerableFilterFreqImageSourceIF3 self) -> unsigned long long const *"""
...
def steerable_filter_freq_image_source(*args, **kwargs):
    ...
    import itk
    return itk.SteerableFilterFreqImageSource.__call__(*args, **kwargs)
