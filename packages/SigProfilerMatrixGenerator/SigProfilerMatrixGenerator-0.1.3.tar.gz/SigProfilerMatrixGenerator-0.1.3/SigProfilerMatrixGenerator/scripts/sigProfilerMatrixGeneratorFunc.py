...
def sigProfilerMatrixGeneratorFunc (project, genome, vcfFiles, output, exome=False, SNVs=False,indel=False, indel_extended=False, bed_file=None, chrom_based=False, plot=False, gs=False):
	'''
