...
function GetOciSubcommands_compute() {
    $ociSubcommands = @{
        'compute' = 'boot-volume-attachment console-history image instance instance-console-connection pic shape vnic-attachment volume-attachment'
...
function GetOciCommandsToLongParams_compute() {
    $ociCommandsToLongParams = @{
        ...
        'compute instance launch' = 'assign-public-ip availability-domain boot-volume-size-in-gbs compartment-id defined-tags display-name extended-metadata fault-domain freeform-tags from-json help hostname-label image-id ipxe-script-file is-pv-encryption-in-transit-enabled max-wait-seconds metadata private-ip shape skip-source-dest-check source-boot-volume-id source-details ssh-authorized-keys-file subnet-id user-data-file vnic-display-name wait-for-state wait-interval-seconds'
        ...
        'compute volume-attachment attach-paravirtualized-volume' = 'display-name from-json help instance-id is-pv-encryption-in-transit-enabled is-read-only max-wait-seconds volume-id wait-for-state wait-interval-seconds'
