...
function GetOciSubcommands_lb() {
    $ociSubcommands = @{
        'lb' = 'backend backend-health backend-set backend-set-health certificate health-checker hostname listener load-balancer load-balancer-health path-route-set policy protocol shape work-request'
...
function GetOciCommandsToLongParams_lb() {
    $ociCommandsToLongParams = @{
        ...
        'lb listener create' = 'connection-configuration-idle-timeout default-backend-set-name from-json help hostname-names load-balancer-id max-wait-seconds name path-route-set-name port protocol ssl-certificate-name ssl-verify-depth ssl-verify-peer-certificate wait-for-state wait-interval-seconds'
        ...
        'lb listener update' = 'connection-configuration-idle-timeout default-backend-set-name force from-json help hostname-names listener-name load-balancer-id max-wait-seconds path-route-set-name port protocol ssl-certificate-name ssl-verify-depth ssl-verify-peer-certificate wait-for-state wait-interval-seconds'
        'lb load-balancer create' = 'backend-sets certificates compartment-id defined-tags display-name freeform-tags from-json help hostnames is-private listeners max-wait-seconds path-route-sets shape-name subnet-ids wait-for-state wait-interval-seconds'
