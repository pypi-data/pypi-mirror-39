...
function GetOciSubcommands_iam() {
    $ociSubcommands = @{
        'iam' = 'auth-token availability-domain compartment customer-secret-key dynamic-group fault-domain group policy region region-subscription smtp-credential tag tag-namespace user work-request'
