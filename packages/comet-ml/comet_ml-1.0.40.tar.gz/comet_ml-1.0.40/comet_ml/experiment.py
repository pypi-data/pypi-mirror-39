...
from .utils import is_list_like, local_timestamp
...
class BaseExperiment(object):
    ...
    def log_asset(self, file_path, file_name=None, overwrite=False):
        """
        ...
        self._file_upload(file_path, "asset", url_params, copy_to_tmp=True)
    ...
    def _file_upload(
        self, file_path, upload_type, url_params=None, file_name=None, copy_to_tmp=False
    ):
        ...
        if copy_to_tmp is True:
            # Ensure we pass the correct file_name
            if file_name is None:
