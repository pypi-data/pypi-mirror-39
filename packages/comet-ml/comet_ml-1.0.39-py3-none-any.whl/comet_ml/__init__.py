...
class Experiment(BaseExperiment):
    ...
    def _initialize_streamer(self, full_ws_url, initial_offset):
        ...
        self.streamer = Streamer(
            self.ws_connection, INITIAL_BEAT_DURATION, self.connection, initial_offset
        )
...
class ExistingExperiment(Experiment):
    ...
    def __init__(self, api_key, previous_experiment, **kwargs):
        ...
        for key in ["log_code", "log_graph", "parse_args", "log_env_details",
                    "log_git_metadata", "log_git_patch"]:
