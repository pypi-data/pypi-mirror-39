...
.. image:: https://gitlab.idiap.ch/beat/beat.backend.python/badges/v1.6.0/build.svg
   :target: https://gitlab.idiap.ch/beat/beat.backend.python/commits/v1.6.0
.. image:: https://gitlab.idiap.ch/beat/beat.backend.python/badges/v1.6.0/coverage.svg
   :target: https://gitlab.idiap.ch/beat/beat.backend.python/commits/v1.6.0
