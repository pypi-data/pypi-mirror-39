...
# ---------------------------------------------------------
"""activity.py, A file for telemetry activity classes"""
...
class ActivityLoggerAdapter(logging.LoggerAdapter):
    ...
    def process(self, msg, kwargs):
        """
           An activity is a logical block of code that consumers
           want to monitor.
           The monitoring is achieved through wrapping this logical block
           of code via with log_activity() method.

           Args:
               msg (str). the log message.\n
               kwargs (str). the arguments with properties.
           """
