...
def createDict(works, aids):
	...
	for hit in works:
		...
		for durationIndex, value in enumerate(DurationSections):
			if duration < value:
				break
		worksDict[worksInfo['vid']] = {'title': worksInfo['title'], 'aid': aid, 'publishTime': publishTime, 'playTime': 0, 'timeCount': 0, 'show': 0, 'showPlay': 0, 'durationIndex': durationIndex, 'statis': [0, 0, 0, 0, 0, 0, 0, 0, 0, duration, size]}
