...
#
#     from terminator3 import metadata
#
# However, when we do this, we also import `terminator3/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'terminator3_cli = terminator3.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'terminator3_gui = terminator3.gui:entry_point'
        # ]
    }
)
