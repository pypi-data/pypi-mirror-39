...
class UserRequest(object):
    ...
    swagger_types = {
        ...
        'del_groups': 'list[UserGroup]',
        'change_groups': 'list[UserGroup]',
        'enabled': 'bool',
    ...
    def __init__(self, user_email=None, user_password=None, account_role=None, add_groups=None, del_groups=None, change_groups=None, enabled=None, add_u2f_devices=None, del_u2f_devices=None, rename_u2f_devices=None):
        """
        ...
        if change_groups is not None:
          self.change_groups = change_groups
    ...
    def change_groups(self):
        """
        Gets the change_groups of this UserRequest.

        Type: list[L{UserGroup}]
        """
        return self._change_groups

    @change_groups.setter
    def change_groups(self, change_groups):
        """
        Sets the change_groups of this UserRequest.
        """

        self._change_groups = change_groups
