...
class DigestApi(object):
    ...
    def compute_digest(self, body, async=False, **kwargs):
        """
        ...
        if async:
            return self.compute_digest_with_http_info(body, async=async, **kwargs)
        else:
            (data) = self.compute_digest_with_http_info(body, async=async, **kwargs)
            return data

    def compute_digest_with_http_info(self, body, async=False, **kwargs):
        """
        This returns the digest of data provided in request body using the algorithm specified in request body. Maximum size of request body supported is 512KB. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.compute_digest_with_http_info(body, async=True)
            >>> result = thread.get()
    ...
    def compute_mac(self, key_id, body, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.compute_mac_with_http_info(key_id, body, async=async, **kwargs)
        else:
            (data) = self.compute_mac_with_http_info(key_id, body, async=async, **kwargs)
            return data

    def compute_mac_with_http_info(self, key_id, body, async=False, **kwargs):
        """
        Compute a cryptographic Message Authentication Code on a message using a symmetric key. The key must have the MACGenerate operation enabled. Asymmetric keys may not be used to generate MACs. They can be used with the sign and verify operations. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.compute_mac_with_http_info(key_id, body, async=True)
            >>> result = thread.get()
    ...
    def compute_mac_ex(self, body, async=False, **kwargs):
        """
        Compute a cryptographic Message Authentication Code on a message using a symmetric key. The key must have the MACGenerate operation enabled. Asymmetric keys may not be used to generate MACs. They can be used with the sign and verify operations. 
        @type async: bool
        @param async: Whether the call should be performed asynchronously. (Default is False).
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.compute_mac_ex_with_http_info(body, async=async, **kwargs)
        else:
            (data) = self.compute_mac_ex_with_http_info(body, async=async, **kwargs)
            return data

    def compute_mac_ex_with_http_info(self, body, async=False, **kwargs):
        """
        Compute a cryptographic Message Authentication Code on a message using a symmetric key. The key must have the MACGenerate operation enabled. Asymmetric keys may not be used to generate MACs. They can be used with the sign and verify operations. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.compute_mac_ex_with_http_info(body, async=True)
            >>> result = thread.get()
    ...
    def verify_mac(self, key_id, body, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.verify_mac_with_http_info(key_id, body, async=async, **kwargs)
        else:
            (data) = self.verify_mac_with_http_info(key_id, body, async=async, **kwargs)
            return data

    def verify_mac_with_http_info(self, key_id, body, async=False, **kwargs):
        """
        The data to be MACed, the algorithm, and a pre-computed MAC are provided in the request body, and the key id is provided in the URL. SDKMS computes the MAC of the data and compares it with the specified MAC, and returns the outcome of the MAC verification in the response body. Maximum size of request body supported is 512KB. Supported digest algorithms are - SHA1, SHA256, SHA384, and SHA512.             
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.verify_mac_with_http_info(key_id, body, async=True)
            >>> result = thread.get()
    ...
    def verify_mac_ex(self, body, async=False, **kwargs):
        """
        The data to be MACed, the algorithm, and a pre-computed MAC are provided in the request body, and the key id is provided in the URL. SDKMS computes the MAC of the data and compares it with the specified MAC, and returns the outcome of the MAC verification in the response body. Maximum size of request body supported is 512KB. Supported digest algorithms are - SHA1, SHA256, SHA384, and SHA512. 
        @type async: bool
        @param async: Whether the call should be performed asynchronously. (Default is False).
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.verify_mac_ex_with_http_info(body, async=async, **kwargs)
        else:
            (data) = self.verify_mac_ex_with_http_info(body, async=async, **kwargs)
            return data

    def verify_mac_ex_with_http_info(self, body, async=False, **kwargs):
        """
        The data to be MACed, the algorithm, and a pre-computed MAC are provided in the request body, and the key id is provided in the URL. SDKMS computes the MAC of the data and compares it with the specified MAC, and returns the outcome of the MAC verification in the response body. Maximum size of request body supported is 512KB. Supported digest algorithms are - SHA1, SHA256, SHA384, and SHA512. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.verify_mac_ex_with_http_info(body, async=True)
            >>> result = thread.get()
