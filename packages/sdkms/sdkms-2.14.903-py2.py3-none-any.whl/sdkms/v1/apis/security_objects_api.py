...
class SecurityObjectsApi(object):
    ...
    def agree_key(self, body, async=False, **kwargs):
        """
        ...
        if async:
            return self.agree_key_with_http_info(body, async=async, **kwargs)
        else:
            (data) = self.agree_key_with_http_info(body, async=async, **kwargs)
            return data

    def agree_key_with_http_info(self, body, async=False, **kwargs):
        """
        This does a cryptographic key agreement operation between a public and private key. Both keys must have been generated from the same parameters (e.g. the same elliptic curve). Both keys must allow the AGREEKEY operation. The request body contains the requested properties for the new key as well as the mechanism (e.g. Diffie-Hellman) to be used to produce the key material for the new key. The output of this API should not be used directly as a cryptographic key. The target object type should be HMAC or Secret, and a key derivation procedure should be used to derive the actual key material. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.agree_key_with_http_info(body, async=True)
            >>> result = thread.get()
    ...
    def delete_private_key(self, key_id, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.delete_private_key_with_http_info(key_id, async=async, **kwargs)
        else:
            (data) = self.delete_private_key_with_http_info(key_id, async=async, **kwargs)
            return data

    def delete_private_key_with_http_info(self, key_id, async=False, **kwargs):
        """
        Removes the private portion of an asymmetric key from SDKMS. After this operation is performed, operations that require the private key, such as encryption and generating signatures, may no longer be performed. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.delete_private_key_with_http_info(key_id, async=True)
            >>> result = thread.get()
    ...
    def delete_security_object(self, key_id, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.delete_security_object_with_http_info(key_id, async=async, **kwargs)
        else:
            (data) = self.delete_security_object_with_http_info(key_id, async=async, **kwargs)
            return data

    def delete_security_object_with_http_info(self, key_id, async=False, **kwargs):
        """
        Delete a specified security object.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.delete_security_object_with_http_info(key_id, async=True)
            >>> result = thread.get()
    ...
    def derive_key(self, key_id, body, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.derive_key_with_http_info(key_id, body, async=async, **kwargs)
        else:
            (data) = self.derive_key_with_http_info(key_id, body, async=async, **kwargs)
            return data

    def derive_key_with_http_info(self, key_id, body, async=False, **kwargs):
        """
        This derives a key from an existing key and returns the properties of the new key. The request body contains the requested properties for the new as well as the mechanism to be used to produce the key material for the new key. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.derive_key_with_http_info(key_id, body, async=True)
            >>> result = thread.get()
    ...
    def derive_key_ex(self, body, async=False, **kwargs):
        """
        This derives a key from an existing key and returns the properties of the new key. The request body contains the requested properties for the new as well as the mechanism to be used to produce the key material for the new key. 
        @type async: bool
        @param async: Whether the call should be performed asynchronously. (Default is False).
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.derive_key_ex_with_http_info(body, async=async, **kwargs)
        else:
            (data) = self.derive_key_ex_with_http_info(body, async=async, **kwargs)
            return data

    def derive_key_ex_with_http_info(self, body, async=False, **kwargs):
        """
        This derives a key from an existing key and returns the properties of the new key. The request body contains the requested properties for the new as well as the mechanism to be used to produce the key material for the new key. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.derive_key_ex_with_http_info(body, async=True)
            >>> result = thread.get()
    ...
    def generate_security_object(self, body, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.generate_security_object_with_http_info(body, async=async, **kwargs)
        else:
            (data) = self.generate_security_object_with_http_info(body, async=async, **kwargs)
            return data

    def generate_security_object_with_http_info(self, body, async=False, **kwargs):
        """
        Generate a new security object (such as an RSA key pair or an AES key) of the requested size or elliptic curve. <br> By default, all key operations except for Export that are implemented for that type of key will be enabled. These may be overridden by requesting specific operations in the key creation request. <br> Objects of type Opaque may not be generated with this API. They must be imported via the importSecurityObject API. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.generate_security_object_with_http_info(body, async=True)
            >>> result = thread.get()
    ...
    def get_security_object(self, key_id, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.get_security_object_with_http_info(key_id, async=async, **kwargs)
        else:
            (data) = self.get_security_object_with_http_info(key_id, async=async, **kwargs)
            return data

    def get_security_object_with_http_info(self, key_id, async=False, **kwargs):
        """
        Get the details of a particular security object. The query parameter `?view=value` may be used to get the value of an opaque object or certificate directly as raw bytes. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.get_security_object_with_http_info(key_id, async=True)
            >>> result = thread.get()
    ...
    def get_security_object_digest(self, body, async=False, **kwargs):
        """
        @type async: bool
        @param async: Whether the call should be performed asynchronously. (Default is False).
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.get_security_object_digest_with_http_info(body, async=async, **kwargs)
        else:
            (data) = self.get_security_object_digest_with_http_info(body, async=async, **kwargs)
            return data

    def get_security_object_digest_with_http_info(self, body, async=False, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.get_security_object_digest_with_http_info(body, async=True)
            >>> result = thread.get()
    ...
    def get_security_object_value(self, key_id, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.get_security_object_value_with_http_info(key_id, async=async, **kwargs)
        else:
            (data) = self.get_security_object_value_with_http_info(key_id, async=async, **kwargs)
            return data

    def get_security_object_value_with_http_info(self, key_id, async=False, **kwargs):
        """
        Get the details and value of a particular exportable security object. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.get_security_object_value_with_http_info(key_id, async=True)
            >>> result = thread.get()
    ...
    def get_security_object_value_ex(self, body, async=False, **kwargs):
        """
        Get the details and value of a particular exportable security object. 
        @type async: bool
        @param async: Whether the call should be performed asynchronously. (Default is False).
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.get_security_object_value_ex_with_http_info(body, async=async, **kwargs)
        else:
            (data) = self.get_security_object_value_ex_with_http_info(body, async=async, **kwargs)
            return data

    def get_security_object_value_ex_with_http_info(self, body, async=False, **kwargs):
        """
        Get the details and value of a particular exportable security object. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.get_security_object_value_ex_with_http_info(body, async=True)
            >>> result = thread.get()
    ...
    def get_security_objects(self, name=None, group_id=None, creator=None, sort=None, start=None, limit=None, offset=None, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.get_security_objects_with_http_info(name=name, group_id=group_id, creator=creator, sort=sort, start=start, limit=limit, offset=offset, async=async, **kwargs)
        else:
            (data) = self.get_security_objects_with_http_info(name=name, group_id=group_id, creator=creator, sort=sort, start=start, limit=limit, offset=offset, async=async, **kwargs)
            return data

    def get_security_objects_with_http_info(self, name=None, group_id=None, creator=None, sort=None, start=None, limit=None, offset=None, async=False, **kwargs):
        """
        Return detailed information about the security objects stored in Fortanix SDKMS. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.get_security_objects_with_http_info(async=True)
            >>> result = thread.get()
    ...
    def import_security_object(self, body, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.import_security_object_with_http_info(body, async=async, **kwargs)
        else:
            (data) = self.import_security_object_with_http_info(body, async=async, **kwargs)
            return data

    def import_security_object_with_http_info(self, body, async=False, **kwargs):
        """
        Import a security object into SDKMS. <br> By default, all key operations except that are implemented for that type of key will be enabled. These may be overridden by requesting specific operations in the key import request. <br> For symmetric and asymmetric keys, value is base64-encoding of the key material in DER format. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.import_security_object_with_http_info(body, async=True)
            >>> result = thread.get()
    ...
    def persist_security_object(self, body, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.persist_security_object_with_http_info(body, async=async, **kwargs)
        else:
            (data) = self.persist_security_object_with_http_info(body, async=async, **kwargs)
            return data

    def persist_security_object_with_http_info(self, body, async=False, **kwargs):
        """
        This API copies a transient key into a persisted security object in SDKMS. If the transient key's origin is \"FortanixHSM\", the origin of the persisted key will be \"Transient\". If the transient key's origin is \"External\", the origin of the persisted key will be \"External\". 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.persist_security_object_with_http_info(body, async=True)
            >>> result = thread.get()
    ...
    def update_security_object(self, key_id, body, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.update_security_object_with_http_info(key_id, body, async=async, **kwargs)
        else:
            (data) = self.update_security_object_with_http_info(key_id, body, async=async, **kwargs)
            return data

    def update_security_object_with_http_info(self, key_id, body, async=False, **kwargs):
        """
        Update the properties of a security object. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.update_security_object_with_http_info(key_id, body, async=True)
            >>> result = thread.get()
