...
class PluginsApi(object):
    ...
    def create_plugin(self, body, async=False, **kwargs):
        """
        ...
        if async:
            return self.create_plugin_with_http_info(body, async=async, **kwargs)
        else:
            (data) = self.create_plugin_with_http_info(body, async=async, **kwargs)
            return data

    def create_plugin_with_http_info(self, body, async=False, **kwargs):
        """
        Create a new plugin with the specified properties.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.create_plugin_with_http_info(body, async=True)
            >>> result = thread.get()
    ...
    def delete_plugin(self, plugin_id, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.delete_plugin_with_http_info(plugin_id, async=async, **kwargs)
        else:
            (data) = self.delete_plugin_with_http_info(plugin_id, async=async, **kwargs)
            return data

    def delete_plugin_with_http_info(self, plugin_id, async=False, **kwargs):
        """
        Remove a plugin from SDKMS.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.delete_plugin_with_http_info(plugin_id, async=True)
            >>> result = thread.get()
    ...
    def get_plugin(self, plugin_id, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.get_plugin_with_http_info(plugin_id, async=async, **kwargs)
        else:
            (data) = self.get_plugin_with_http_info(plugin_id, async=async, **kwargs)
            return data

    def get_plugin_with_http_info(self, plugin_id, async=False, **kwargs):
        """
        Look up plugin by plugin ID.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.get_plugin_with_http_info(plugin_id, async=True)
            >>> result = thread.get()
    ...
    def get_plugins(self, group_id=None, sort=None, start=None, limit=None, offset=None, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.get_plugins_with_http_info(group_id=group_id, sort=sort, start=start, limit=limit, offset=offset, async=async, **kwargs)
        else:
            (data) = self.get_plugins_with_http_info(group_id=group_id, sort=sort, start=start, limit=limit, offset=offset, async=async, **kwargs)
            return data

    def get_plugins_with_http_info(self, group_id=None, sort=None, start=None, limit=None, offset=None, async=False, **kwargs):
        """
        Get details of all plugins the current user has access to.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.get_plugins_with_http_info(async=True)
            >>> result = thread.get()
    ...
    def invoke_plugin(self, plugin_id, body, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.invoke_plugin_with_http_info(plugin_id, body, async=async, **kwargs)
        else:
            (data) = self.invoke_plugin_with_http_info(plugin_id, body, async=async, **kwargs)
            return data

    def invoke_plugin_with_http_info(self, plugin_id, body, async=False, **kwargs):
        """
        Invokes a plugin execution with the provided request body as input to the plugin.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.invoke_plugin_with_http_info(plugin_id, body, async=True)
            >>> result = thread.get()
    ...
    def sys_v1_plugins_invoke_plugin_id_get(self, plugin_id, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.sys_v1_plugins_invoke_plugin_id_get_with_http_info(plugin_id, async=async, **kwargs)
        else:
            (data) = self.sys_v1_plugins_invoke_plugin_id_get_with_http_info(plugin_id, async=async, **kwargs)
            return data

    def sys_v1_plugins_invoke_plugin_id_get_with_http_info(self, plugin_id, async=False, **kwargs):
        """
        Invokes a plugin with empty input.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.sys_v1_plugins_invoke_plugin_id_get_with_http_info(plugin_id, async=True)
            >>> result = thread.get()
    ...
    def update_plugin(self, plugin_id, body, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.update_plugin_with_http_info(plugin_id, body, async=async, **kwargs)
        else:
            (data) = self.update_plugin_with_http_info(plugin_id, body, async=async, **kwargs)
            return data

    def update_plugin_with_http_info(self, plugin_id, body, async=False, **kwargs):
        """
        Change a plugin's properties, such as name, description, code, or group membership.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.update_plugin_with_http_info(plugin_id, body, async=True)
            >>> result = thread.get()
