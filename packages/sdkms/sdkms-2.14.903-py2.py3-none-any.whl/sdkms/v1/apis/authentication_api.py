...
class AuthenticationApi(object):
    ...
    def authorize(self, async=False, **kwargs):
        """
        ...
        if async:
            return self.authorize_with_http_info(async=async, **kwargs)
        else:
            (data) = self.authorize_with_http_info(async=async, **kwargs)
            return data

    def authorize_with_http_info(self, async=False, **kwargs):
        """
        Authenticate a user or an app to SDKMS to begin a session. The caller needs to provide a basic authentication token to authenticate to SDKMS. The response body contains a bearer authentication token which needs to be provided by subsequent calls for the duration of the session. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.authorize_with_http_info(async=True)
            >>> result = thread.get()
    ...
    def check_health(self, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.check_health_with_http_info(async=async, **kwargs)
        else:
            (data) = self.check_health_with_http_info(async=async, **kwargs)
            return data

    def check_health_with_http_info(self, async=False, **kwargs):
        """
        Returns a 200-class status code if the server is handling requests, or a 500-class status code if the server is having problems. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.check_health_with_http_info(async=True)
            >>> result = thread.get()
    ...
    def get_server_version(self, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.get_server_version_with_http_info(async=async, **kwargs)
        else:
            (data) = self.get_server_version_with_http_info(async=async, **kwargs)
            return data

    def get_server_version_with_http_info(self, async=False, **kwargs):
        """
        Returns information about the  SDKMS server version and the client API version that it supports. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.get_server_version_with_http_info(async=True)
            >>> result = thread.get()
    ...
    def select_account(self, body, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.select_account_with_http_info(body, async=async, **kwargs)
        else:
            (data) = self.select_account_with_http_info(body, async=async, **kwargs)
            return data

    def select_account_with_http_info(self, body, async=False, **kwargs):
        """
        Select one of user's account to proceed. This is applicable when a user is associated with more than one account. The caller needs to provide a bearer token for the session in the request body. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.select_account_with_http_info(body, async=True)
            >>> result = thread.get()
    ...
    def terminate(self, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.terminate_with_http_info(async=async, **kwargs)
        else:
            (data) = self.terminate_with_http_info(async=async, **kwargs)
            return data

    def terminate_with_http_info(self, async=False, **kwargs):
        """
        Terminate an authenticated session. After this call, the provided bearer authentication token will be invalidated and cannot be used to make any further API calls. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
    ...
    def unlock2_f(self, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.unlock2_f_with_http_info(async=async, **kwargs)
        else:
            (data) = self.unlock2_f_with_http_info(async=async, **kwargs)
            return data

    def unlock2_f_with_http_info(self, async=False, **kwargs):
        """
        Re-authenticate to unlock two factor configuration. Two factor configuration must be unlocked to enable or disable two factor authentication, add or remove two factor devices, or regenerate recovery codes. The caller needs to provide a bearer token for the session in the request body. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.unlock2_f_with_http_info(async=True)
            >>> result = thread.get()
