...
class TwoFactorAuthenticationApi(object):
    ...
    def authorize_recovery_code(self, async=False, **kwargs):
        """
        ...
        if async:
            return self.authorize_recovery_code_with_http_info(async=async, **kwargs)
        else:
            (data) = self.authorize_recovery_code_with_http_info(async=async, **kwargs)
            return data

    def authorize_recovery_code_with_http_info(self, async=False, **kwargs):
        """
        Complete two factor authentication with a backup recovery code. The caller needs to provide a bearer token for the session in the request body. Each recovery code may only be used once, so users should update their two factor configuration after using this API. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.authorize_recovery_code_with_http_info(async=True)
            >>> result = thread.get()
    ...
    def authorize_u2_f(self, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.authorize_u2_f_with_http_info(async=async, **kwargs)
        else:
            (data) = self.authorize_u2_f_with_http_info(async=async, **kwargs)
            return data

    def authorize_u2_f_with_http_info(self, async=False, **kwargs):
        """
        Complete two factor authentication with a U2F authentication token to authenticate to SDKMS. The response body contains a bearer authentication token which needs to be provided by subsequent calls for the duration of the session. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.authorize_u2_f_with_http_info(async=True)
            >>> result = thread.get()
    ...
    def generate_recovery_codes(self, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.generate_recovery_codes_with_http_info(async=async, **kwargs)
        else:
            (data) = self.generate_recovery_codes_with_http_info(async=async, **kwargs)
            return data

    def generate_recovery_codes_with_http_info(self, async=False, **kwargs):
        """
        Generate backup recovery codes that may be used to complete complete two factor authentication. The caller needs to provide a bearer token for the session in the request body. Two factor configuration must be unlocked to use this API. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.generate_recovery_codes_with_http_info(async=True)
            >>> result = thread.get()
    ...
    def generate_u2_f_challenge(self, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.generate_u2_f_challenge_with_http_info(async=async, **kwargs)
        else:
            (data) = self.generate_u2_f_challenge_with_http_info(async=async, **kwargs)
            return data

    def generate_u2_f_challenge_with_http_info(self, async=False, **kwargs):
        """
        Generate a new challenge that may be used to register U2F devices. The caller needs to provide a bearer token for the session in the request body. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.generate_u2_f_challenge_with_http_info(async=True)
            >>> result = thread.get()
    ...
    def lock2_f(self, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.lock2_f_with_http_info(async=async, **kwargs)
        else:
            (data) = self.lock2_f_with_http_info(async=async, **kwargs)
            return data

    def lock2_f_with_http_info(self, async=False, **kwargs):
        """
        Lock two factor configuration after completing two factor reconfiguration. The caller needs to provide a bearer token for the session in the request body. If this API is not called, two factor configuration will be locked automatically after ten minutes. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.lock2_f_with_http_info(async=True)
            >>> result = thread.get()
