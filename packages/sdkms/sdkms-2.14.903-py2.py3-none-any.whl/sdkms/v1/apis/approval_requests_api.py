...
class ApprovalRequestsApi(object):
    ...
    def approve(self, request_id, async=False, **kwargs):
        """
        @type async: bool
        ...
        if async:
            return self.approve_with_http_info(request_id, async=async, **kwargs)
        else:
            (data) = self.approve_with_http_info(request_id, async=async, **kwargs)
            return data

    def approve_with_http_info(self, request_id, async=False, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.approve_with_http_info(request_id, async=True)
            >>> result = thread.get()
    ...
    def create_approval_request(self, body, async=False, **kwargs):
        """
        @type async: bool
        @param async: Whether the call should be performed asynchronously. (Default is False).
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.create_approval_request_with_http_info(body, async=async, **kwargs)
        else:
            (data) = self.create_approval_request_with_http_info(body, async=async, **kwargs)
            return data

    def create_approval_request_with_http_info(self, body, async=False, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.create_approval_request_with_http_info(body, async=True)
            >>> result = thread.get()
    ...
    def delete_approval_request(self, request_id, async=False, **kwargs):
        """
        @type async: bool
        @param async: Whether the call should be performed asynchronously. (Default is False).
        @type request_id: L{str}
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.delete_approval_request_with_http_info(request_id, async=async, **kwargs)
        else:
            (data) = self.delete_approval_request_with_http_info(request_id, async=async, **kwargs)
            return data

    def delete_approval_request_with_http_info(self, request_id, async=False, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.delete_approval_request_with_http_info(request_id, async=True)
            >>> result = thread.get()
    ...
    def deny(self, request_id, async=False, **kwargs):
        """
        @type async: bool
        @param async: Whether the call should be performed asynchronously. (Default is False).
        @type request_id: L{str}
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.deny_with_http_info(request_id, async=async, **kwargs)
        else:
            (data) = self.deny_with_http_info(request_id, async=async, **kwargs)
            return data

    def deny_with_http_info(self, request_id, async=False, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.deny_with_http_info(request_id, async=True)
            >>> result = thread.get()
    ...
    def get_approval_request(self, request_id, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.get_approval_request_with_http_info(request_id, async=async, **kwargs)
        else:
            (data) = self.get_approval_request_with_http_info(request_id, async=async, **kwargs)
            return data

    def get_approval_request_with_http_info(self, request_id, async=False, **kwargs):
        """
        Get the details and status of a particular approval request.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.get_approval_request_with_http_info(request_id, async=True)
            >>> result = thread.get()
    ...
    def get_approval_requests(self, requester=None, reviewer=None, subject=None, status=None, async=False, **kwargs):
        """
        @type async: bool
        @param async: Whether the call should be performed asynchronously. (Default is False).
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.get_approval_requests_with_http_info(requester=requester, reviewer=reviewer, subject=subject, status=status, async=async, **kwargs)
        else:
            (data) = self.get_approval_requests_with_http_info(requester=requester, reviewer=reviewer, subject=subject, status=status, async=async, **kwargs)
            return data

    def get_approval_requests_with_http_info(self, requester=None, reviewer=None, subject=None, status=None, async=False, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.get_approval_requests_with_http_info(async=True)
            >>> result = thread.get()
    ...
    def get_result(self, request_id, async=False, **kwargs):
        """
        @type async: bool
        @param async: Whether the call should be performed asynchronously. (Default is False).
        @type request_id: L{str}
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.get_result_with_http_info(request_id, async=async, **kwargs)
        else:
            (data) = self.get_result_with_http_info(request_id, async=async, **kwargs)
            return data

    def get_result_with_http_info(self, request_id, async=False, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.get_result_with_http_info(request_id, async=True)
            >>> result = thread.get()
