...
class AppsApi(object):
    ...
    def create_app(self, body, async=False, **kwargs):
        """
        ...
        if async:
            return self.create_app_with_http_info(body, async=async, **kwargs)
        else:
            (data) = self.create_app_with_http_info(body, async=async, **kwargs)
            return data

    def create_app_with_http_info(self, body, async=False, **kwargs):
        """
        Create a new application with the specified properties.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.create_app_with_http_info(body, async=True)
            >>> result = thread.get()
    ...
    def delete_app(self, app_id, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.delete_app_with_http_info(app_id, async=async, **kwargs)
        else:
            (data) = self.delete_app_with_http_info(app_id, async=async, **kwargs)
            return data

    def delete_app_with_http_info(self, app_id, async=False, **kwargs):
        """
        Remove an application from SDKMS.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.delete_app_with_http_info(app_id, async=True)
            >>> result = thread.get()
    ...
    def get_app(self, app_id, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.get_app_with_http_info(app_id, async=async, **kwargs)
        else:
            (data) = self.get_app_with_http_info(app_id, async=async, **kwargs)
            return data

    def get_app_with_http_info(self, app_id, async=False, **kwargs):
        """
        Look up an application by application ID.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.get_app_with_http_info(app_id, async=True)
            >>> result = thread.get()
    ...
    def get_apps(self, group_id=None, sort=None, start=None, limit=None, offset=None, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.get_apps_with_http_info(group_id=group_id, sort=sort, start=start, limit=limit, offset=offset, async=async, **kwargs)
        else:
            (data) = self.get_apps_with_http_info(group_id=group_id, sort=sort, start=start, limit=limit, offset=offset, async=async, **kwargs)
            return data

    def get_apps_with_http_info(self, group_id=None, sort=None, start=None, limit=None, offset=None, async=False, **kwargs):
        """
        Get details of all applications the current user has access to.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
    ...
    def get_credential(self, app_id, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.get_credential_with_http_info(app_id, async=async, **kwargs)
        else:
            (data) = self.get_credential_with_http_info(app_id, async=async, **kwargs)
            return data

    def get_credential_with_http_info(self, app_id, async=False, **kwargs):
        """
        Retrieve the authentication credential (API key or certificate) for a particular application. Only users who are an administrator of at least one of the application's groups can retrieve the credential.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.get_credential_with_http_info(app_id, async=True)
            >>> result = thread.get()
    ...
    def regenerate_api_key(self, app_id, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.regenerate_api_key_with_http_info(app_id, async=async, **kwargs)
        else:
            (data) = self.regenerate_api_key_with_http_info(app_id, async=async, **kwargs)
            return data

    def regenerate_api_key_with_http_info(self, app_id, async=False, **kwargs):
        """
        Create a new API key for an application. An application may only have one valid API key at a time, so performing this action will invalidate all old API keys. This does not invalidate existing sessions, so any applications with an existing open session will be able to continue operating with their old session until those sessions expire. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.regenerate_api_key_with_http_info(app_id, async=True)
            >>> result = thread.get()
    ...
    def update_app(self, app_id, body, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.update_app_with_http_info(app_id, body, async=async, **kwargs)
        else:
            (data) = self.update_app_with_http_info(app_id, body, async=async, **kwargs)
            return data

    def update_app_with_http_info(self, app_id, body, async=False, **kwargs):
        """
        Change an application's properties, such as name, description, or group membership.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.update_app_with_http_info(app_id, body, async=True)
            >>> result = thread.get()
