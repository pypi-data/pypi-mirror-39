...
class LogsApi(object):
    ...
    def get_audit_logs(self, size=None, _from=None, action_type=None, actor_type=None, actor_id=None, object_id=None, severity=None, range_from=None, range_to=None, async=False, **kwargs):
        """
        ...
        if async:
            return self.get_audit_logs_with_http_info(size=size, _from=_from, action_type=action_type, actor_type=actor_type, actor_id=actor_id, object_id=object_id, severity=severity, range_from=range_from, range_to=range_to, async=async, **kwargs)
        else:
            (data) = self.get_audit_logs_with_http_info(size=size, _from=_from, action_type=action_type, actor_type=actor_type, actor_id=actor_id, object_id=object_id, severity=severity, range_from=range_from, range_to=range_to, async=async, **kwargs)
            return data

    def get_audit_logs_with_http_info(self, size=None, _from=None, action_type=None, actor_type=None, actor_id=None, object_id=None, severity=None, range_from=None, range_to=None, async=False, **kwargs):
        """
        Get audit log entries matching the requested filters.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.get_audit_logs_with_http_info(async=True)
            >>> result = thread.get()
