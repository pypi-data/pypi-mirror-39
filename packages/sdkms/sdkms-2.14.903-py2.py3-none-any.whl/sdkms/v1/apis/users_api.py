...
class UsersApi(object):
    ...
    def change_password(self, body, async=False, **kwargs):
        """
        @type async: bool
        ...
        if async:
            return self.change_password_with_http_info(body, async=async, **kwargs)
        else:
            (data) = self.change_password_with_http_info(body, async=async, **kwargs)
            return data

    def change_password_with_http_info(self, body, async=False, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.change_password_with_http_info(body, async=True)
            >>> result = thread.get()
    ...
    def confirm_email(self, user_id, body, async=False, **kwargs):
        """
        @type async: bool
        @param async: Whether the call should be performed asynchronously. (Default is False).
        @type user_id: L{str}
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.confirm_email_with_http_info(user_id, body, async=async, **kwargs)
        else:
            (data) = self.confirm_email_with_http_info(user_id, body, async=async, **kwargs)
            return data

    def confirm_email_with_http_info(self, user_id, body, async=False, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.confirm_email_with_http_info(user_id, body, async=True)
            >>> result = thread.get()
    ...
    def create_user(self, body, async=False, **kwargs):
        """
        Signs up a new user.
        @type async: bool
        @param async: Whether the call should be performed asynchronously. (Default is False).
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.create_user_with_http_info(body, async=async, **kwargs)
        else:
            (data) = self.create_user_with_http_info(body, async=async, **kwargs)
            return data

    def create_user_with_http_info(self, body, async=False, **kwargs):
        """
        Signs up a new user.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
    ...
    def delete_user(self, user_id, async=False, **kwargs):
        """
        @type async: bool
        @param async: Whether the call should be performed asynchronously. (Default is False).
        @type user_id: L{str}
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.delete_user_with_http_info(user_id, async=async, **kwargs)
        else:
            (data) = self.delete_user_with_http_info(user_id, async=async, **kwargs)
            return data

    def delete_user_with_http_info(self, user_id, async=False, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
    ...
    def delete_user_account(self, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.delete_user_account_with_http_info(async=async, **kwargs)
        else:
            (data) = self.delete_user_account_with_http_info(async=async, **kwargs)
            return data

    def delete_user_account_with_http_info(self, async=False, **kwargs):
        """
        Completely deletes the currently logged in user from the system.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.delete_user_account_with_http_info(async=True)
            >>> result = thread.get()
    ...
    def forgot_password(self, body, async=False, **kwargs):
        """
        @type async: bool
        @param async: Whether the call should be performed asynchronously. (Default is False).
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.forgot_password_with_http_info(body, async=async, **kwargs)
        else:
            (data) = self.forgot_password_with_http_info(body, async=async, **kwargs)
            return data

    def forgot_password_with_http_info(self, body, async=False, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.forgot_password_with_http_info(body, async=True)
            >>> result = thread.get()
    ...
    def get_user(self, user_id, async=False, **kwargs):
        """
        @type async: bool
        @param async: Whether the call should be performed asynchronously. (Default is False).
        @type user_id: L{str}
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.get_user_with_http_info(user_id, async=async, **kwargs)
        else:
            (data) = self.get_user_with_http_info(user_id, async=async, **kwargs)
            return data

    def get_user_with_http_info(self, user_id, async=False, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
    ...
    def get_user_account(self, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.get_user_account_with_http_info(async=async, **kwargs)
        else:
            (data) = self.get_user_account_with_http_info(async=async, **kwargs)
            return data

    def get_user_account_with_http_info(self, async=False, **kwargs):
        """
        Obtain the current user's account information.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.get_user_account_with_http_info(async=True)
            >>> result = thread.get()
    ...
    def get_users(self, group_id=None, sort=None, start=None, limit=None, offset=None, async=False, **kwargs):
        """
        @type async: bool
        @param async: Whether the call should be performed asynchronously. (Default is False).
        @type group_id: L{str}
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.get_users_with_http_info(group_id=group_id, sort=sort, start=start, limit=limit, offset=offset, async=async, **kwargs)
        else:
            (data) = self.get_users_with_http_info(group_id=group_id, sort=sort, start=start, limit=limit, offset=offset, async=async, **kwargs)
            return data

    def get_users_with_http_info(self, group_id=None, sort=None, start=None, limit=None, offset=None, async=False, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
    ...
    def invite_user(self, body, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.invite_user_with_http_info(body, async=async, **kwargs)
        else:
            (data) = self.invite_user_with_http_info(body, async=async, **kwargs)
            return data

    def invite_user_with_http_info(self, body, async=False, **kwargs):
        """
        Invite an existing user or new user to join an existing account. Only user email is required for invite API 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.invite_user_with_http_info(body, async=True)
            >>> result = thread.get()
    ...
    def process_invitations(self, body, async=False, **kwargs):
        """
        Process a user's pending invitations. It does both accepts and rejects.
        @type async: bool
        @param async: Whether the call should be performed asynchronously. (Default is False).
        @type body: L{ProcessInviteRequest}
        @param body: Process account invitation (both accetps and rejects) (required)
        @rtype: None
        @return:
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.process_invitations_with_http_info(body, async=async, **kwargs)
        else:
            (data) = self.process_invitations_with_http_info(body, async=async, **kwargs)
            return data

    def process_invitations_with_http_info(self, body, async=False, **kwargs):
        """
        Process a user's pending invitations. It does both accepts and rejects.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.process_invitations_with_http_info(body, async=True)
            >>> result = thread.get()
    ...
    def resend_confirm_email(self, user_id, async=False, **kwargs):
        """
        @type async: bool
        @param async: Whether the call should be performed asynchronously. (Default is False).
        @type user_id: L{str}
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.resend_confirm_email_with_http_info(user_id, async=async, **kwargs)
        else:
            (data) = self.resend_confirm_email_with_http_info(user_id, async=async, **kwargs)
            return data

    def resend_confirm_email_with_http_info(self, user_id, async=False, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.resend_confirm_email_with_http_info(user_id, async=True)
            >>> result = thread.get()
    ...
    def resend_invitation(self, user_id, async=False, **kwargs):
        """
        @type async: bool
        @param async: Whether the call should be performed asynchronously. (Default is False).
        @type user_id: L{str}
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.resend_invitation_with_http_info(user_id, async=async, **kwargs)
        else:
            (data) = self.resend_invitation_with_http_info(user_id, async=async, **kwargs)
            return data

    def resend_invitation_with_http_info(self, user_id, async=False, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.resend_invitation_with_http_info(user_id, async=True)
            >>> result = thread.get()
    ...
    def reset_password(self, user_id, body, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.reset_password_with_http_info(user_id, body, async=async, **kwargs)
        else:
            (data) = self.reset_password_with_http_info(user_id, body, async=async, **kwargs)
            return data

    def reset_password_with_http_info(self, user_id, body, async=False, **kwargs):
        """
        Resetting a user's password. User must have a valid reset token from forgot password step.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.reset_password_with_http_info(user_id, body, async=True)
            >>> result = thread.get()
    ...
    def update_user(self, user_id, body, async=False, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.update_user_with_http_info(user_id, body, async=async, **kwargs)
        else:
            (data) = self.update_user_with_http_info(user_id, body, async=async, **kwargs)
            return data

    def update_user_with_http_info(self, user_id, body, async=False, **kwargs):
        """
        Change a user's properties.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
    ...
    def validate_password_reset_token(self, user_id, body, async=False, **kwargs):
        """
        @type async: bool
        @param async: Whether the call should be performed asynchronously. (Default is False).
        @type user_id: L{str}
        ...
        kwargs['_return_http_data_only'] = True
        if async:
            return self.validate_password_reset_token_with_http_info(user_id, body, async=async, **kwargs)
        else:
            (data) = self.validate_password_reset_token_with_http_info(user_id, body, async=async, **kwargs)
            return data

    def validate_password_reset_token_with_http_info(self, user_id, body, async=False, **kwargs):
        """
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True::
            >>> thread = api.validate_password_reset_token_with_http_info(user_id, body, async=True)
            >>> result = thread.get()
