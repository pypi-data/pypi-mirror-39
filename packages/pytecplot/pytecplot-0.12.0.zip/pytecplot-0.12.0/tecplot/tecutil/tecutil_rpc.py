...
class TecUtilRPC(object):
 ...
 def ArgListGetArgTypeByIndex(self,arg_list,index):
  ...
  self.chk(rep)
  return ArgListArgType(rep.args[0].int32)
 ...
 def AxisLabelGetNumberFormat(self,axis,axis_num):
  ...
  self.chk(rep)
  return NumberFormat(rep.args[0].int32)
 ...
 def ColorMapSetBase(self,base_color_map):
  ...
  self.chk(rep)
  return SetValueReturnCode(rep.args[0].int32)
 ...
 def DataFaceMapGetElementRawItemType(self,face_map):
  ...
  self.chk(rep)
  return OffsetDataType(rep.args[0].int32)
 ...
 def DataFaceNbrGetModeByRef(self,face_neighbor):
  ...
  self.chk(rep)
  return FaceNeighborMode(rep.args[0].int32)
 ...
 def DataSetGetVarLoadMode(self):
  ...
  self.chk(rep)
  return VarLoadMode(rep.args[0].int32)
 ...
 def DataValueGetLocation(self,zone,var):
  ...
  self.chk(rep)
  return ValueLocation(rep.args[0].int32)
 ...
 def DataValueGetRefType(self,field_data):
  ...
  self.chk(rep)
  return FieldDataType(rep.args[0].int32)
 ...
 def ElemOrientGetOrientation(self,element_orientation,element):
  ...
  self.chk(rep)
  return ElementOrientation(rep.args[0].int32)
 ...
 def FieldMapGetMode(self,field_map):
  ...
  self.chk(rep)
  return FieldMapMode(rep.args[0].int32)
 ...
 def FrameGetPlotType(self):
  ...
  self.chk(rep)
  return PlotType(rep.args[0].int32)
 ...
 def GeomArrowheadGetAttach(self,gid):
  ...
  self.chk(rep)
  return ArrowheadAttachment(rep.args[0].int32)
 ...
 def GeomArrowheadGetStyle(self,gid):
  ...
  self.chk(rep)
  return ArrowheadStyle(rep.args[0].int32)
 ...
 def GeomGetClipping(self,gid):
  ...
  self.chk(rep)
  return Clipping(rep.args[0].int32)
 ...
 def GeomGetDrawOrder(self,gid):
  ...
  self.chk(rep)
  return DrawOrder(rep.args[0].int32)
 ...
 def GeomGetLinePattern(self,gid):
  ...
  self.chk(rep)
  return LinePattern(rep.args[0].int32)
 ...
 def GeomGetPositionCoordSys(self,gid):
  ...
  self.chk(rep)
  return CoordSys(rep.args[0].int32)
 ...
 def GeomGetScope(self,gid):
  ...
  self.chk(rep)
  return Scope(rep.args[0].int32)
 def GeomGetType(self,gid):
  args=((ValueType.Scalar,c_int64,gid),)
  rep=self.sndrcv("GeomGetType",*args)
  self.chk(rep)
  return GeomForm(rep.args[0].int32)
 ...
 def GeomImageGetResizeFilter(self,gid):
  ...
  self.chk(rep)
  return ImageResizeFilter(rep.args[0].int32)
 ...
 def GetExportImageHeight(self,width,region):
  ...
  rep=self.sndrcv("GetExportImageHeight",*args)
  self.chk(rep)
  return rep.args[0].int32
 ...
 def ImageGetColorTable(self,red__array,green__array,blue__array):
  ...
  self.chk(rep)
  memmove(red__array, rep.args[0].buffer, sizeof(red__array))
  memmove(green__array, rep.args[1].buffer, sizeof(green__array))
  memmove(blue__array, rep.args[2].buffer, sizeof(blue__array))
 ...
 def ImageIndexedBitmapCreate(self,region,red_color_table__array,green_color_table__array,blue_color_table__array):
  ...
  self.chk(rep)
  memmove(red_color_table__array, rep.args[0].buffer, sizeof(red_color_table__array))
  memmove(green_color_table__array, rep.args[1].buffer, sizeof(green_color_table__array))
  memmove(blue_color_table__array, rep.args[2].buffer, sizeof(blue_color_table__array))
  return (rep.status == tecrpc.Reply.Success)
 def ImageIndexedGetScanLine(self,scan_line,rgb_index__array):
  ...
  self.chk(rep)
  memmove(rgb_index__array, rep.args[0].buffer, sizeof(rgb_index__array))
  return (rep.status == tecrpc.Reply.Success)
 ...
 def LastErrorMessageType(self):
  ...
  self.chk(rep)
  return MessageBoxType(rep.args[0].int32)
 ...
 def LineMapGetAssignment(self,line_map):
  ...
  return (
   ...
   rep.args[3].int32,
   rep.args[4].int32,
   FunctionDependency(rep.args[5].int32))
 ...
 def LineSegProbeGetStatus(self,line_seg_probe_result,which_segment):
  ...
  self.chk(rep)
  return ProbeStatus(rep.args[0].int32)
 ...
 def MouseGetCurrentMode(self):
  ...
  self.chk(rep)
  return MouseButtonMode(rep.args[0].int32)
 ...
 def PickListGetAxisSubObject(self,pick_list_index):
  ...
  self.chk(rep)
  return AxisSubObject(rep.args[0].int32)
 ...
 def PickListGetType(self,pick_list_index):
  ...
  self.chk(rep)
  return PickObjects(rep.args[0].int32)
 ...
 def ProbeAtPosition(self,x,y,z,i_cell,j_cell,k_cell,plane,cur_zone,start_with_local_cell,v_value__array,source_zones,search_volume,get_zone_only,get_nearest_point):
  ...
  self.chk(rep)
  memmove(v_value__array, rep.args[5].buffer, sizeof(v_value__array))
  return (
   (rep.status == tecrpc.Reply.Success),
   rep.args[0].int64,
   rep.args[1].int64,
   rep.args[2].int64,
   IJKPlanes(rep.args[3].int32),
   rep.args[4].int32)
 ...
 def ProbeFieldGetCZType(self):
  ...
  self.chk(rep)
  return CZType(rep.args[0].int32)
 ...
 def ProbeFieldGetPlane(self):
  ...
  self.chk(rep)
  return IJKPlanes(rep.args[0].int32)
 ...
 def StreamtraceGetType(self,stream_number):
  ...
  self.chk(rep)
  return Streamtrace(rep.args[0].int32)
 ...
 def StyleGetLowLevelX(self,arg_list):
  ...
  self.chk(rep)
  return GetValueReturnCode(rep.args[0].int32)
 ...
 def TecplotGetAppMode(self):
  ...
  self.chk(rep)
  return AppMode(rep.args[0].int32)
 ...
 def TextBoxGetType(self,tid):
  ...
  self.chk(rep)
  return TextBox(rep.args[0].int32)
 ...
 def TextGetAnchor(self,tid):
  ...
  self.chk(rep)
  return TextAnchor(rep.args[0].int32)
 ...
 def TextGetType(self,tid):
  ...
  self.chk(rep)
  return TextType(rep.args[0].int32)
 ...
 def ThreadTimedWaitForCondition(self,condition,mutex,wait_period_in_ms):
  ...
  self.chk(rep)
  return ConditionAwakeReason(rep.args[0].int32)
 ...
 def VarGetStatus(self,zone,var):
  ...
  self.chk(rep)
  return VarStatus(rep.args[0].int32)
 ...
 def ZoneGetType(self,zone):
  ...
  self.chk(rep)
  return ZoneType(rep.args[0].int32)
