...
class Site(object):
    ...
    * log: an object that will be used for logging. ConsoleLog is created by default
    ...
    def __call__(self, action, **kwargs):
        ...
        # Default to formatversion=2 unless user supplies a specific value
    ...
    def iterate(self, action, **kwargs):
        ...
        if 'formatversion' in kwargs:
            raise ValueError("formatversion is not supported with query() function, use object's __call__()")
