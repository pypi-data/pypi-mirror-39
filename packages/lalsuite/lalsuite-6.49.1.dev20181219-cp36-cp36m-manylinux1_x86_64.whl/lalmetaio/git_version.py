...
id = "6542f83c46ac518cfc90740fb8d4527f404e0fd6"
date = "2018-12-16 09:31:46 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "6542f83c46ac518cfc90740fb8d4527f404e0fd6":
        return
    msg = "Program id (6542f83c46ac518cfc90740fb8d4527f404e0fd6) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
