...
setup(
    ...
    version="1.0.0rc1",
    install_requires=['iotile_support_firm_accelerometer_2 >= 2.3.5, == 2.*', 'iotile_support_con_nrf52832_3 >= 3.1.12rc1, == 3.*', 'iotile_support_firm_env_1 >= 1.1.1, == 1.*', u'sortedcontainers ~= 2.1', u'iotile-core >= 3.24.1', u'iotile-ext-cloud >= 0.6.0', u'iotile-sensorgraph >= 0.8.0'],
