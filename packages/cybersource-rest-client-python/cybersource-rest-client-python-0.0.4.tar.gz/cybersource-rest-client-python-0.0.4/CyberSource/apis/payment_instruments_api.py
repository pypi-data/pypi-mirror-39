...
class PaymentInstrumentsApi(object):
    ...
    def tms_v1_instrumentidentifiers_token_id_paymentinstruments_get(self, profile_id, token_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.tms_v1_instrumentidentifiers_token_id_paymentinstruments_get(profile_id, token_id, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.tms_v1_instrumentidentifiers_token_id_paymentinstruments_get_with_http_info(profile_id, token_id, **kwargs)
        else:
            (data) = self.tms_v1_instrumentidentifiers_token_id_paymentinstruments_get_with_http_info(profile_id, token_id, **kwargs)
            return data

    def tms_v1_instrumentidentifiers_token_id_paymentinstruments_get_with_http_info(self, profile_id, token_id, **kwargs):
        """
        Retrieve all Payment Instruments associated with an Instrument Identifier
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.tms_v1_instrumentidentifiers_token_id_paymentinstruments_get_with_http_info(profile_id, token_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method tms_v1_instrumentidentifiers_token_id_paymentinstruments_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'profile_id' is set
        if ('profile_id' not in params) or (params['profile_id'] is None):
            raise ValueError("Missing the required parameter `profile_id` when calling `tms_v1_instrumentidentifiers_token_id_paymentinstruments_get`")
        ...
        if 'limit' in params and params['limit'] > 100:
            raise ValueError("Invalid value for parameter `limit` when calling `tms_v1_instrumentidentifiers_token_id_paymentinstruments_get`, must be a value less than or equal to `100`")
        if 'limit' in params and params['limit'] < 1:
            raise ValueError("Invalid value for parameter `limit` when calling `tms_v1_instrumentidentifiers_token_id_paymentinstruments_get`, must be a value greater than or equal to `1`")
    ...
    def tms_v1_paymentinstruments_post(self, profile_id, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.tms_v1_paymentinstruments_post(profile_id, body, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.tms_v1_paymentinstruments_post_with_http_info(profile_id, body, **kwargs)
        else:
            (data) = self.tms_v1_paymentinstruments_post_with_http_info(profile_id, body, **kwargs)
            return data

    def tms_v1_paymentinstruments_post_with_http_info(self, profile_id, body, **kwargs):
        """
        Create a Payment Instrument
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.tms_v1_paymentinstruments_post_with_http_info(profile_id, body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method tms_v1_paymentinstruments_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'profile_id' is set
        if ('profile_id' not in params) or (params['profile_id'] is None):
            raise ValueError("Missing the required parameter `profile_id` when calling `tms_v1_paymentinstruments_post`")
    ...
    def tms_v1_paymentinstruments_token_id_delete(self, profile_id, token_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.tms_v1_paymentinstruments_token_id_delete(profile_id, token_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.tms_v1_paymentinstruments_token_id_delete_with_http_info(profile_id, token_id, **kwargs)
        else:
            (data) = self.tms_v1_paymentinstruments_token_id_delete_with_http_info(profile_id, token_id, **kwargs)
            return data

    def tms_v1_paymentinstruments_token_id_delete_with_http_info(self, profile_id, token_id, **kwargs):
        """
        Delete a Payment Instrument
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.tms_v1_paymentinstruments_token_id_delete_with_http_info(profile_id, token_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method tms_v1_paymentinstruments_token_id_delete" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'profile_id' is set
        if ('profile_id' not in params) or (params['profile_id'] is None):
            raise ValueError("Missing the required parameter `profile_id` when calling `tms_v1_paymentinstruments_token_id_delete`")
        # verify the required parameter 'token_id' is set
        if ('token_id' not in params) or (params['token_id'] is None):
    ...
    def tms_v1_paymentinstruments_token_id_get(self, profile_id, token_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.tms_v1_paymentinstruments_token_id_get(profile_id, token_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.tms_v1_paymentinstruments_token_id_get_with_http_info(profile_id, token_id, **kwargs)
        else:
            (data) = self.tms_v1_paymentinstruments_token_id_get_with_http_info(profile_id, token_id, **kwargs)
            return data

    def tms_v1_paymentinstruments_token_id_get_with_http_info(self, profile_id, token_id, **kwargs):
        """
        Retrieve a Payment Instrument
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.tms_v1_paymentinstruments_token_id_get_with_http_info(profile_id, token_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method tms_v1_paymentinstruments_token_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'profile_id' is set
        if ('profile_id' not in params) or (params['profile_id'] is None):
            raise ValueError("Missing the required parameter `profile_id` when calling `tms_v1_paymentinstruments_token_id_get`")
        # verify the required parameter 'token_id' is set
        if ('token_id' not in params) or (params['token_id'] is None):
    ...
    def tms_v1_paymentinstruments_token_id_patch(self, profile_id, token_id, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.tms_v1_paymentinstruments_token_id_patch(profile_id, token_id, body, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.tms_v1_paymentinstruments_token_id_patch_with_http_info(profile_id, token_id, body, **kwargs)
        else:
            (data) = self.tms_v1_paymentinstruments_token_id_patch_with_http_info(profile_id, token_id, body, **kwargs)
            return data

    def tms_v1_paymentinstruments_token_id_patch_with_http_info(self, profile_id, token_id, body, **kwargs):
        """
        Update a Payment Instrument
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.tms_v1_paymentinstruments_token_id_patch_with_http_info(profile_id, token_id, body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method tms_v1_paymentinstruments_token_id_patch" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'profile_id' is set
        if ('profile_id' not in params) or (params['profile_id'] is None):
            raise ValueError("Missing the required parameter `profile_id` when calling `tms_v1_paymentinstruments_token_id_patch`")
        # verify the required parameter 'token_id' is set
        if ('token_id' not in params) or (params['token_id'] is None):
            raise ValueError("Missing the required parameter `token_id` when calling `tms_v1_paymentinstruments_token_id_patch`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
