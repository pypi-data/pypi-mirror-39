...
class PtsV2PaymentsPost201ResponseProcessorInformationIssuer(object):
    """
    ...
    def __init__(self, country=None, discretionary_data=None):
        """
        PtsV2PaymentsPost201ResponseProcessorInformationIssuer - a model defined in Swagger
        """
    ...
    def country(self):
        """
        Gets the country of this PtsV2PaymentsPost201ResponseProcessorInformationIssuer.
        ...
        :return: The country of this PtsV2PaymentsPost201ResponseProcessorInformationIssuer.
        :rtype: str
        """
    ...
    def country(self, country):
        """
        Sets the country of this PtsV2PaymentsPost201ResponseProcessorInformationIssuer.
        Country in which the card was issued. This information enables you to determine whether the card was issued domestically or internationally. Use the two-character ISO Standard Country Codes.  This field is supported for Visa, Mastercard, Discover, Diners Club, JCB, and Maestro (International) on Chase Paymentech Solutions. 

        :param country: The country of this PtsV2PaymentsPost201ResponseProcessorInformationIssuer.
        :type: str
        """
    ...
    def discretionary_data(self):
        """
        Gets the discretionary_data of this PtsV2PaymentsPost201ResponseProcessorInformationIssuer.
        ...
        :return: The discretionary_data of this PtsV2PaymentsPost201ResponseProcessorInformationIssuer.
        :rtype: str
        """
    ...
    def discretionary_data(self, discretionary_data):
        """
        Sets the discretionary_data of this PtsV2PaymentsPost201ResponseProcessorInformationIssuer.
        Data defined by the issuer. The value for this reply field will probably be the same as the value that you submitted in the authorization request, but it is possible for the processor, issuer, or acquirer to modify the value.  This field is supported only for Visa transactions on **CyberSource through VisaNet**. 

        :param discretionary_data: The discretionary_data of this PtsV2PaymentsPost201ResponseProcessorInformationIssuer.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, PtsV2PaymentsPost201ResponseProcessorInformationIssuer):
            return False
