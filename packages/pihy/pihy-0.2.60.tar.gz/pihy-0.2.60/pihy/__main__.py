...
storage_path_ph_long = "/var/www/raspberry_reactjs/logs/ph.json"
storage_path_ph_short = "/var/www/raspberry_reactjs/logs/ph_short.json"
storage_path_pump = "/var/www/raspberry_reactjs/logs/pump.json"
storage_path_pump_run = "/var/www/raspberry_reactjs/logs/pump_run.json"
...
def Log(storage, xVal):
  ...
  with open(storage_path_ph_long, 'w') as outfile:
...
def PHShort():
  xVal = ph.query("R")
  xTime = Log(storage_path_ph_short, xVal)
