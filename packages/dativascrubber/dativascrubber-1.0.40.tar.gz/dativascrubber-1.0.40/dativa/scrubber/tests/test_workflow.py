...
from dativa.scrubber import ScrubberValidationError, Scrubber, DefaultReportWriter
...
class WorkflowTests(_BaseTest):
    ...
    def test_report_writer(self):
        ...
        self.assertEqual(report[0].get_records().shape[0], 26)

        self.assertEqual(report[1].get_log_dict()["field"], "TotalEpisodes_clean")
        self.assertEqual(report[1].get_log_dict()["rule"], "Number")
        self.assertEqual(report[1].get_log_dict()["number_records"], 16)
        self.assertEqual(report[1].get_log_dict()["category"], "quarantined")
        self.assertEqual(report[1].get_log_dict()["description"], "Removed duplicates")
        self.assertEqual(report[1].get_records().shape[0], 16)

        self.assertEqual(report[2].get_log_dict()["field"], "TotalEpisodes")
        self.assertEqual(report[2].get_log_dict()["rule"], "Number")
        self.assertEqual(report[2].get_log_dict()["number_records"], 1)
        self.assertEqual(report[2].get_log_dict()["category"], "replaced")
        self.assertEqual(report[2].get_log_dict()["description"], "Replaced with default value")
        self.assertEqual(report[2].get_records().shape[0], 1)
