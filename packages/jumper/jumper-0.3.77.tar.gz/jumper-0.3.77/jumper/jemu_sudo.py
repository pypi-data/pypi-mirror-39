...
class JemuSudo(JemuMemPeripheral):
    ...
    def __init__(self, jemu_connection, id, peripheral_type, gdb_mode):
    ...
    def stop_after_ns(self, nanoseconds):
        ...
        self._jemu_connection.send_command(json_command, self._id, self._peripheral_type)
    ...
    def set_timer(self, ns, callback):
        with self._timers_lock:
            ...
            response = self._jemu_connection.send_command(json_command, self._id, self._peripheral_type)
    ...
    def get_pin_level(self, pin_num):
        jemu_packet = self._jemu_connection.send_command(self._get_pin_level_message(pin_num), self._id, self._peripheral_type)
    ...
    def set_pin_level(self, pin_num, pin_level):
        self._jemu_connection.send_command_async(self._set_pin_level_message(pin_num, pin_level > 0), self._id, self._peripheral_type)
