...
class Vlab (object):
    ...
    def __init__(
        ...
        self._uart = JemuUart(self) if self._platform is None else JemuUart(self, mcu_name=self._platform)  # after _build_components_methods
    ...
    def _init_web_app_with_token(self, token, no_browser):
        ...
        try:
            ...
            self._analytics = Analytics(self._web_api, local_jemu=self._local_jemu)
            self._user_error_reporting.set_web_api(self._web_api)
            self._user_error_reporting.set_analytics(self._analytics)
    ...
    def _build_components_methods(self):
        ...
        if os.path.isfile(board_json):
            ...
            if self._platform in platforms_list_lower:
    ...
    def _parse_bsp_json(self, bsp_path):
        ...
        return bsp_json_parser.get_components(self._jemu_connection, self._gdb_mode)
