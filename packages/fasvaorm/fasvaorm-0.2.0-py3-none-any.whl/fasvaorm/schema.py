...
class ModuleSchema(Schema):
    ...
    processed = fields.List(fields.String(), required=True, allow_none=True)
...
class ConfigurationSchema(Schema):
    ...
    startDate = fields.DateTime(required=True, allow_none=False)
...
class EnrichmentSchema(Schema):
    ...
    enriched_on = fields.DateTime(required=True, allow_none=False)
