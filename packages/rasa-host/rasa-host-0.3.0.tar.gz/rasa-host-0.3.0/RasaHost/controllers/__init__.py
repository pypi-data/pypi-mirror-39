__all__ = ['home_controller', 'nlu_controller', 'stories_controller', 'domain_controller', 'logs_controller', 'rasa_controller', 'chat_controller', 'models_controller']
...
from RasaHost.controllers import models_controller
