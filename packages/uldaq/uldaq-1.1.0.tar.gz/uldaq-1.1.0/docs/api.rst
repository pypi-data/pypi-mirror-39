...
.. autoclass:: AiConfig()
    ...
    **Method**                                         **Description**
    ...
    :func:`~AiConfig.get_chan_sensor_coefficients`     Gets the sensor coefficients being used for the
                                                       specified A/D channel.
    :func:`~AiConfig.set_auto_zero_mode`               Configures the auto zero mode for the analog input
                                                       subsystem.
...
AoConfig class
===============
Provides information about the configuration of the analog output subsystem.
