...
class JobsApi(object):
    ...
    def get_all_jobs(self, **kwargs):  # noqa: E501
        ...
        :param int skip: Skip number of jobs
        :param int limit: Limit number of returned jobs
        :param str after_id: Return jobs after the given id
        :param str filter: Filter to apply
        :param str sort: The sorting algorithm to use
        :param bool async_: Perform the request asynchronously
    ...
    def get_all_jobs_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['states', 'tags', 'skip', 'limit', 'after_id', 'filter', 'sort']  # noqa: E501
        all_params.append('async_')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
