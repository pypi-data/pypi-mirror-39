...
class forcaster(SupervisedLearnerPrimitiveBase[Inputs, Outputs, Params, Hyperparams]):
    """
    ...
    def set_training_data(self, *, inputs: Inputs) -> None:  # type: ignore
        ...
        self._RUNLEN = (train_vs_test['d3mIndex'].loc['TRAIN'])
    ...
    def produce(self, *, inputs: Inputs, iterations: int = None) -> CallResult[Outputs]:
        ...
        prediction = []
        print(thresolds)
        for i in range(self._RUNLEN, self._FITLEN):
