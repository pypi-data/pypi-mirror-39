...
def index(request, template_name="templates/lbforum/index.html"):
    ctx = {}
    topics = None
    user = request.user
...
def recent(request, template_name="templates/lbforum/recent.html"):
    ctx = {}
    user = request.user
    topics = get_all_topics(user)
    q = request.GET.get('q', '')
...
def forum(
        ...
        template_name="templates/lbforum/forum.html"):
...
def topic(request, topic_id, template_name="templates/lbforum/topic.html"):
    user = request.user
...
@csrf_exempt
def markitup_preview(request, template_name="templates/lbforum/markitup_preview.html"):
...
def new_post(
        ...
        template_name='templates/lbforum/post.html'):
    user = request.user
