...
class SolutionCallback(_object):
    ...
    def NumBinaryPropagations(self):
        return _pywrapsat.SolutionCallback_NumBinaryPropagations(self)

    def NumIntegerPropagations(self):
    ...
    def SolutionIntegerValue(self, index):
        return _pywrapsat.SolutionCallback_SolutionIntegerValue(self, index)

    def SolutionBooleanValue(self, index):
...
def SatHelper_SolveWithParametersAndSolutionCallback(model_proto, parameters, callback):
...
def SatHelper_SolverResponseStats(response):
...
def SatHelper_ValidateModel(model_proto):
