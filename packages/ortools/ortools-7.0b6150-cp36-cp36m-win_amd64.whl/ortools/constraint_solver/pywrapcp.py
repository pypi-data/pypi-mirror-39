...
class RoutingModel(_object):
    ...
    def GetDimensionsWithSoftAndSpanCosts(self) -> "std::vector< operations_research::RoutingDimension * >":
        return _pywrapcp.RoutingModel_GetDimensionsWithSoftAndSpanCosts(self)
    ...
    def AddTypeIncompatibility(self, type1: 'int', type2: 'int') -> "void":
        return _pywrapcp.RoutingModel_AddTypeIncompatibility(self, type1, type2)

    def GetTypeIncompatibilities(self, type: 'int') -> "absl::flat_hash_set< int > const &":
        return _pywrapcp.RoutingModel_GetTypeIncompatibilities(self, type)
