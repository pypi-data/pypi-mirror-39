...
class TestSites(unittest.TestCase):
    ...
    def setUp(self):
        self.path = join(os.path.dirname(os.path.realpath(__file__)), "../sites")
    ...
    def test_getContent(self):
        for hostname in self.hostnames:
            ...
            module = getattr(import_module('{}.{}'.format('sites', hostname)), module_name)()
            link = LINKS[hostname]
            if link:
    ...
    def test_DocumentNotFound(self):
        module = getattr(import_module('{}.{}'.format('sites', "unitrier")), "Unitrier")()
