...
@click.option('--format', '-f', default='{env} {orgName} {orgId}', help='The available column names for this command are {profile} {env} {orgName} {orgId}')
def add(profile_name, format):
