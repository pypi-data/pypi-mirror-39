...
class SDKRenderer(PointsRenderer):
    ...
    def update(self):
        ...
        if self._new_points_list.empty() and (cepton_sdk.capture_replay.is_open()):
            if cepton_sdk.capture_replay.is_end() and (not cepton_sdk.capture_replay.get_enable_loop()):
                return
        ...
        self.points_selector.points = points[points.valid]
        self.points = points
        self.refresh()
        self.save_frame()
        return True
