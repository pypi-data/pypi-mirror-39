...
from clusterone.business_logic.job_commands import CreateDistributedJobCommand
...
@click.option(
    ...
    help='Docker image to be used for parameter server.',
)
def command(context, **kwargs):
    ...
    cmd = CreateDistributedJobCommand(client=context.client, kwargs=kwargs)
