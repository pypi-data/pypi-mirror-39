...
from dlpipeline.demo.load import load_graph, image_to_tensor
...
#with open('/home/heider/Projects/IBBD5/dlpipeline/dlpipeline/demo/web_app_demo/app/models/vgg16_cat_list.pk',
#          'rb') as f:
#  cat_list = pk.load(f)
...
def run_models(img_path,base_path,time_path):
  ...
  results = sorcery.dict_of(vgg_predictions,
                             dlp_predictions)

  return NOD(sorcery.dict_of(results,
                             message))
