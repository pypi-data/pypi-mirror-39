...
class Hyvebrain:
    ...
    def clearTextContent( self, text_content ):
        self.text_content = ""
        return self

    # functions #
    def clearFunctions( self, functions ):
        self.functions = []
        return self
    ...
    # build #
    def build( self ):
        json_obj = { "text_content" : self.text_content, "functions": self.functions, "return_natural_language_raw_data": self._return_natural_language_raw_data } 
