...
class KiWISStore(TimeSeriesStore):
    ...
    def __init__(self, base_url: str, data_source: int=0, user: str=None, password: str=None):
        self._kiwis = KiWIS(base_url, data_source, user=user, password=password, create_pandas=False)

    def change_data_source(self, data_source: int=None):
        self._kiwis._KiWIS_data_source = data_source
