...
class DefaultApi(object):
    ...
    def vehicle_financial_portfolio_options(self, **kwargs):  # noqa: E501
        """vehicle_financial_portfolio_options  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.vehicle_financial_portfolio_options(async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.vehicle_financial_portfolio_options_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.vehicle_financial_portfolio_options_with_http_info(**kwargs)  # noqa: E501
            return data

    def vehicle_financial_portfolio_options_with_http_info(self, **kwargs):  # noqa: E501
        """vehicle_financial_portfolio_options  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.vehicle_financial_portfolio_options_with_http_info(async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method vehicle_financial_portfolio_options" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/vehicle/financial/portfolio', 'OPTIONS',
            path_params,
            query_params,
            header_params,
            body=body_params,
