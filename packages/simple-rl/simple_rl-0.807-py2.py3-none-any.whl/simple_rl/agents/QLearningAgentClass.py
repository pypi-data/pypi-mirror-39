...
class QLearningAgent(Agent):
    ...
    def _anneal(self):
        ...
        # if self.episode_number % 5 == 0 and self.step_number % 100 == 0:
        #     print "\t", self.episode_number, self.step_number, self.epsilon, self.epsilon_init, self.alpha, self.alpha_init
