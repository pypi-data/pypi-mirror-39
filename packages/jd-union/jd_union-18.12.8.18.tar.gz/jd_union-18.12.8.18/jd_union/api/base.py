...
class RestApi(object):
    ...
    def __init__(self, domain='gw.api.360buy.net', port=80):
        ...
        if (jd_union.getDefaultAppInfo()):
            self.__app_key = jd_union.getDefaultAppInfo().appkey
            self.__secret = jd_union.getDefaultAppInfo().secret
    ...
    def set_app_info(self, appinfo):
        # =======================================================================
        # 设置请求的app信息
        # @param appinfo: import jd_union
        #                 appinfo jd_union.appinfo(appkey,secret)
        # =======================================================================
    ...
    def getResponse(self, accessToken=None, timeout=30):
        ...
        connection.connect()
        url = "http://" + self.__domain + N_REST + "?" + urllib.parse.urlencode(sys_parameters)
