...
def meme(memeFilePath, *points, imageName="meme.png", saveMeme=False):
	...
	try:
		...
		memeFilePath = pkg_resources.resource_filename(__name__, 'Memes/' + memeFileName)
	...
	for point in ymlData['text']:
		...
		fontLocation = pkg_resources.resource_filename('DotMeme', 'font.ttf')
...
def listMemes():
	...
	"""
	for meme in pkg_resources.resource_listdir(__name__, 'Memes'):
		yield meme
