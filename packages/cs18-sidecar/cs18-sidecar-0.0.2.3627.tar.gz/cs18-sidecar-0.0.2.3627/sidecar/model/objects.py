...
class AzureSidecarConfiguration(ISidecarConfiguration):
    def __init__(self,
                 ...
                 messaging: MessagingConnectionProperties,
                 env_type: str):
        super().__init__(environment, "azure", sandbox_id, space_id, cloud_external_key, apps, messaging, env_type)
...
class AwsSidecarConfiguration(ISidecarConfiguration):
    def __init__(self,
                 ...
                 messaging: MessagingConnectionProperties,
                 env_type: str):
        super().__init__(environment, "aws", sandbox_id, space_id, cloud_external_key, apps, messaging, env_type)
...
class KubernetesSidecarConfiguration(ISidecarConfiguration):
    def __init__(self, kub_api_address: str,
                 ...
                 messaging: MessagingConnectionProperties,
                 env_type: str):
        super().__init__(environment, "kubernetes", sandbox_id, space_id, cloud_external_key, apps, messaging, env_type)
