...
class AzureStatusMaintainer:
    ...
    def __init__(self, cosmos_service: AzureCosmosService, entry_id: str):
    ...
    def _get_sandbox_document_with_retries(self):
        return self._cosmos_service.find_document_by_id(id=self._entry_id)
    ...
    def update_app_instance_status(self, instance_logical_id, instance_id, app_name, status):
        with self._lock:
            ...
            self._cosmos_service.update_document(id=self._entry_id,
                                                 update_param={
                                                     '$set': {
