...
# ############################################################################
EXTERNAL_RETRY = True if str(os.getenv('EXTERNAL_RETRY', 'false')).lower() == 'true' else False
if EXTERNAL_RETRY:
    EXTERNAL_RETRY = {
        'number': os.environ.get('EXTERNAL_RETRY_NUMBER', '2'),
        'factor': os.environ.get('EXTERNAL_RETRY_FACTOR', '0.1'),
        'status_codes': os.environ.get('EXTERNAL_RETRY_STATUS_CODES', '500, 502'),
    }
