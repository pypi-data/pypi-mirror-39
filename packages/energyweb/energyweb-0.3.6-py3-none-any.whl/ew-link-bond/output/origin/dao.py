...
from core import LocalFileData, ChainData, RawEnergyData, RawCarbonEmissionData
...
class ConsumptionFileData(LocalFileData):
    ...
    """
    def __init__(self, raw_energy: RawEnergyData, consumed: ConsumedChainData):
...
class ProductionFileData(LocalFileData):
    ...
    """
    def __init__(self, raw_energy: RawEnergyData, raw_carbon_emitted: RawCarbonEmissionData, produced: ProducedChainData):
        self.raw_energy = raw_energy
