...
class Zone():
    ...
    def turnon_tacto(self):
        new_value = change_bit_value(self._zone_state, 0, 2, 1)
        self.write_register(0, new_value)

    def turnoff_tacto(self):
        new_value = change_bit_value(self._zone_state, 0, 2, 0)
        self.write_register(0, new_value)
    ...
    def turnon_hold(self):
        new_value = change_bit_value(self._zone_state, 0, 3, 1)
        self.write_register(0, new_value)

    def turnoff_hold(self):
        new_value = change_bit_value(self._zone_state, 0, 3, 0)
        self.write_register(0, new_value)
