...
# meme temps.
###
with open(path.join(here, 'rewrite_pdf', '__init__.py'), encoding='utf-8') as f:
...
setup(
    ...
    description='A wrapper around ghostscript to rewrite pdf',
    ...
    entry_points={
        'console_scripts': [
            "rewrite_pdf=rewrite_pdf.bin.rewrite_pdf:main",
        ],
    },
)
