...
setup(
    ...
    version="0.4.0rc3",
    install_requires=['iotile_support_con_nrf52832_3 >= 3.1.9rc2, == 3.*', 'iotile_support_firm_accelerometer_2 >= 2.3.5rc4, == 2.*', 'iotile_support_firm_env_1 >= 1.1.1, == 1.*', u'sortedcontainers ~= 2.1', u'iotile-core >= 3.23.1', u'iotile-ext-cloud >= 0.6.0', u'iotile-sensorgraph >= 0.7.2'],
