...
class IloEnv(_object):
    ...
    def makeSymbol(self, key):
        return _opl.IloEnv_makeSymbol(self, key)

    def _createOplModel(self, modelSource):
...
class IloOplModelDefinition(_object):
    ...
    def getElementDefinition(self, name):
...
class IloTupleSchema(_object):
    ...
    def _hasSubTuple(self):
        return _opl.IloTupleSchema__hasSubTuple(self)

    def _getTupleColumn(self, i):
...
class IloOplModel(_object):
    ...
    def getElementNamesInPostProcessing(self):
    ...
    def convertAllIntVars(self):
        return _opl.IloOplModel_convertAllIntVars(self)

    def unconvertAllIntVars(self):
...
def IloOplModel__makeModelSourceFromString(env, model):
...
class IloOplElementDefinition(_object):
    ...
    def getElementDefinitionType_asInt(self):
...
class IloOplProfiler(_object):
    ...
    def setIgnoreUserSection(self, arg2):
...
class IloOplSettings(_object):
    ...
    def setSkipWarnNeverUsedElements(self, value):
...
class IloCplex(_object):
    ...
    def getNbarrierIterations(self):
        return _opl.IloCplex_getNbarrierIterations(self)

    def getNsiftingIterations(self):
        return _opl.IloCplex_getNsiftingIterations(self)

    def getNsiftingPhaseOneIterations(self):
