...
class ClinicalSubjectLoader(BaseLoader):
    ...
    def validate(self):
        ...
        if 'subject_label' not in D.columns:
            print('No column named "subject_label". This is required, and must be the unique subject label.')
            return False
    ...
    def ingest(self, D):
        ...
        res = self.conn.execute("SELECT id FROM subjects WHERE subject_label in {} and dataset_id={};"
                                .format(
