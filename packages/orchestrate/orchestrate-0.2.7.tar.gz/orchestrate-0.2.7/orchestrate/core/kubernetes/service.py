...
class KubernetesService(Service):
  ...
  def test_config(self, retries=0, wait_time=5):
    # TODO(Nakul): Figure out how/where service is created and change it to be in the orchestrate namespace
    # asana - https://app.asana.com/0/697026535962187/947782483639457/f
    for try_number in range(retries + 1):
      try:
