...
def _backward_ngraph_subgraph_op(name=None, attr=None, out=None, **kwargs):
    r"""
...
def _ngraph_subgraph_op(*data, **kwargs):
    r"""_ngraph_subgraph_op

    Defined in src/operator/contrib/ngraph.cc:L255
    This function support variable length of positional input.
