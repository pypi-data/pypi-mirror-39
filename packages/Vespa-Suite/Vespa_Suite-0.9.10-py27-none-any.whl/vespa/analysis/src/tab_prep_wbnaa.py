...
import auto_gui.fidsum_wbnaa as fidsum_wbnaa
...
from plot_panel_prep_wbnaa import PlotPanelPrepWbnaa, PlotPanelPrepWbnaaSeries
...
class TabPrepWbnaa(tab_base.Tab, fidsum_wbnaa.PanelPrepWbnaaUI):
    ...
    def initialize_controls(self):
        ...
        width, height = self.SpinFidLeftShift.GetSizeTuple()
    ...
    def on_ref_spectrum_source(self, event): 
        ...
        val = constants.WbnaaRefSpectrumSource.choices.keys()[index]
