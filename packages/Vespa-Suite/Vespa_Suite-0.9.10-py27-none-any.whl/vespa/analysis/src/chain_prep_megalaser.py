...
# Our modules
import constants
import chain_prep_identity

import functors.funct_fidsum_wbnaa as funct_fidsum_megalaser
import functors.functor as functor




class ChainPrepMegalaser(chain_prep_identity.ChainPrepIdentity):
    """ 
    ...
    def __init__(self, dataset, block):
        ...
        self.functor_all = funct_fidsum_megalaser.do_processing_all
