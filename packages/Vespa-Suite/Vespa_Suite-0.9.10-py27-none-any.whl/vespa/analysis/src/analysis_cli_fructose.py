...
import fileio.dicom_siemens_timeseries as fileio_dicom_siemens_timeseries
...
def main():
    ...
    paths = filter(os.path.isdir, [os.path.join(STARTDIR,f) for f in os.listdir(STARTDIR)])
    paths = paths[::-1]
