...
import vespa.common.mrs_data_raw_fidsum_uncom as mrs_data_raw_fidsum_uncomb
...
class RawReaderSiemensTwixSlaserCmrrVe(raw_reader.RawReader):
    ...
    def read_raw(self, filename, ignore_data=False, open_dataset=None):
        ...
        raw = mrs_data_raw_fidsum_uncomb.DataRawFidsumUncomb(d)
...
def _extract_parameters(evps):
    ...
    d["dims"]           = mrs_data_raw_fidsum_uncomb.DataRawFidsumUncomb.DEFAULT_DIMS
