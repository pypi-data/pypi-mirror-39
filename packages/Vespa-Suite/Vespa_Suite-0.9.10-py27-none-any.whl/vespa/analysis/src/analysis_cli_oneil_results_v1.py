...
import fileio.dicom_siemens as fileio_dicom_siemens
...
from vespa.analysis.src.auto_gui import watref
...
def analysis_cli_oneil_results(dataset, csvfile, viffpath='', 
    ...
    data_source = raw.get_data_source(dataset.all_voxels[0])
...
#        ax.yaxis.set_minor_locator(MultipleLocator(2.0))
    ...
    msg = u"Vespa-Analysis Version: %s                            Processing Timestamp: %s" % (vespa_version, timestamp)
