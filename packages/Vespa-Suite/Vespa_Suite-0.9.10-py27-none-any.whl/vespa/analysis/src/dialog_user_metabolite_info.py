...
class DialogUserMetaboliteInfo(dialog_user_metabolite_info.MyDialog):
    ...
    def _improve_height(self):
        ...
        dialog_width, dialog_height = self.GetSizeTuple()
        ...
        _, r_height = self.ScrolledWindowDynamicList.GetClientSizeTuple()
    ...
    def _initialize_controls(self):
        ...
        for heading in headings:
            if heading:
                ...
                self.MetaboliteGridSizer.AddSpacer( (1, 1) )
...
class DynamicMetinfoList(object):
    ...
    def add_row(self, item=None, notify_parent=True):
        ...
        if notify_parent:
            ...
            dialog_width, dialog_height = self.parent.GetSizeTuple()
