...
class PlotPanelPrepTimeseries(plot_panel_spectrum.PlotPanelSpectrum):
    ...
    def on_middle_motion(self, xcur, ycur, xprev, yprev, iplot):
        ...
        self.tab.FloatGlobalPhase1.SetValue(val)
        val = self.tab.block.set.global_phase0
        self.tab.FloatGlobalPhase0.SetValue(val)
