...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.7.2 on Fri Jul 07 15:41:57 2017
#
...
class PanelPrepTimeseriesUI(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.SpinFidsToAverage = wx.SpinCtrl(self.PanelFidAveraging, wx.ID_ANY, "0", min=1, max=100)
        ...
        self.FloatGlobalPhase1 = FloatSpin(self.PanelFidCorrectionsAndAveraging, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        self.label_12 = wx.StaticText(self.PanelFidCorrectionsAndAveraging, wx.ID_ANY, "Global Phase 0 [deg:")
        self.FloatGlobalPhase0 = FloatSpin(self.PanelFidCorrectionsAndAveraging, wx.ID_ANY, value=0.0, digits=1, min_val=0.0, max_val=360.0, increment=1.0, agwStyle=FS_LEFT)
