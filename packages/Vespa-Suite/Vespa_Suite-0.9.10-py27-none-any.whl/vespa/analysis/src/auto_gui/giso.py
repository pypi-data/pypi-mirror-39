...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.7.2 on Tue May 30 08:54:19 2017
#
...
class PanelGisoUI(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.VoigtNotebook = wx.Notebook(self.PanelControls, wx.ID_ANY)
        ...
        self.FloatPriorPpmStart = FloatSpin(self.panel_2, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
        self.FloatPriorPpmEnd = FloatSpin(self.panel_2, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
