...
if wx_util.is_wx_floatspin_ok():
    ...
    from vespa.common.wx_gravy.widgets.floatspin.floatspin import EVT_FLOATSPIN
...
class FloatSpinProperty(Property, _activator):
    ...
    def display(self, parent):
        ...
        self.spin = FloatSpinMultiplier(parent, self.id, increment=0.001, min_val=self.val_range[0], max_val=self.val_range[1])
