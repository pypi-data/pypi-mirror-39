...
# Our modules
import tab_experiment
import dialog_calculate_add_sub
...
class NotebookExperiments(vespa_notebooks.VespaAuiNotebook):
    ...
    WELCOME_TAB_TEXT = """
    <html><body>
    <h1>Welcome to Vespa - Simulation</h1>
    <img src="%s" alt="Time-Freq Plots" />
    <p><b>Currently there are no experiments loaded.</b></p>
    <p>You can use the Experiment menu to load an existing experiment or 
