...
# Our modules
import auto_gui.manage_pulse_sequences as gui_manage_pulse_sequences
import dialog_pulse_sequence_info
import dialog_pulse_sequence_editor
...
class DialogManagePulseSequences(gui_manage_pulse_sequences.MyDialog):
    ...
    def __init__(self, parent, db):
        ...
        if self.pulse_sequences:
            ...
            list_width, list_height = self.ListPulseSequences.GetSizeTuple()
...
Would you like to see the import log?"""            
    ...
    def populate_pulse_sequences(self):
        ...
        for i, pulse_sequence in enumerate(self.pulse_sequences):
            self.ListPulseSequences.InsertStringItem(i, pulse_sequence.name)

            # Mark the public column if necessary
            public = "x" if pulse_sequence.is_public else " "
            self.ListPulseSequences.SetStringItem(i, 1, public)
            ...
            self.ListPulseSequences.SetStringItem(i, 2, usage_count)
