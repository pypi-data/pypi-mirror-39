#!/usr/bin/env python
# -*- coding: utf-8 -*-
# generated by wxGlade 0.6.5 on Thu Jul 23 18:35:56 2015
...
class MyDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.ListTransformKernels = wx.ListCtrl(self, -1, style=wx.LC_REPORT | wx.SUNKEN_BORDER)
...
if __name__ == "__main__":
    ...
    DialogManageTransformKernels = MyDialog(None, -1, "")
    app.SetTopWindow(DialogManageTransformKernels)
    DialogManageTransformKernels.Show()
    app.MainLoop()
