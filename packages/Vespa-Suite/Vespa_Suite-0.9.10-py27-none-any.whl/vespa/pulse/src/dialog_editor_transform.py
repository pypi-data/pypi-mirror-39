...
class LocalPulseDesign(object):
    def __init__(self, machine_specs):
        # self.calc_resolution = 2000
        # self.pulse_bandwidth_type = 'half_height'
...
#bjs                       "Please change the name to a unique value."
        ...
        if msg:
            ...
            globs = [[hide_time_steps,  u'Long', u'Time Steps [int]', time_steps, u'time_steps'],
                     [hide_duration,  u'Double', u'Duration [msec]',  duration,   u'duration'],
                     [hide_tip_angle, u'Double', u'Tip Angle [deg]',  tip_angle,  u'tip_angle'],
                     [hide_bandwidth, u'Double', u'Bandwidth [kHz]',  bandwidth,  u'bandwidth']]
