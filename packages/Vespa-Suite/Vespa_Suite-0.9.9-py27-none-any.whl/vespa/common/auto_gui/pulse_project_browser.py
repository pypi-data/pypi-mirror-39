...
class PulseProjectBrowser(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.ListPulseProjects = wx.ListBox(self, -1, choices=[])
        self.sizer_7_staticbox = wx.StaticBox(self, -1, "Pulse Projects")
    ...
    def __set_properties(self):
        # begin wxGlade: PulseProjectBrowser.__set_properties
        self.SetTitle("Pulse Project Browser")
        self.SetSize((652, 414))
        # end wxGlade

    def __do_layout(self):
        # begin wxGlade: PulseProjectBrowser.__do_layout
