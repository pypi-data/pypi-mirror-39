...
class EditFloatSpinMultiplier(ManagedBase, EditStylesMixin):
    ...
    def __init__(self, name, parent, id, sizer, pos, 
        ...
        self.access_functions['multiplier'] = (self.get_multiplier, self.set_multiplier)
        ...
        prop['multiplier']  = FloatProperty(self, 'multiplier', None, can_disable=True, label=_("multiplier"))
        prop['extrastyle']  = CheckListProperty(self, 'extrastyle', parent=None, styles=self.extra_dict)


    def create_widget(self):
        self.widget = FloatSpinMultiplier(self.parent.widget, self.id,
    ...
    def create_properties(self):
        ...
        szr.Add(prop['multiplier'].panel, 0, wx.EXPAND)
    ...
    def set_multiplier(self, value):
        ...
        if self.multiplier != value:
            ...
            if self.widget:
                self.widget.SetValue(self.multiplier)
...
def builder(parent, sizer, pos, number=[1]):
    ...
    while common.app_tree.has_name(name):
        number[0] += 1
        name = 'float_spin_multiplier_%d' % number[0]
    text = EditFloatSpinMultiplier(name, parent, wx.NewId(), sizer, pos,
