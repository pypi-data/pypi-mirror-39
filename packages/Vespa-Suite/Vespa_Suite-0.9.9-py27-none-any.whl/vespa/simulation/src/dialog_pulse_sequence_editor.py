...
import run_experiment_controller
import dialog_experiment_list
import mrs_data_basis
import build_basis_functions as bbf_module
import auto_gui.pulse_sequence_editor as pulse_sequence_editor
...
class DialogPulseSequenceEditor(pulse_sequence_editor.MyDialog):
    ...
    def on_combo_isotope(self, event):
        ...
        self.freq1d.midppm     = ppm
        self.basis.midppm      = ppm
    ...
    def initialize_auinotebook_panes(self):
        ...
        self.canvas_axes.set_axis_bgcolor(self.background)
    ...
    def plot_canvas(self, reset_history=False):
        ...
        pivot   = util_ppm.ppm2pts(self.pivot, self.freq1d)
