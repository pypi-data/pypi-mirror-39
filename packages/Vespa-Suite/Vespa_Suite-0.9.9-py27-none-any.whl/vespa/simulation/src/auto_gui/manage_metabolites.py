#!/usr/bin/env python
# -*- coding: utf-8 -*-
# generated by wxGlade 0.6.3 on Wed Feb 23 17:42:20 2011 from "/home/me/duke/src/vespa/simulation/src/wxglade/manage_metabolites.wxg"
...
class MyDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.CheckboxShowDeactivated = wx.CheckBox(self, -1, "Show deactivated")
        ...
        self.ButtonDeactivate = wx.Button(self, -1, "(De)ac&tivate")
        self.ButtonDelete = wx.Button(self, wx.ID_DELETE, "")
        self.ListMetabolites = wx.ListCtrl(self, -1, style=wx.LC_REPORT|wx.SUNKEN_BORDER)
...
if __name__ == "__main__":
    ...
    DialogManageMetabolites = MyDialog(None, -1, "")
    app.SetTopWindow(DialogManageMetabolites)
    DialogManageMetabolites.Show()
    app.MainLoop()
