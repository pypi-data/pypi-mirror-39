...
class TabExperiment(vespa_notebooks.VespaAuiNotebook):
    ...
    def __init__(self, parent, top, db, experiment, is_new):
        ...
        vespa_notebooks.VespaAuiNotebook.__init__(self, parent, style)
    ...
    def build_tabs(self):
        ...
        self.plot1d_axes.set_axis_bgcolor(self._prefs.bgcolor)
        ...
        self.integral_axes.set_axis_bgcolor(self._prefs.bgcolor)
        ...
        self.contour_axes.set_axis_bgcolor(self._prefs.bgcolor)
    ...
    def set_apodization(self, dim0=None):
        ...
        self.apodization = util_generic_spectral.apodize(xx, self.linewidth,
                                                         type_)
