...
#     a = np.array(a)
    ...
    # Phase0 constraints
    ph0min = 0.001 - (set.optimize_limits_range_phase0 * np.pi / 180.0)
    ph0max = 0.001 + (set.optimize_limits_range_phase0 * np.pi / 180.0)
...
#     ph0max = chain.init_ph0 + (set.optimize_limits_range_phase0 * np.pi / 180.0)
    ...
    # Phase1 constraints
    ph1min = 0.1 - set.optimize_limits_range_phase1
    ph1max = 0.1 + set.optimize_limits_range_phase1
