...
import auto_gui.timeseries as timeseries
import functors.funct_coil_combine as funct_coil_combine
...
from plot_panel_prep_timeseries import PlotPanelPrepTimeseries
