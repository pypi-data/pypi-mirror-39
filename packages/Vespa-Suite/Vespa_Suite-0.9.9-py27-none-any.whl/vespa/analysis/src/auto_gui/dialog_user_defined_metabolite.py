...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.7.2 on Tue May 23 10:10:16 2017
#
...
class MyDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.PanelUserDefinedMetabolite = wx.Panel(self.WindowSplitter, wx.ID_ANY)
        ...
        self.FloatLinewidth = FloatSpin(self.PanelUserDefinedMetabolite, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
    ...
    def __set_properties(self):
        ...
        self.ComboZeroLineLocation.SetSelection(-1)
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        sizer_5.Add(self.TextMetaboliteName, 1, wx.ALIGN_CENTER_VERTICAL | wx.ALL | wx.EXPAND, 6)
        sizer_70.Add(sizer_5, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL | wx.EXPAND, 8)
        ...
        self.WindowSplitter.SplitVertically(self.PanelUserDefinedMetabolite, self.PanelPreview)
