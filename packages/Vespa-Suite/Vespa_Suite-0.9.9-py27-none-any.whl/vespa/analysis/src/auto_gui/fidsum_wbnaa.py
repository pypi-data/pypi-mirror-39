...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.7.2 on Tue Sep 19 13:06:54 2017
#
...
class PanelPrepWbnaaUI(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.SpinFidIndex = wx.SpinCtrl(self.PanelFidCorrectionsAndAveraging, wx.ID_ANY, "", min=0, max=100)
        self.FloatGaussianApodization = FloatSpin(self.PanelFidCorrectionsAndAveraging, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        self.FloatPeakShiftValue = FloatSpin(self.PanelFidCorrectionsAndAveraging, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        self.SpinFidLeftShift = wx.SpinCtrl(self.PanelFidCorrectionsAndAveraging, wx.ID_ANY, "", min=-100, max=100)
        self.FloatPhase0 = FloatSpin(self.PanelFidCorrectionsAndAveraging, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        self.label_4 = wx.StaticText(self.PanelFidCorrectionsAndAveraging, wx.ID_ANY, "Global Phase 1 [deg]:")
        self.FloatPhase1 = FloatSpin(self.PanelFidCorrectionsAndAveraging, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        ...
        self.FloatReferencePeakCenter = FloatSpin(self.PanelFidCorrectionsAndAveraging, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        self.FloatPeakSearchWidth = FloatSpin(self.PanelFidCorrectionsAndAveraging, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        self.SpinFidLeftShiftB0 = wx.SpinCtrl(self.PanelFidCorrectionsAndAveraging, wx.ID_ANY, "", min=0, max=100)
        ...
        self.FloatPhase0RangeStart = FloatSpin(self.PanelFidCorrectionsAndAveraging, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        self.FloatPhase0RangeEnd = FloatSpin(self.PanelFidCorrectionsAndAveraging, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        self.SpinFidLeftShiftPhase0 = wx.SpinCtrl(self.PanelFidCorrectionsAndAveraging, wx.ID_ANY, "", min=0, max=100)
        ...
        self.SpinRefPeakLineWidth = wx.SpinCtrl(self.PanelFidCorrectionsAndAveraging, wx.ID_ANY, "3", min=1, max=100)
        self.SpinConstantPhase0Offset = wx.SpinCtrl(self.PanelFidCorrectionsAndAveraging, wx.ID_ANY, "", min=0, max=100)
    ...
    def __set_properties(self):
        # begin wxGlade: PanelPrepWbnaaUI.__set_properties
        self.ComboDataExclusionDisplayMethod.SetSelection(-1)
    ...
    def __do_layout(self):
        # begin wxGlade: PanelPrepWbnaaUI.__do_layout
        ...
        sizer_9.Add(sizer_5_copy, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL | wx.EXPAND, 8)
        ...
        sizer_9.Add(sizer_8, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL | wx.EXPAND, 8)
