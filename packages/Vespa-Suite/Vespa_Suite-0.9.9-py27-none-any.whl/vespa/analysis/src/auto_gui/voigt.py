...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.7.2 on Fri Aug 31 16:40:34 2018
#
...
class PanelVoigtUI(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.VoigtNotebook = wx.Notebook(self.PanelVoigtControls, wx.ID_ANY)
        ...
        self.FloatPriorPpmStart = FloatSpin(self.PanelMetabolite, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
        self.FloatPriorPpmEnd = FloatSpin(self.PanelMetabolite, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
        ...
        self.FloatB0ShiftValue = FloatSpin(self.PanelInitialValues, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        ...
        self.FloatBaselineInitIgnoreWidth = FloatSpin(self.PanelBaselineInitLowess, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        self.FloatInitialBaselineLowessWidth = FloatSpin(self.PanelBaselineInitLowess, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        ...
        self.FloatLinewidthValue = FloatSpin(self.PanelInitialValues, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        self.PanelInitialLinewidth = wx.Panel(self.PanelInitialValues, wx.ID_ANY)
        self.FloatInitialLinewidthStart = FloatSpin(self.PanelInitialLinewidth, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        self.FloatInitialLinewidthEnd = FloatSpin(self.PanelInitialLinewidth, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        self.FloatInitialLinewidthMultiplier = FloatSpin(self.PanelInitialLinewidth, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=0.1, agwStyle=FS_LEFT)
        ...
        self.FloatInitialPhase0Value = FloatSpin(self.PanelInitialValues, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        self.FloatInitialPhase1Value = FloatSpin(self.PanelInitialValues, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        ...
        self.SpinInitialKOLinewidthMinimum = wx.SpinCtrl(self.PanelKOFilter, wx.ID_ANY, "", min=0, max=100, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL)
        self.SpinInitialKOPoints = wx.SpinCtrl(self.PanelKOFilter, wx.ID_ANY, "", min=0, max=100, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL)
        ...
        self.FloatBaselineSmoothingWidth = FloatSpin(self.PanelBaseline, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
        self.FloatBaselineUnderestimate = FloatSpin(self.PanelBaseline, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
        ...
        self.SpinBaselineSplineNknots = wx.SpinCtrl(self.PanelBsplineParameters, wx.ID_ANY, "", min=0, max=100, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL)
        self.FloatBaselineSplineSpacing = FloatSpin(self.PanelBsplineParameters, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
        ...
        self.SpinBaselineSplineOrder = wx.SpinCtrl(self.PanelBsplineParameters, wx.ID_ANY, "", min=0, max=100, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL)
        ...
        self.FloatBaselineWaveletMinDyad = FloatSpin(self.PanelWaveletParameters, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        ...
        self.FloatMmolSingleDatasetStartArea = FloatSpin(self.PanelMmolSingleDataset, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        ...
        self.SpinOptimizeGlobalIterations = wx.SpinCtrl(self.PanelOptimization, wx.ID_ANY, "", min=0, max=100, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL)
        self.FloatOptimizeStopTolerance = FloatSpinMultiplier(self.PanelOptimization, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, multiplier=1.1, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
        self.SpinOptimizeMaxIterations = wx.SpinCtrl(self.PanelOptimization, wx.ID_ANY, "", min=0, max=100, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL)
        self.static_line_11 = wx.StaticLine(self.PanelOptimization, wx.ID_ANY)
        self.FloatOptimizeLimitsRangeArea = FloatSpin(self.PanelOptimization, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
        self.FloatOptimzeLimitsRangePhase0 = FloatSpin(self.PanelOptimization, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.SP_WRAP | wx.TE_AUTO_URL | wx.TE_NOHIDESEL | wx.TE_PROCESS_ENTER)
        self.FloatOptimizeLimitsRangePpm = FloatSpin(self.PanelOptimization, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
        self.FloatOptimizeLimitsRangePhase1 = FloatSpin(self.PanelOptimization, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
        self.FloatOptimizeLimitsMinLinewidth = FloatSpin(self.PanelOptimization, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
        self.StaticMaxLinewidth = wx.StaticText(self.PanelOptimization, wx.ID_ANY, "0.0")
        self.FloatOptimizeLimitsMaxLinewidth = FloatSpin(self.PanelOptimization, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
        ...
        self.FloatOptimizeWeightsScaleFactor = FloatSpinMultiplier(self.PanelLocalWeights, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, multiplier=1.1, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
        self.FloatOptimizeWeightsWidthFactor = FloatSpin(self.PanelLocalWeights, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
        self.CheckOptimizeWeightsWaterFlag = wx.CheckBox(self.PanelOptimization, wx.ID_ANY, " Apply Min in Water Region - Start:")
        self.FloatOptimizeWeightsWaterStart = FloatSpin(self.PanelOptimization, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        self.FloatOptimizeWeightsWaterEnd = FloatSpin(self.PanelOptimization, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        self.CheckOptimizeWeightsLipidFlag = wx.CheckBox(self.PanelOptimization, wx.ID_ANY, " Apply Min in Lipid Region   - Start:")
        self.FloatOptimizeWeightsLipidStart = FloatSpin(self.PanelOptimization, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        self.FloatOptimizeWeightsLipidEnd = FloatSpin(self.PanelOptimization, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        self.FloatOptimizeWeightsSmallPeakFactor = FloatSpin(self.PanelOptimization, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        ...
        self.FloatConfidenceAlpha = FloatSpin(self.PanelQuality, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
        ...
        self.FloatCramerRaoPpmStart = FloatSpin(self.PanelQuality, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
        self.labelNoiseEnd = wx.StaticText(self.PanelQuality, wx.ID_ANY, "End: ")
        self.FloatCramerRaoPpmEnd = FloatSpin(self.PanelQuality, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
    ...
    def __do_layout(self):
        ...
        grid_sizer_7 = wx.FlexGridSizer(4, 4, 2, 2)
        ...
        grid_sizer_5 = wx.FlexGridSizer(4, 4, 2, 2)
        ...
        grid_sizer_9 = wx.FlexGridSizer(3, 3, 2, 2)
    ...
    def on_optimize_limits_range_area(self, event):  # wxGlade: PanelVoigtUI.<event_handler>
        print "Event handler 'on_optimize_limits_range_area' not implemented!"
        event.Skip()

    def on_optimize_limits_range_phase0(self, event):  # wxGlade: PanelVoigtUI.<event_handler>
        print "Event handler 'on_optimize_limits_range_phase0' not implemented!"
        event.Skip()

    def on_optimize_limits_range_ppm(self, event):  # wxGlade: PanelVoigtUI.<event_handler>
        print "Event handler 'on_optimize_limits_range_ppm' not implemented!"
        event.Skip()

    def on_optimize_limits_range_phase1(self, event):  # wxGlade: PanelVoigtUI.<event_handler>
        print "Event handler 'on_optimize_limits_range_phase1' not implemented!"
        event.Skip()

    def on_optimize_limits_min_linewidth(self, event):  # wxGlade: PanelVoigtUI.<event_handler>
        print "Event handler 'on_optimize_limits_min_linewidth' not implemented!"
        event.Skip()

    def on_optimize_limits_max_linewidth(self, event):  # wxGlade: PanelVoigtUI.<event_handler>
