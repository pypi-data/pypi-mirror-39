...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.7.2 on Mon Feb 13 14:50:54 2017
#
...
class PanelSpectralUI(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.NotebookSpectral = wx.Notebook(self, wx.ID_ANY)
        ...
        self.SpinFirLength = wx.SpinCtrl(self.PanelWaterFir, wx.ID_ANY, "", min=0, max=100, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL)
        self.FloatFirWidth = FloatSpin(self.PanelWaterFir, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
        self.FloatFirRipple = FloatSpin(self.PanelWaterFir, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
        self.ComboFirExtrapMethod = wx.ComboBox(self.PanelWaterFir, wx.ID_ANY, choices=["None", "Linear", "AR Model"], style=wx.CB_READONLY)
        self.SpinFirExtrapValue = wx.SpinCtrl(self.PanelWaterFir, wx.ID_ANY, "", min=0, max=100, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL)
        self.PanelWaterHamming = wx.Panel(self.PanelSpectral, wx.ID_ANY)
        self.SpinHamLength = wx.SpinCtrl(self.PanelWaterHamming, wx.ID_ANY, "", min=0, max=100, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL)
        ...
        self.SpinHamExtrapValue = wx.SpinCtrl(self.PanelWaterHamming, wx.ID_ANY, "", min=0, max=100, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL)
        ...
        self.FloatWidth = FloatSpin(self.PanelSpectral, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.SP_WRAP | wx.TE_AUTO_URL | wx.TE_NOHIDESEL | wx.TE_PROCESS_ENTER)
        self.CheckFreqLock = wx.CheckBox(self.PanelSpectral, wx.ID_ANY, "Lock B0")
        self.FloatFrequency = FloatSpin(self.PanelSpectral, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
        self.FloatAmplitude = FloatSpinMultiplier(self.PanelSpectral, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, multiplier=1.1, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
        self.CheckPhaseLock = wx.CheckBox(self.PanelSpectral, wx.ID_ANY, "Lock Ph01")
        self.FloatPhase0 = FloatSpin(self.PanelSpectral, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
        self.CheckZeroPhase1 = wx.CheckBox(self.PanelSpectral, wx.ID_ANY, "Set Ph1 to Zero")
        self.FloatPhase1 = FloatSpin(self.PanelSpectral, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
        self.FloatPhase1Pivot = FloatSpin(self.PanelSpectral, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
        self.FloatDcOffset = FloatSpin(self.PanelSpectral, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL | wx.TE_PROCESS_ENTER)
        self.CheckCorrectPhase1 = wx.CheckBox(self.PanelSpectral, wx.ID_ANY, "Correct Phase1")
        self.SpinKissOff = wx.SpinCtrl(self.PanelSpectral, wx.ID_ANY, "", min=0, max=100, style=wx.SP_ARROW_KEYS | wx.TE_AUTO_URL)
        ...
        self.FloatSvdThreshold = FloatSpin(self.PanelSvdControls, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        ...
        self.FloatSvdExcludeLipidStart = FloatSpin(self.PanelSvdControls, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        self.label_4 = wx.StaticText(self.PanelSvdControls, wx.ID_ANY, "    End: ")
        self.FloatSvdExcludeLipidEnd = FloatSpin(self.PanelSvdControls, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT)
        ...
        self.Bind(wx.EVT_CHECKBOX, self.on_ko_correction, self.CheckCorrectPhase1)
        self.Bind(wx.EVT_SPINCTRL, self.on_kiss_off, self.SpinKissOff)
    ...
    def __set_properties(self):
        # begin wxGlade: PanelSpectralUI.__set_properties
        self.CheckFFT.SetValue(1)
        self.CheckChop.SetValue(1)
        self.ComboEcc.SetSelection(-1)
        self.PanelEccBrowse.Hide()
        self.ComboWater.SetSelection(-1)
        ...
        self.ComboZeroFill.SetSelection(-1)
        ...
        self.SpinKissOff.SetMinSize((80, -1))
        self.ComboSvdThresholdUnit.SetSelection(-1)
        # end wxGlade

    def __do_layout(self):
        # begin wxGlade: PanelSpectralUI.__do_layout
        ...
        sizer_3.Add(label_1, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.RIGHT, 2)
        sizer_3.Add(self.ComboDataB, 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 4)
        SizerSpectral.Add(sizer_3, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.BOTTOM | wx.TOP, 6)
        sizer_118.Add(self.CheckFlip, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.LEFT | wx.RIGHT, 5)
        sizer_118.Add(self.CheckFFT, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.LEFT | wx.RIGHT, 5)
        sizer_118.Add(self.CheckChop, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.LEFT | wx.RIGHT, 6)
        SizerSpectral.Add(sizer_118, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.BOTTOM | wx.TOP, 6)
        ...
        sizer_34.Add(labelEddy, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.RIGHT, 3)
        sizer_34.Add(self.ComboEcc, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT, 0)
        SizerSpectral.Add(sizer_34, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.BOTTOM | wx.RIGHT, 4)
        sizer_3_copy.Add(self.ButtonEccBrowse, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.RIGHT, 5)
        sizer_3_copy.Add(self.TextEccFilename, 1, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.EXPAND, 0)
        self.PanelEccBrowse.SetSizer(sizer_3_copy)
        SizerSpectral.Add(self.PanelEccBrowse, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.ALL | wx.EXPAND, 2)
        ...
        sizer_36.Add(labelWater, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.RIGHT, 2)
        sizer_36.Add(self.ComboWater, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT, 0)
        SizerSpectral.Add(sizer_36, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.RIGHT, 4)
        Length = wx.StaticText(self.PanelWaterFir, wx.ID_ANY, "FIR Filter Length:")
        sizer_3_copy_1.Add(Length, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.ALL, 3)
        sizer_3_copy_1.Add(self.SpinFirLength, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.ALL, 3)
        sizer_15.Add(sizer_3_copy_1, 1, wx.ALIGN_RIGHT, 0)
        LabelFirWidth = wx.StaticText(self.PanelWaterFir, wx.ID_ANY, "FIR 1/2 Width: ")
        sizer_4.Add(LabelFirWidth, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.ALL, 3)
        sizer_4.Add(self.FloatFirWidth, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.ALL, 3)
        LabelFirRipple = wx.StaticText(self.PanelWaterFir, wx.ID_ANY, "FIR Ripple [dB]: ")
        sizer_4.Add(LabelFirRipple, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.ALL, 3)
        sizer_4.Add(self.FloatFirRipple, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.ALL, 3)
        sizer_15.Add(sizer_4, 1, wx.ALIGN_RIGHT, 0)
        LabelFirExtrapolation = wx.StaticText(self.PanelWaterFir, wx.ID_ANY, "Extrapolation: ")
        sizer_5.Add(LabelFirExtrapolation, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.ALL, 3)
        ...
        sizer_5.Add(LabelFirExtrap, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.ALL, 3)
        sizer_5.Add(self.SpinFirExtrapValue, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.ALL, 3)
        sizer_15.Add(sizer_5, 1, wx.ALIGN_RIGHT, 0)
        self.PanelWaterFir.SetSizer(sizer_15)
        SizerSpectral.Add(self.PanelWaterFir, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.ALL | wx.EXPAND, 2)
        Length_copy = wx.StaticText(self.PanelWaterHamming, wx.ID_ANY, "Hamming Filter Length:")
        sizer_3_copy_2.Add(Length_copy, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.ALL, 3)
        sizer_3_copy_2.Add(self.SpinHamLength, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.ALL, 3)
        sizer_2_copy.Add(sizer_3_copy_2, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT, 0)
        LabelHamExtrapMethod = wx.StaticText(self.PanelWaterHamming, wx.ID_ANY, "Extrapolation:")
        sizer_4_copy.Add(LabelHamExtrapMethod, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.ALL, 3)
        sizer_4_copy.Add(self.ComboHamExtrapMethod, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.ALL, 3)
        labelHamExtrapValue = wx.StaticText(self.PanelWaterHamming, wx.ID_ANY, "    Extrap Pts:")
        sizer_4_copy.Add(labelHamExtrapValue, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.ALL, 3)
        sizer_4_copy.Add(self.SpinHamExtrapValue, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.ALL, 3)
        sizer_2_copy.Add(sizer_4_copy, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT, 0)
        self.PanelWaterHamming.SetSizer(sizer_2_copy)
        SizerSpectral.Add(self.PanelWaterHamming, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.ALL | wx.EXPAND, 2)
        ...
        sizer_1127.Add(ZeroFill, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.RIGHT, 2)
        sizer_1127.Add(self.ComboZeroFill, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT, 0)
        SizerSpectral.Add(sizer_1127, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.ALL, 4)
        labelApodization = wx.StaticText(self.PanelSpectral, wx.ID_ANY, "Apodize: ")
        sizer_1124.Add(labelApodization, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.RIGHT, 2)
        sizer_1124.Add(self.ComboApodization, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT, 0)
        Width = wx.StaticText(self.PanelSpectral, wx.ID_ANY, "   Width [Hz]:")
        sizer_1124.Add(Width, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.RIGHT, 2)
        sizer_1124.Add(self.FloatWidth, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT, 0)
        SizerSpectral.Add(sizer_1124, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.ALL, 3)
        ...
        KissOff = wx.StaticText(self.PanelSpectral, wx.ID_ANY, " Left Shift [pts]:")
        grid_sizer_1.Add(KissOff, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.ALL, 3)
        grid_sizer_1.Add(self.SpinKissOff, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.ALL, 2)
        ...
        sizer_29.Add(self.ButtonUserFunction, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT, 0)
        ...
        sizer_28.Add(sizer_29, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 3)
        ...
        sizer_51.Add(self.SplitterWindow, 1, wx.EXPAND, 0)
        self.PanelParameters.SetSizer(sizer_51)
        ...
        sizer_7.Add(self.FloatSvdThreshold, 0, wx.ALIGN_CENTER_HORIZONTAL, 0)
        ...
        sizer_45.Add(sizer_44, 1, wx.ALIGN_RIGHT | wx.EXPAND | wx.TOP, 8)
        ...
        sizer_50.Add(self.SplitterWindowSvd, 1, wx.EXPAND, 0)
        self.PanelSvdFilter.SetSizer(sizer_50)
    ...
    def on_ko_correction(self, event):  # wxGlade: PanelSpectralUI.<event_handler>
        print "Event handler 'on_ko_correction' not implemented!"
        event.Skip()

    def on_kiss_off(self, event):  # wxGlade: PanelSpectralUI.<event_handler>
        print "Event handler 'on_kiss_off' not implemented!"
        event.Skip()
