...
import auto_gui.dialog_user_defined_prior as dialog_user_defined_prior

from dialog_user_defined_metabolite import DialogUserDefinedMetabolite
...
class DialogUserDefinedPrior(dialog_user_defined_prior.MyDialog):
    ...
    def __init__(self, parent, dataset, mrs_prior=None, 
        ...
        # copy original mrs_prior and constraints in case user hits cancel
    ...
    def initialize_controls(self):
        ...
        for heading in headings:
            if heading:
                ...
                self.GridSizerGroups.AddSpacer( (1, 1) )
        ...
        for heading in headings:
            if heading:
                ...
                self.GridSizerEquality.AddSpacer( (1, 1) )
        ...
        for heading in headings:
            if heading:
                ...
                self.GridSizerInequality.AddSpacer( (1, 1) )
    ...
    def on_edit_group(self, event):
        ...
        if key:
            ...
            if code == wx.ID_OK:
                ...
                for new_key in self.mrs_prior.metabolites.keys():
                    if new_key == key:
...
class DynamicList1(object):
    ...
    def set_new_values(self, previous=None, add_check=None):
        ...
        for key in previous.metabolites.keys():
