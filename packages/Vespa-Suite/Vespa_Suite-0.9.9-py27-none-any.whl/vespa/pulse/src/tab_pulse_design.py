...
class TabPulseDesign(vespa_notebooks.VespaAuiNotebook):
    ...
    def __init__(self, main_frame, db, pulse_design=None):
        ...
        if pulse_design:
            # The user opened an existing pulse design from the DB or 
            # copied an open design.
            is_new = False
            self.pulse_design = pulse_design
            
            # If I can't find this in the database, then this design was
            # copied from another design. That matters, see below.
