...
from missinglink_kernel.callback.ml_env_vars import MlEnvironmentVariables
...
class BaseCallback(object):
    ...
    def __init__(self, owner_id=None, project_token=None, stopped_callback=None, framework='none', **kwargs):
        ...
        self._config_prefix = kwargs.pop('config_prefix', None)
    ...
    def _test_iteration_end(self, expected, predictions, probabilities, **kwargs):
        ...
        is_finished = kwargs.pop('is_finished', False) or (-1 < self._test_iter <= self._test_iteration_count)
