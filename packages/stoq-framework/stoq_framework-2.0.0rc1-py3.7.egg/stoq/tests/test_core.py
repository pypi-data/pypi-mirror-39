...
class TestCore(unittest.TestCase):
    ...
    def test_provider_with_task(self):
        ...
        simple_provider.ingest = create_autospec(simple_provider.ingest)
        simple_archiver = s.load_plugin('simple_archiver')
        simple_archiver.PAYLOAD = b'This is a payload'
        simple_archiver.get = create_autospec(simple_archiver.get)
        s.run()
        simple_provider.ingest.assert_called_once()
        simple_archiver.get.assert_called_once()
        dummy_connector.save.assert_called_once()
