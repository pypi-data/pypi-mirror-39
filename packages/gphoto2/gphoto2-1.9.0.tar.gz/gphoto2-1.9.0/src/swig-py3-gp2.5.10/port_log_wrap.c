...
#define SWIGTYPE_p__GPPortInfoList swig_types[41]
#define SWIGTYPE_p_char swig_types[42]
#define SWIGTYPE_p_f_enum_GPLogLevel_p_q_const__char_p_q_const__char_p_void__void swig_types[43]
...
SWIGINTERN PyObject *_wrap_gp_log_add_func(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg1 = (GPLogLevel)(val1);
  {
    ...
    _global_new_func->func = swig_obj[1];
    arg2 = gp_log_call_python;
  }
  if (swig_obj[2]) {
    {
      _global_new_func->data = swig_obj[2];
    }
  }
  {
