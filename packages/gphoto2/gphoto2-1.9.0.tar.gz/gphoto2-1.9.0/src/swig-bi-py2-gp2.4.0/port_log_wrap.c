...
SWIGINTERN PyObject *_wrap_gp_log_add_func(PyObject *self, PyObject *args) {
  ...
  arg1 = (GPLogLevel)(val1);
  {
    ...
    _global_new_func->func = obj1;
    arg2 = gp_log_call_python;
  }
  if (obj2) {
    {
      _global_new_func->data = obj2;
    }
  }
  {
...
SWIGINTERN PyObject *_wrap_gp_log_remove_func(PyObject *self, PyObject *args) {
  ...
  if(!PyArg_UnpackTuple(args,(char *)"gp_log_remove_func",1,1,&obj0)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"gp_log_add_func", _wrap_gp_log_add_func, METH_VARARGS, (char *)"\n"
		...
		""},
	 { (char *)"gp_log_remove_func", _wrap_gp_log_remove_func, METH_VARARGS, (char *)"\n"
