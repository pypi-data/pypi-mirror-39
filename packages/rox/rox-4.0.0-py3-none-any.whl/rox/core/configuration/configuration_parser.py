...
class ConfigurationParser:
    ...
    def parse_internal(self, fetch_result, sdk_settings):
        if fetch_result is None or not fetch_result.data:
        ...
        try:
            json_obj = json.loads(fetch_result.data)
        except Exception as ex:
    ...
    def parse_experiment(self, data):
        ...
        return ExperimentModel(id, name, condition, is_archived, flags, labels)
