...
class DynamicApiTests(unittest.TestCase):
    def test_is_enabled(self):
        ...
        exp_repo.set_experiments([ExperimentModel('1', 'default.newFlag', 'and(true, true)', False, ['default.newFlag'], set())])
    ...
    def test_get_value(self):
        ...
        exp_repo.set_experiments([ExperimentModel('1', 'default.newVariant', 'ifThen(true, "B", "A")', False, ['default.newVariant'], set())])
        flag_setter.set_experiments()
