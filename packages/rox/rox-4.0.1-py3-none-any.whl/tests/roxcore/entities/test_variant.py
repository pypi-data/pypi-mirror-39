...
class VariantTests(unittest.TestCase):
    ...
    def test_will_return_default_value_when_no_parser_or_condition(self):
        ...
        variant.set_for_evaluation(None, ExperimentModel('id', 'name', '123', False, ['1'], set()), None)
    ...
    def test_will_return_default_value_when_result_not_in_options(self):
        ...
        variant = Variant('1', ['2', '3'])
        variant.set_for_evaluation(parser, ExperimentModel('id', 'name', '123', False, ['1'], set()), None)
    ...
    def test_will_raise_impression(self):
        ...
        variant = Variant('1', ['2', '3'])
        variant.set_for_evaluation(parser, ExperimentModel('id', 'name', '123', False, ['1'], set()), imp_invoker)
