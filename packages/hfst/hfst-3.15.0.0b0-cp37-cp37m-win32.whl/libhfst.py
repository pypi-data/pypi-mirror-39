...
class HfstTransducerUIntPair(_object):
    ...
    def __init__(self, *args):
        this = _libhfst.new_HfstTransducerUIntPair(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_setmethods__["first"] = _libhfst.HfstTransducerUIntPair_first_set
    __swig_getmethods__["first"] = _libhfst.HfstTransducerUIntPair_first_get
    if _newclass:
        first = _swig_property(_libhfst.HfstTransducerUIntPair_first_get, _libhfst.HfstTransducerUIntPair_first_set)
    __swig_setmethods__["second"] = _libhfst.HfstTransducerUIntPair_second_set
    __swig_getmethods__["second"] = _libhfst.HfstTransducerUIntPair_second_get
    if _newclass:
        second = _swig_property(_libhfst.HfstTransducerUIntPair_second_get, _libhfst.HfstTransducerUIntPair_second_set)
    def __len__(self):
        return 2
    def __repr__(self):
        return str((self.first, self.second))
    ...
    __del__ = lambda self: None
HfstTransducerUIntPair_swigregister = _libhfst.HfstTransducerUIntPair_swigregister
...
class LocationVector(_object):
    ...
    def __init__(self, *args):
        this = _libhfst.new_LocationVector(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
LocationVector_swigregister = _libhfst.LocationVector_swigregister
...
class LocationVectorVector(_object):
    ...
    def __init__(self, *args):
        this = _libhfst.new_LocationVectorVector(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
LocationVectorVector_swigregister = _libhfst.LocationVectorVector_swigregister
...
class Location(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["start"] = _libhfst.Location_start_set
    __swig_getmethods__["start"] = _libhfst.Location_start_get
    if _newclass:
        start = _swig_property(_libhfst.Location_start_get, _libhfst.Location_start_set)
    __swig_setmethods__["length"] = _libhfst.Location_length_set
    __swig_getmethods__["length"] = _libhfst.Location_length_get
    if _newclass:
        length = _swig_property(_libhfst.Location_length_get, _libhfst.Location_length_set)
    __swig_setmethods__["input"] = _libhfst.Location_input_set
    __swig_getmethods__["input"] = _libhfst.Location_input_get
    if _newclass:
        input = _swig_property(_libhfst.Location_input_get, _libhfst.Location_input_set)
    __swig_setmethods__["output"] = _libhfst.Location_output_set
    __swig_getmethods__["output"] = _libhfst.Location_output_get
    if _newclass:
        output = _swig_property(_libhfst.Location_output_get, _libhfst.Location_output_set)
    __swig_setmethods__["tag"] = _libhfst.Location_tag_set
    __swig_getmethods__["tag"] = _libhfst.Location_tag_get
    if _newclass:
        tag = _swig_property(_libhfst.Location_tag_get, _libhfst.Location_tag_set)
    __swig_setmethods__["weight"] = _libhfst.Location_weight_set
    __swig_getmethods__["weight"] = _libhfst.Location_weight_get
    if _newclass:
        weight = _swig_property(_libhfst.Location_weight_get, _libhfst.Location_weight_set)
    __swig_setmethods__["input_parts"] = _libhfst.Location_input_parts_set
    __swig_getmethods__["input_parts"] = _libhfst.Location_input_parts_get
    if _newclass:
        input_parts = _swig_property(_libhfst.Location_input_parts_get, _libhfst.Location_input_parts_set)
    __swig_setmethods__["output_parts"] = _libhfst.Location_output_parts_set
    __swig_getmethods__["output_parts"] = _libhfst.Location_output_parts_get
    if _newclass:
        output_parts = _swig_property(_libhfst.Location_output_parts_get, _libhfst.Location_output_parts_set)
    __swig_setmethods__["input_symbol_strings"] = _libhfst.Location_input_symbol_strings_set
    __swig_getmethods__["input_symbol_strings"] = _libhfst.Location_input_symbol_strings_get
    if _newclass:
        input_symbol_strings = _swig_property(_libhfst.Location_input_symbol_strings_get, _libhfst.Location_input_symbol_strings_set)
    __swig_setmethods__["output_symbol_strings"] = _libhfst.Location_output_symbol_strings_set
    __swig_getmethods__["output_symbol_strings"] = _libhfst.Location_output_symbol_strings_get
    if _newclass:
        output_symbol_strings = _swig_property(_libhfst.Location_output_symbol_strings_get, _libhfst.Location_output_symbol_strings_set)

    def __init__(self):
        this = _libhfst.new_Location()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
Location_swigregister = _libhfst.Location_swigregister
...
pmatch_get_tokenized_output = _libhfst.pmatch_get_tokenized_output

def pmatch_locate(*args):
    return _libhfst.pmatch_locate(*args)
pmatch_locate = _libhfst.pmatch_locate
