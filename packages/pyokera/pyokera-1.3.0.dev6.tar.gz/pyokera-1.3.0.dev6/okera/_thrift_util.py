...
# library structure of thriftpy; section cython vs cython
#
...
def get_transport(socket, host, auth_mechanism='NOSASL', service_name=None,
    ...
    print('TSocket instance is-a: {0}'.format(socket))
    if auth_mechanism == 'NOSASL':
        t = TBufferedTransport(socket)
        print('TBufferedTransport instance is-a: {0}'.format(t))
        return t
