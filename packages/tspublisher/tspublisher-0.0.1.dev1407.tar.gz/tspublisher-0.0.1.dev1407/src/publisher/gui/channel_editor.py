...
class ChannelEditor(QtGui.QWidget, Ui_channel_editor):
    ...
    def __init__(self, parent=None):
        ...
        self.channel_tbl.horizontalHeader().setResizeMode(1, QtGui.QHeaderView.Stretch)
    ...
    def _display_error(self, message):
        QtGui.QMessageBox.critical(self, "Error", "Error: {}".format(message))
        self.loading_overlay.hide()
        self._enable_input()
