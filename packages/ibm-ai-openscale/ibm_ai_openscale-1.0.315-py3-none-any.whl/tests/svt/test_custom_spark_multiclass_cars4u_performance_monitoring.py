...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_05_subscribe_custom(self):
        subscription = self.ai_client.data_mart.subscriptions.add(
            CustomMachineLearningAsset(source_uid='action', binding_uid=self.binding_uid))
    ...
    def test_09_setup_performance_monitoring(self):
        self.subscription.performance_monitoring.enable()
        print('Subscription details after performance monitor ON: ' + str(self.subscription.get_details()))
    ...
    def test_13_get_performance_monitoring_details(self):
        self.subscription.performance_monitoring.get_details()
