...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.postgres_credentials = get_postgres_credentials()
        cls.ai_client = APIClient(cls.aios_credentials)

    def test_01_setup_data_mart(self):
        self.ai_client.data_mart.setup(db_credentials=self.postgres_credentials, schema=self.schema)
    ...
    def test_15_stats_on_fairness_monitoring_table(self):
        TestAIOpenScaleClient.subscription.payload_logging.show_table()
    ...
    def test_16_disable_fairness_monitoring(self):
