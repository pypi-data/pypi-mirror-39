...
class AzureClient(Client):
    ...
    def prepare_artifact(self, asset):
        ...
        elif asset.problem_type == ProblemType.MULTICLASS_CLASSIFICATION:
            # TODO workaround until gateway sets correct role for that field
            artifact.properties['prediction_probability_field'] = 'Scored Probabilities'
