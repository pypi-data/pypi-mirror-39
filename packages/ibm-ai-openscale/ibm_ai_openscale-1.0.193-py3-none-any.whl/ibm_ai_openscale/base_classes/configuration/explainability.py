...
class Explainability(TableFromRestApiViewer):
    ...
    def enable(self, feature_columns, categorical_columns=None, label_column=None, problem_type=None, input_data_type=None, training_data_reference=None):
        """
        ...
        elif input_data_type == InputDataType.UNSTRUCTURED_IMAGE:
            model_data_type = 'image'
        elif input_data_type == InputDataType.UNSTRUCTURED_TEXT:
            model_data_type = 'text'
        else:
            raise IncorrectValue(input_data_type, 'Input data type is not supported.')
    ...
    def _get_schema(self):
        return {
            'fields': [
                ...
                {'name': 'user_timestamp_log', 'type': 'json', 'nullable': False},
                {'name': 'last_accessed_by', 'type': 'timestamp', 'nullable': False},
                {'name': 'last_accessed_at', 'type': 'timestamp', 'nullable': False}
            ]
        }
