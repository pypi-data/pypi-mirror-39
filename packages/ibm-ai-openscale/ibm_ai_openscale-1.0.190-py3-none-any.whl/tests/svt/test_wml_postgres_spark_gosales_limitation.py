...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_01b_create_client(self):
    ...
    def test_04a_get_wml_client(self):
    ...
    def test_08_setup_fairness_monitoring(self):
