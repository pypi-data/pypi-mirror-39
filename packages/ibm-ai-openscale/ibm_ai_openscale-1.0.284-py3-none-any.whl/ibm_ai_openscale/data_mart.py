...
class DataMart:
    ...
    def setup(self, postgres_credentials=None, db_credentials=None, schema=None, internal_db=False):
        ...
        Example of usage (postgres):

        >>> ai_client.data_mart.setup(db_credentials={
        >>>   "uri": "postgres://admin:XXXXXXXX@sl-us-south-5-portal.24.dblayer.com:56446/compose"
        >>> })

        Example of usage (db2):

        >>> ai_client.data_mart.setup(db_credentials={
        >>>   "uri": "db2://dash24644:XXXXXXXXXX@dashdb-entry-yp-dal03-12.services.dal.bluemix.net:50000/BLUDB"
        >>> })
