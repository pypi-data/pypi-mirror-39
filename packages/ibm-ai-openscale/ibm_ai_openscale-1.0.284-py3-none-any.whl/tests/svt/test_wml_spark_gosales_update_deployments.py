...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_09_prepare_model(self):
        model_name = "AIOS Spark GoSales file model"
    ...
    def test_14_list_and_get_uids_after_subscribe(self):
        ...
        TestAIOpenScaleClient.ai_client.data_mart.subscriptions.list(name="AIOS Spark GoSales file model")
    ...
    def test_15_prepare_deployment(self):
        deployment_name = "AIOS Spark GoSales file deployment"
