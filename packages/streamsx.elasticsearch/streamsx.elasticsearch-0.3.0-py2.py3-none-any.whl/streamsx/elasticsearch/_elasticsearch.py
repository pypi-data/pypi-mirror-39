...
def bulk_insert(stream, indexName, bulk_size=1, message_attribute=None, credentials='es', vmArg=None, name=None):
    ...
    _op = _ElasticsearchIndex(stream, indexName=indexName, bulkSize=bulk_size, appConfigName=credentials, vmArg=vmArg, name=name)
...
def bulk_insert_dynamic(stream, index_name_attribute, message_attribute, bulk_size=1, credentials='es', vmArg=None, name=None):
    ...
    _op = _ElasticsearchIndex(stream, bulkSize=bulk_size, appConfigName=credentials, vmArg=vmArg, name=name)
    _op.params['documentAttribute'] = _op.attribute(stream, message_attribute)
