...
"""
Package containing AzureML Training SDK Widgets. Training SDK widgets can show status of your runs with corresponding
properties, logs and metrics.
...
- Databricks:  Synchronous Auto-updates but non-interactive currently.
