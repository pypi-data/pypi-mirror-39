// Transcrypt'ed from Python, 2018-12-03 19:25:14
var re = {};
...
export {run559, anA, aB, y, f1, q, p, run387, r};
...
export var run = function (autoTester) {
	...
	(function () {
		...
		return __call__ (__accu0__.check, __accu0__, __add__ (__add__ (list ([1, 2, 3]), aList), list ([4, 5, 6])));
	}) ();
	(function () {
		var __accu0__ = autoTester;
		return __call__ (__accu0__.check, __accu0__, __mul__ (3, list ([1, 2, 3])));
	}) ();
	(function () {
		var __accu0__ = autoTester;
		return __call__ (__accu0__.check, __accu0__, __mul__ (list ([1, 2, 3]), 3));
	}) ();
	...
	autoTester.check ('a: {0}; b: {1}'.format (1, list ([])));
	autoTester.check ('a: {}; b: {}'.format (1, list ([])));
