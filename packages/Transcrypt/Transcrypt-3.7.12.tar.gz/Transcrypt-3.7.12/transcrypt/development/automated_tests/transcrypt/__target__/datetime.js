// Transcrypt'ed from Python, 2018-12-03 19:25:11
...
export var _DAYS_IN_MONTH = list ([-(1), 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31]);
export var _DAYS_BEFORE_MONTH = list ([-(1)]);
export var dbm = 0;
...
export var _MONTHNAMES = list ([null, 'Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']);
export var _DAYNAMES = list ([null, 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun']);
...
export var datetime =  __class__ ('datetime', [date], {
	...
	get __repr__ () {return __get__ (this, function (self) {
		var L = list ([self._year, self._month, self._day, self._hour, self._minute, self._second, self._microsecond]);
		if (L [len (L) - 1] == 0) {
			L.py_pop ();
		}
		if (L [len (L) - 1] == 0) {
