...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputMessage, TypeInputStickerSet, TypeChannelAdminLogEventsFilter, TypeInputChannel, TypeInputUser, TypeBool, TypeChannelBannedRights, TypeInputChatPhoto, TypeChannelAdminRights, TypeChannelParticipantsFilter
