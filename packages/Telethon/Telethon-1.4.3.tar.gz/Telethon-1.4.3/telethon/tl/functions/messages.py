...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputMessage, TypeInputPeer, TypeMessageEntity, TypeInputSingleMedia, TypeInputGeoPoint, TypeInputDocument, TypeBool, TypeInputBotInlineMessageID, TypeInputStickerSet, TypeInputMedia, TypeSendMessageAction, TypeShippingOption, TypeInlineBotSwitchPM, TypeInputChatPhoto, TypeInputBotInlineResult, TypeReplyMarkup, TypeInputStickeredMedia, TypeInputEncryptedFile, TypeInputUser, TypeMessagesFilter, TypeReportReason, TypeInputDialogPeer, TypeInputEncryptedChat
