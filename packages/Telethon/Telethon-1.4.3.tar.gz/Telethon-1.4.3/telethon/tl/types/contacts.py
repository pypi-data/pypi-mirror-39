...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypePeer, TypeContactLink, TypeImportedContact, TypeTopPeerCategoryPeers, TypeUser, TypePopularContact, TypeContactBlocked, TypeChat, TypeContact
