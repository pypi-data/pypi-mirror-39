...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeFoundGif, TypeEncryptedFile, TypeUser, TypeStickerSetCovered, TypeInlineBotSwitchPM, TypeStickerSet, TypeChatFull, TypeDialog, TypeChat, TypeDocument, TypeBotInlineResult, TypeHighScore, TypeStickerPack, TypeMessage
