...
def html_page_context(app, pagename, templatename, context, doctree):
    if templatename == "page.html" and not re.match(
        app.config.edit_on_github_skip_regex, pagename
    ):
...
def setup(app):
    ...
    app.add_config_value(
        "edit_on_github_page_message", "Edit This Page on Github", True
    )
    app.add_config_value(
        "edit_on_github_help_message", "Push the Edit button on the next page", True
    )
    app.add_config_value("edit_on_github_skip_regex", "_.*", True)
