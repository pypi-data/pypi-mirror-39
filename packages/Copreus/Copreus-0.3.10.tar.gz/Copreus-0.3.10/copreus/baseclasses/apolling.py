...
class APolling(object):
    ...
    Expects 'poll-interval' in the device yaml configuration - device is polled every n seconds. Further,
    for spontaneus polling, apolling subscribes to poll-now and upon receiving of the predefined command in
    mqtt-translations, polling is started.
    """
    ...
    def _stop_polling(self):
        ...
        self._logger_apolling.info("APolling._stop_polling - stopped polling.")
