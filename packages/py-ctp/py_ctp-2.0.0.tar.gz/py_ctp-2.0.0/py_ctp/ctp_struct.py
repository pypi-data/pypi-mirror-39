...
class  CThostFtdcTransferBankToFutureReqField(Structure):
    ...
    def getFuturePwdFlag(self):
        '''密码标志'''
        return TThostFtdcFuturePwdFlagType(ord(self.FuturePwdFlag)) if self.FuturePwdFlag in list(TThostFtdcFuturePwdFlagType) else list(TThostFtdcFuturePwdFlagType)[0]
...
class  CThostFtdcTransferQryDetailRspField(Structure):
    ...
    def getFlag(self):
        '''有效标志'''
        return TThostFtdcTransferValidFlagType(ord(self.Flag)) if self.Flag in list(TThostFtdcTransferValidFlagType) else list(TThostFtdcTransferValidFlagType)[0]
...
class  CThostFtdcExchangeField(Structure):
    ...
    def getExchangeProperty(self):
        '''交易所属性'''
        return TThostFtdcExchangePropertyType(ord(self.ExchangeProperty)) if self.ExchangeProperty in list(TThostFtdcExchangePropertyType) else list(TThostFtdcExchangePropertyType)[0]
...
class  CThostFtdcProductField(Structure):
    ...
    def getProductClass(self):
        '''产品类型'''
        return TThostFtdcProductClassType(ord(self.ProductClass)) if self.ProductClass in list(TThostFtdcProductClassType) else list(TThostFtdcProductClassType)[0]
    ...
    def getPositionType(self):
        '''持仓类型'''
        return TThostFtdcPositionTypeType(ord(self.PositionType)) if self.PositionType in list(TThostFtdcPositionTypeType) else list(TThostFtdcPositionTypeType)[0]

    def getPositionDateType(self):
        '''持仓日期类型'''
        return TThostFtdcPositionDateTypeType(ord(self.PositionDateType)) if self.PositionDateType in list(TThostFtdcPositionDateTypeType) else list(TThostFtdcPositionDateTypeType)[0]

    def getCloseDealType(self):
        '''平仓处理类型'''
        return TThostFtdcCloseDealTypeType(ord(self.CloseDealType)) if self.CloseDealType in list(TThostFtdcCloseDealTypeType) else list(TThostFtdcCloseDealTypeType)[0]
    ...
    def getMortgageFundUseRange(self):
        '''质押资金可用范围'''
        return TThostFtdcMortgageFundUseRangeType(ord(self.MortgageFundUseRange)) if self.MortgageFundUseRange in list(TThostFtdcMortgageFundUseRangeType) else list(TThostFtdcMortgageFundUseRangeType)[0]
...
class  CThostFtdcInstrumentField(Structure):
    ...
    def getInstLifePhase(self):
        '''合约生命周期状态'''
        return TThostFtdcInstLifePhaseType(ord(self.InstLifePhase)) if self.InstLifePhase in list(TThostFtdcInstLifePhaseType) else list(TThostFtdcInstLifePhaseType)[0]
    ...
    def getMaxMarginSideAlgorithm(self):
        '''是否使用大额单边保证金算法'''
        return TThostFtdcMaxMarginSideAlgorithmType(ord(self.MaxMarginSideAlgorithm)) if self.MaxMarginSideAlgorithm in list(TThostFtdcMaxMarginSideAlgorithmType) else list(TThostFtdcMaxMarginSideAlgorithmType)[0]
    ...
    def getOptionsType(self):
        '''期权类型'''
        return TThostFtdcOptionsTypeType(ord(self.OptionsType)) if self.OptionsType in list(TThostFtdcOptionsTypeType) else list(TThostFtdcOptionsTypeType)[0]
    ...
    def getCombinationType(self):
        '''组合类型'''
        return TThostFtdcCombinationTypeType(ord(self.CombinationType)) if self.CombinationType in list(TThostFtdcCombinationTypeType) else list(TThostFtdcCombinationTypeType)[0]
...
class  CThostFtdcInvestorField(Structure):
    ...
    def getIdentifiedCardType(self):
        '''证件类型'''
        return TThostFtdcIdCardTypeType(ord(self.IdentifiedCardType)) if self.IdentifiedCardType in list(TThostFtdcIdCardTypeType) else list(TThostFtdcIdCardTypeType)[0]
...
class  CThostFtdcTradingCodeField(Structure):
    ...
    def getClientIDType(self):
        '''交易编码类型'''
        return TThostFtdcClientIDTypeType(ord(self.ClientIDType)) if self.ClientIDType in list(TThostFtdcClientIDTypeType) else list(TThostFtdcClientIDTypeType)[0]
    ...
    def getBizType(self):
        '''业务类型'''
        return TThostFtdcBizTypeType(ord(self.BizType)) if self.BizType in list(TThostFtdcBizTypeType) else list(TThostFtdcBizTypeType)[0]
...
class  CThostFtdcSuperUserFunctionField(Structure):
    ...
    def getFunctionCode(self):
        '''功能代码'''
        return TThostFtdcFunctionCodeType(ord(self.FunctionCode)) if self.FunctionCode in list(TThostFtdcFunctionCodeType) else list(TThostFtdcFunctionCodeType)[0]
...
class  CThostFtdcInvestorPositionField(Structure):
    ...
    def getPosiDirection(self):
        '''持仓多空方向'''
        return TThostFtdcPosiDirectionType(ord(self.PosiDirection)) if self.PosiDirection in list(TThostFtdcPosiDirectionType) else list(TThostFtdcPosiDirectionType)[0]

    def getHedgeFlag(self):
        '''投机套保标志'''
        return TThostFtdcHedgeFlagType(ord(self.HedgeFlag)) if self.HedgeFlag in list(TThostFtdcHedgeFlagType) else list(TThostFtdcHedgeFlagType)[0]

    def getPositionDate(self):
        '''持仓日期'''
        return TThostFtdcPositionDateType(ord(self.PositionDate)) if self.PositionDate in list(TThostFtdcPositionDateType) else list(TThostFtdcPositionDateType)[0]
...
class  CThostFtdcInstrumentMarginRateField(Structure):
    ...
    def getInvestorRange(self):
        '''投资者范围'''
        return TThostFtdcInvestorRangeType(ord(self.InvestorRange)) if self.InvestorRange in list(TThostFtdcInvestorRangeType) else list(TThostFtdcInvestorRangeType)[0]
...
class  CThostFtdcInstrumentTradingRightField(Structure):
    ...
    def getTradingRight(self):
        '''交易权限'''
        return TThostFtdcTradingRightType(ord(self.TradingRight)) if self.TradingRight in list(TThostFtdcTradingRightType) else list(TThostFtdcTradingRightType)[0]
...
class  CThostFtdcBrokerUserField(Structure):
    ...
    def getUserType(self):
        '''用户类型'''
        return TThostFtdcUserTypeType(ord(self.UserType)) if self.UserType in list(TThostFtdcUserTypeType) else list(TThostFtdcUserTypeType)[0]
...
class  CThostFtdcBrokerUserFunctionField(Structure):
    ...
    def getBrokerFunctionCode(self):
        '''经纪公司功能代码'''
        return TThostFtdcBrokerFunctionCodeType(ord(self.BrokerFunctionCode)) if self.BrokerFunctionCode in list(TThostFtdcBrokerFunctionCodeType) else list(TThostFtdcBrokerFunctionCodeType)[0]
...
class  CThostFtdcTraderOfferField(Structure):
    ...
    def getTraderConnectStatus(self):
        '''交易所交易员连接状态'''
        return TThostFtdcTraderConnectStatusType(ord(self.TraderConnectStatus)) if self.TraderConnectStatus in list(TThostFtdcTraderConnectStatusType) else list(TThostFtdcTraderConnectStatusType)[0]
...
class  CThostFtdcInputOrderField(Structure):
    ...
    def getOrderPriceType(self):
        '''报单价格条件'''
        return TThostFtdcOrderPriceTypeType(ord(self.OrderPriceType)) if self.OrderPriceType in list(TThostFtdcOrderPriceTypeType) else list(TThostFtdcOrderPriceTypeType)[0]

    def getDirection(self):
        '''买卖方向'''
        return TThostFtdcDirectionType(ord(self.Direction)) if self.Direction in list(TThostFtdcDirectionType) else list(TThostFtdcDirectionType)[0]
    ...
    def getTimeCondition(self):
        '''有效期类型'''
        return TThostFtdcTimeConditionType(ord(self.TimeCondition)) if self.TimeCondition in list(TThostFtdcTimeConditionType) else list(TThostFtdcTimeConditionType)[0]
    ...
    def getVolumeCondition(self):
        '''成交量类型'''
        return TThostFtdcVolumeConditionType(ord(self.VolumeCondition)) if self.VolumeCondition in list(TThostFtdcVolumeConditionType) else list(TThostFtdcVolumeConditionType)[0]
    ...
    def getContingentCondition(self):
        '''触发条件'''
        return TThostFtdcContingentConditionType(ord(self.ContingentCondition)) if self.ContingentCondition in list(TThostFtdcContingentConditionType) else list(TThostFtdcContingentConditionType)[0]
    ...
    def getForceCloseReason(self):
        '''强平原因'''
        return TThostFtdcForceCloseReasonType(ord(self.ForceCloseReason)) if self.ForceCloseReason in list(TThostFtdcForceCloseReasonType) else list(TThostFtdcForceCloseReasonType)[0]
...
class  CThostFtdcOrderField(Structure):
    ...
    def getOrderSubmitStatus(self):
        '''报单提交状态'''
        return TThostFtdcOrderSubmitStatusType(ord(self.OrderSubmitStatus)) if self.OrderSubmitStatus in list(TThostFtdcOrderSubmitStatusType) else list(TThostFtdcOrderSubmitStatusType)[0]
    ...
    def getOrderSource(self):
        '''报单来源'''
        return TThostFtdcOrderSourceType(ord(self.OrderSource)) if self.OrderSource in list(TThostFtdcOrderSourceType) else list(TThostFtdcOrderSourceType)[0]

    def getOrderStatus(self):
        '''报单状态'''
        return TThostFtdcOrderStatusType(ord(self.OrderStatus)) if self.OrderStatus in list(TThostFtdcOrderStatusType) else list(TThostFtdcOrderStatusType)[0]

    def getOrderType(self):
        '''报单类型'''
        return TThostFtdcOrderTypeType(ord(self.OrderType)) if self.OrderType in list(TThostFtdcOrderTypeType) else list(TThostFtdcOrderTypeType)[0]
...
class  CThostFtdcInputOrderActionField(Structure):
    ...
    def getActionFlag(self):
        '''操作标志'''
        return TThostFtdcActionFlagType(ord(self.ActionFlag)) if self.ActionFlag in list(TThostFtdcActionFlagType) else list(TThostFtdcActionFlagType)[0]
...
class  CThostFtdcOrderActionField(Structure):
    ...
    def getOrderActionStatus(self):
        '''报单操作状态'''
        return TThostFtdcOrderActionStatusType(ord(self.OrderActionStatus)) if self.OrderActionStatus in list(TThostFtdcOrderActionStatusType) else list(TThostFtdcOrderActionStatusType)[0]
...
class  CThostFtdcExchangeTradeField(Structure):
    ...
    def getTradingRole(self):
        '''交易角色'''
        return TThostFtdcTradingRoleType(ord(self.TradingRole)) if self.TradingRole in list(TThostFtdcTradingRoleType) else list(TThostFtdcTradingRoleType)[0]
    ...
    def getOffsetFlag(self):
        '''开平标志'''
        return TThostFtdcOffsetFlagType(ord(self.OffsetFlag)) if self.OffsetFlag in list(TThostFtdcOffsetFlagType) else list(TThostFtdcOffsetFlagType)[0]
    ...
    def getTradeType(self):
        '''成交类型'''
        return TThostFtdcTradeTypeType(ord(self.TradeType)) if self.TradeType in list(TThostFtdcTradeTypeType) else list(TThostFtdcTradeTypeType)[0]

    def getPriceSource(self):
        '''成交价来源'''
        return TThostFtdcPriceSourceType(ord(self.PriceSource)) if self.PriceSource in list(TThostFtdcPriceSourceType) else list(TThostFtdcPriceSourceType)[0]
    ...
    def getTradeSource(self):
        '''成交来源'''
        return TThostFtdcTradeSourceType(ord(self.TradeSource)) if self.TradeSource in list(TThostFtdcTradeSourceType) else list(TThostFtdcTradeSourceType)[0]
...
class  CThostFtdcOptionInstrMiniMarginField(Structure):
    ...
    def getValueMethod(self):
        '''取值方式'''
        return TThostFtdcValueMethodType(ord(self.ValueMethod)) if self.ValueMethod in list(TThostFtdcValueMethodType) else list(TThostFtdcValueMethodType)[0]
...
class  CThostFtdcInputExecOrderField(Structure):
    ...
    def getActionType(self):
        '''执行类型'''
        return TThostFtdcActionTypeType(ord(self.ActionType)) if self.ActionType in list(TThostFtdcActionTypeType) else list(TThostFtdcActionTypeType)[0]
    ...
    def getReservePositionFlag(self):
        ...
        return TThostFtdcExecOrderPositionFlagType(ord(self.ReservePositionFlag)) if self.ReservePositionFlag in list(TThostFtdcExecOrderPositionFlagType) else list(TThostFtdcExecOrderPositionFlagType)[0]

    def getCloseFlag(self):
        '''期权行权后生成的头寸是否自动平仓'''
        return TThostFtdcExecOrderCloseFlagType(ord(self.CloseFlag)) if self.CloseFlag in list(TThostFtdcExecOrderCloseFlagType) else list(TThostFtdcExecOrderCloseFlagType)[0]
...
class  CThostFtdcExecOrderField(Structure):
    ...
    def getExecResult(self):
        '''执行结果'''
        return TThostFtdcExecResultType(ord(self.ExecResult)) if self.ExecResult in list(TThostFtdcExecResultType) else list(TThostFtdcExecResultType)[0]
...
class  CThostFtdcForQuoteField(Structure):
    ...
    def getForQuoteStatus(self):
        '''询价状态'''
        return TThostFtdcForQuoteStatusType(ord(self.ForQuoteStatus)) if self.ForQuoteStatus in list(TThostFtdcForQuoteStatusType) else list(TThostFtdcForQuoteStatusType)[0]
...
class  CThostFtdcInputQuoteField(Structure):
    ...
    def getAskOffsetFlag(self):
        '''卖开平标志'''
        return TThostFtdcOffsetFlagType(ord(self.AskOffsetFlag)) if self.AskOffsetFlag in list(TThostFtdcOffsetFlagType) else list(TThostFtdcOffsetFlagType)[0]

    def getBidOffsetFlag(self):
        '''买开平标志'''
        return TThostFtdcOffsetFlagType(ord(self.BidOffsetFlag)) if self.BidOffsetFlag in list(TThostFtdcOffsetFlagType) else list(TThostFtdcOffsetFlagType)[0]

    def getAskHedgeFlag(self):
        '''卖投机套保标志'''
        return TThostFtdcHedgeFlagType(ord(self.AskHedgeFlag)) if self.AskHedgeFlag in list(TThostFtdcHedgeFlagType) else list(TThostFtdcHedgeFlagType)[0]

    def getBidHedgeFlag(self):
        '''买投机套保标志'''
        return TThostFtdcHedgeFlagType(ord(self.BidHedgeFlag)) if self.BidHedgeFlag in list(TThostFtdcHedgeFlagType) else list(TThostFtdcHedgeFlagType)[0]
...
class  CThostFtdcQuoteField(Structure):
    ...
    def getQuoteStatus(self):
        '''报价状态'''
        return TThostFtdcOrderStatusType(ord(self.QuoteStatus)) if self.QuoteStatus in list(TThostFtdcOrderStatusType) else list(TThostFtdcOrderStatusType)[0]
...
class  CThostFtdcStrikeOffsetField(Structure):
    ...
    def getOffsetType(self):
        '''执行偏移类型'''
        return TThostFtdcStrikeOffsetTypeType(ord(self.OffsetType)) if self.OffsetType in list(TThostFtdcStrikeOffsetTypeType) else list(TThostFtdcStrikeOffsetTypeType)[0]
...
class  CThostFtdcInputCombActionField(Structure):
    ...
    def getCombDirection(self):
        '''组合指令方向'''
        return TThostFtdcCombDirectionType(ord(self.CombDirection)) if self.CombDirection in list(TThostFtdcCombDirectionType) else list(TThostFtdcCombDirectionType)[0]
...
class  CThostFtdcCombActionField(Structure):
    ...
    def getActionStatus(self):
        '''组合状态'''
        return TThostFtdcOrderActionStatusType(ord(self.ActionStatus)) if self.ActionStatus in list(TThostFtdcOrderActionStatusType) else list(TThostFtdcOrderActionStatusType)[0]
...
class  CThostFtdcTradeParamField(Structure):
    ...
    def getTradeParamID(self):
        '''参数代码'''
        return TThostFtdcTradeParamIDType(ord(self.TradeParamID)) if self.TradeParamID in list(TThostFtdcTradeParamIDType) else list(TThostFtdcTradeParamIDType)[0]
...
class  CThostFtdcInputOptionSelfCloseField(Structure):
    ...
    def getOptSelfCloseFlag(self):
        '''期权行权的头寸是否自对冲'''
        return TThostFtdcOptSelfCloseFlagType(ord(self.OptSelfCloseFlag)) if self.OptSelfCloseFlag in list(TThostFtdcOptSelfCloseFlagType) else list(TThostFtdcOptSelfCloseFlagType)[0]
...
class  CThostFtdcInstrumentStatusField(Structure):
    ...
    def getInstrumentStatus(self):
        '''合约交易状态'''
        return TThostFtdcInstrumentStatusType(ord(self.InstrumentStatus)) if self.InstrumentStatus in list(TThostFtdcInstrumentStatusType) else list(TThostFtdcInstrumentStatusType)[0]
    ...
    def getEnterReason(self):
        '''进入本状态原因'''
        return TThostFtdcInstStatusEnterReasonType(ord(self.EnterReason)) if self.EnterReason in list(TThostFtdcInstStatusEnterReasonType) else list(TThostFtdcInstStatusEnterReasonType)[0]
...
class  CThostFtdcPositionProfitAlgorithmField(Structure):
    ...
    def getAlgorithm(self):
        '''盈亏算法'''
        return TThostFtdcAlgorithmType(ord(self.Algorithm)) if self.Algorithm in list(TThostFtdcAlgorithmType) else list(TThostFtdcAlgorithmType)[0]
...
class  CThostFtdcUserRightField(Structure):
    ...
    def getUserRightType(self):
        '''客户权限类型'''
        return TThostFtdcUserRightTypeType(ord(self.UserRightType)) if self.UserRightType in list(TThostFtdcUserRightTypeType) else list(TThostFtdcUserRightTypeType)[0]
...
class  CThostFtdcBrokerWithdrawAlgorithmField(Structure):
    ...
    def getWithdrawAlgorithm(self):
        '''可提资金算法'''
        return TThostFtdcAlgorithmType(ord(self.WithdrawAlgorithm)) if self.WithdrawAlgorithm in list(TThostFtdcAlgorithmType) else list(TThostFtdcAlgorithmType)[0]
    ...
    def getIncludeCloseProfit(self):
        '''可提是否包含平仓盈利'''
        return TThostFtdcIncludeCloseProfitType(ord(self.IncludeCloseProfit)) if self.IncludeCloseProfit in list(TThostFtdcIncludeCloseProfitType) else list(TThostFtdcIncludeCloseProfitType)[0]

    def getAllWithoutTrade(self):
        '''本日无仓且无成交客户是否受可提比例限制'''
        return TThostFtdcAllWithoutTradeType(ord(self.AllWithoutTrade)) if self.AllWithoutTrade in list(TThostFtdcAllWithoutTradeType) else list(TThostFtdcAllWithoutTradeType)[0]

    def getAvailIncludeCloseProfit(self):
        '''可用是否包含平仓盈利'''
        return TThostFtdcIncludeCloseProfitType(ord(self.AvailIncludeCloseProfit)) if self.AvailIncludeCloseProfit in list(TThostFtdcIncludeCloseProfitType) else list(TThostFtdcIncludeCloseProfitType)[0]
    ...
    def getBalanceAlgorithm(self):
        '''权益算法'''
        return TThostFtdcBalanceAlgorithmType(ord(self.BalanceAlgorithm)) if self.BalanceAlgorithm in list(TThostFtdcBalanceAlgorithmType) else list(TThostFtdcBalanceAlgorithmType)[0]
...
class  CThostFtdcSyncStatusField(Structure):
    ...
    def getDataSyncStatus(self):
        '''数据同步状态'''
        return TThostFtdcDataSyncStatusType(ord(self.DataSyncStatus)) if self.DataSyncStatus in list(TThostFtdcDataSyncStatusType) else list(TThostFtdcDataSyncStatusType)[0]
...
class  CThostFtdcLinkManField(Structure):
    ...
    def getPersonType(self):
        '''联系人类型'''
        return TThostFtdcPersonTypeType(ord(self.PersonType)) if self.PersonType in list(TThostFtdcPersonTypeType) else list(TThostFtdcPersonTypeType)[0]
...
class  CThostFtdcQryBrokerUserEventField(Structure):
    ...
    def getUserEventType(self):
        '''用户事件类型'''
        return TThostFtdcUserEventTypeType(ord(self.UserEventType)) if self.UserEventType in list(TThostFtdcUserEventTypeType) else list(TThostFtdcUserEventTypeType)[0]
...
class  CThostFtdcParkedOrderField(Structure):
    ...
    def getStatus(self):
        '''预埋单状态'''
        return TThostFtdcParkedOrderStatusType(ord(self.Status)) if self.Status in list(TThostFtdcParkedOrderStatusType) else list(TThostFtdcParkedOrderStatusType)[0]
...
class  CThostFtdcExchangeSequenceField(Structure):
    ...
    def getMarketStatus(self):
        '''合约交易状态'''
        return TThostFtdcInstrumentStatusType(ord(self.MarketStatus)) if self.MarketStatus in list(TThostFtdcInstrumentStatusType) else list(TThostFtdcInstrumentStatusType)[0]
...
class  CThostFtdcBrokerTradingParamsField(Structure):
    ...
    def getMarginPriceType(self):
        '''保证金价格类型'''
        return TThostFtdcMarginPriceTypeType(ord(self.MarginPriceType)) if self.MarginPriceType in list(TThostFtdcMarginPriceTypeType) else list(TThostFtdcMarginPriceTypeType)[0]
    ...
    def getOptionRoyaltyPriceType(self):
        '''期权权利金价格类型'''
        return TThostFtdcOptionRoyaltyPriceTypeType(ord(self.OptionRoyaltyPriceType)) if self.OptionRoyaltyPriceType in list(TThostFtdcOptionRoyaltyPriceTypeType) else list(TThostFtdcOptionRoyaltyPriceTypeType)[0]
...
class  CThostFtdcBrokerTradingAlgosField(Structure):
    ...
    def getHandlePositionAlgoID(self):
        '''持仓处理算法编号'''
        return TThostFtdcHandlePositionAlgoIDType(ord(self.HandlePositionAlgoID)) if self.HandlePositionAlgoID in list(TThostFtdcHandlePositionAlgoIDType) else list(TThostFtdcHandlePositionAlgoIDType)[0]

    def getFindMarginRateAlgoID(self):
        '''寻找保证金率算法编号'''
        return TThostFtdcFindMarginRateAlgoIDType(ord(self.FindMarginRateAlgoID)) if self.FindMarginRateAlgoID in list(TThostFtdcFindMarginRateAlgoIDType) else list(TThostFtdcFindMarginRateAlgoIDType)[0]

    def getHandleTradingAccountAlgoID(self):
        '''资金处理算法编号'''
        return TThostFtdcHandleTradingAccountAlgoIDType(ord(self.HandleTradingAccountAlgoID)) if self.HandleTradingAccountAlgoID in list(TThostFtdcHandleTradingAccountAlgoIDType) else list(TThostFtdcHandleTradingAccountAlgoIDType)[0]
...
class  CThostFtdcCFMMCBrokerKeyField(Structure):
    ...
    def getKeyKind(self):
        '''动态密钥类型'''
        return TThostFtdcCFMMCKeyKindType(ord(self.KeyKind)) if self.KeyKind in list(TThostFtdcCFMMCKeyKindType) else list(TThostFtdcCFMMCKeyKindType)[0]
...
class  CThostFtdcBrokerUserOTPParamField(Structure):
    ...
    def getOTPType(self):
        '''动态令牌类型'''
        return TThostFtdcOTPTypeType(ord(self.OTPType)) if self.OTPType in list(TThostFtdcOTPTypeType) else list(TThostFtdcOTPTypeType)[0]
...
class  CThostFtdcBulletinField(Structure):
    ...
    def getNewsUrgency(self):
        '''紧急程度'''
        return TThostFtdcNewsUrgencyType(ord(self.NewsUrgency)) if self.NewsUrgency in list(TThostFtdcNewsUrgencyType) else list(TThostFtdcNewsUrgencyType)[0]
...
class  CThostFtdcReqOpenAccountField(Structure):
    ...
    def getLastFragment(self):
        '''最后分片标志'''
        return TThostFtdcLastFragmentType(ord(self.LastFragment)) if self.LastFragment in list(TThostFtdcLastFragmentType) else list(TThostFtdcLastFragmentType)[0]
    ...
    def getIdCardType(self):
        '''证件类型'''
        return TThostFtdcIdCardTypeType(ord(self.IdCardType)) if self.IdCardType in list(TThostFtdcIdCardTypeType) else list(TThostFtdcIdCardTypeType)[0]
    ...
    def getGender(self):
        '''性别'''
        return TThostFtdcGenderType(ord(self.Gender)) if self.Gender in list(TThostFtdcGenderType) else list(TThostFtdcGenderType)[0]
    ...
    def getCustType(self):
        '''客户类型'''
        return TThostFtdcCustTypeType(ord(self.CustType)) if self.CustType in list(TThostFtdcCustTypeType) else list(TThostFtdcCustTypeType)[0]
    ...
    def getMoneyAccountStatus(self):
        '''资金账户状态'''
        return TThostFtdcMoneyAccountStatusType(ord(self.MoneyAccountStatus)) if self.MoneyAccountStatus in list(TThostFtdcMoneyAccountStatusType) else list(TThostFtdcMoneyAccountStatusType)[0]
    ...
    def getVerifyCertNoFlag(self):
        '''验证客户证件号码标志'''
        return TThostFtdcYesNoIndicatorType(ord(self.VerifyCertNoFlag)) if self.VerifyCertNoFlag in list(TThostFtdcYesNoIndicatorType) else list(TThostFtdcYesNoIndicatorType)[0]
    ...
    def getCashExchangeCode(self):
        '''汇钞标志'''
        return TThostFtdcCashExchangeCodeType(ord(self.CashExchangeCode)) if self.CashExchangeCode in list(TThostFtdcCashExchangeCodeType) else list(TThostFtdcCashExchangeCodeType)[0]
    ...
    def getBankAccType(self):
        '''银行帐号类型'''
        return TThostFtdcBankAccTypeType(ord(self.BankAccType)) if self.BankAccType in list(TThostFtdcBankAccTypeType) else list(TThostFtdcBankAccTypeType)[0]
    ...
    def getBankSecuAccType(self):
        '''期货单位帐号类型'''
        return TThostFtdcBankAccTypeType(ord(self.BankSecuAccType)) if self.BankSecuAccType in list(TThostFtdcBankAccTypeType) else list(TThostFtdcBankAccTypeType)[0]
    ...
    def getBankPwdFlag(self):
        '''银行密码标志'''
        return TThostFtdcPwdFlagType(ord(self.BankPwdFlag)) if self.BankPwdFlag in list(TThostFtdcPwdFlagType) else list(TThostFtdcPwdFlagType)[0]

    def getSecuPwdFlag(self):
        '''期货资金密码核对标志'''
        return TThostFtdcPwdFlagType(ord(self.SecuPwdFlag)) if self.SecuPwdFlag in list(TThostFtdcPwdFlagType) else list(TThostFtdcPwdFlagType)[0]
...
class  CThostFtdcReqTransferField(Structure):
    ...
    def getFeePayFlag(self):
        '''费用支付标志'''
        return TThostFtdcFeePayFlagType(ord(self.FeePayFlag)) if self.FeePayFlag in list(TThostFtdcFeePayFlagType) else list(TThostFtdcFeePayFlagType)[0]
    ...
    def getTransferStatus(self):
        '''转账交易状态'''
        return TThostFtdcTransferStatusType(ord(self.TransferStatus)) if self.TransferStatus in list(TThostFtdcTransferStatusType) else list(TThostFtdcTransferStatusType)[0]
...
class  CThostFtdcReqRepealField(Structure):
    ...
    def getBankRepealFlag(self):
        '''银行冲正标志'''
        return TThostFtdcBankRepealFlagType(ord(self.BankRepealFlag)) if self.BankRepealFlag in list(TThostFtdcBankRepealFlagType) else list(TThostFtdcBankRepealFlagType)[0]

    def getBrokerRepealFlag(self):
        '''期商冲正标志'''
        return TThostFtdcBrokerRepealFlagType(ord(self.BrokerRepealFlag)) if self.BrokerRepealFlag in list(TThostFtdcBrokerRepealFlagType) else list(TThostFtdcBrokerRepealFlagType)[0]
...
class  CThostFtdcReqQueryTradeResultBySerialField(Structure):
    ...
    def getRefrenceIssureType(self):
        '''本流水号发布者的机构类型'''
        return TThostFtdcInstitutionTypeType(ord(self.RefrenceIssureType)) if self.RefrenceIssureType in list(TThostFtdcInstitutionTypeType) else list(TThostFtdcInstitutionTypeType)[0]
...
class  CThostFtdcReqDayEndFileReadyField(Structure):
    ...
    def getFileBusinessCode(self):
        '''文件业务功能'''
        return TThostFtdcFileBusinessCodeType(ord(self.FileBusinessCode)) if self.FileBusinessCode in list(TThostFtdcFileBusinessCodeType) else list(TThostFtdcFileBusinessCodeType)[0]
...
class  CThostFtdcTransferSerialField(Structure):
    ...
    def getFutureAccType(self):
        '''期货公司帐号类型'''
        return TThostFtdcFutureAccTypeType(ord(self.FutureAccType)) if self.FutureAccType in list(TThostFtdcFutureAccTypeType) else list(TThostFtdcFutureAccTypeType)[0]
    ...
    def getAvailabilityFlag(self):
        '''有效标志'''
        return TThostFtdcAvailabilityFlagType(ord(self.AvailabilityFlag)) if self.AvailabilityFlag in list(TThostFtdcAvailabilityFlagType) else list(TThostFtdcAvailabilityFlagType)[0]
...
class  CThostFtdcAccountregisterField(Structure):
    ...
    def getOpenOrDestroy(self):
        '''开销户类别'''
        return TThostFtdcOpenOrDestroyType(ord(self.OpenOrDestroy)) if self.OpenOrDestroy in list(TThostFtdcOpenOrDestroyType) else list(TThostFtdcOpenOrDestroyType)[0]
...
class  CThostFtdcFensUserInfoField(Structure):
    ...
    def getLoginMode(self):
        '''登录模式'''
        return TThostFtdcLoginModeType(ord(self.LoginMode)) if self.LoginMode in list(TThostFtdcLoginModeType) else list(TThostFtdcLoginModeType)[0]
...
class  CThostFtdcReserveOpenAccountField(Structure):
    ...
    def getReserveOpenAccStas(self):
        '''预约开户状态'''
        return TThostFtdcReserveOpenAccStasType(ord(self.ReserveOpenAccStas)) if self.ReserveOpenAccStas in list(TThostFtdcReserveOpenAccStasType) else list(TThostFtdcReserveOpenAccStasType)[0]
...
class  CThostFtdcAccountPropertyField(Structure):
    ...
    def getAccountSourceType(self):
        '''账户来源'''
        return TThostFtdcAccountSourceTypeType(ord(self.AccountSourceType)) if self.AccountSourceType in list(TThostFtdcAccountSourceTypeType) else list(TThostFtdcAccountSourceTypeType)[0]
