...
class Trade:
    ...
    def ReqOrderInsert(self, BrokerID: str = '', InvestorID: str = '', InstrumentID: str = '', OrderRef: str = '', UserID: str = '', OrderPriceType: TThostFtdcOrderPriceTypeType = list(TThostFtdcOrderPriceTypeType)[0], Direction: TThostFtdcDirectionType = list(TThostFtdcDirectionType)[0], CombOffsetFlag: str = '', CombHedgeFlag: str = '', LimitPrice: float = .0, VolumeTotalOriginal: int = 1, TimeCondition: TThostFtdcTimeConditionType = list(TThostFtdcTimeConditionType)[0], GTDDate: str = '', VolumeCondition: TThostFtdcVolumeConditionType = list(TThostFtdcVolumeConditionType)[0], MinVolume: int = 1, ContingentCondition: TThostFtdcContingentConditionType = list(TThostFtdcContingentConditionType)[0], StopPrice: float = .0, ForceCloseReason: TThostFtdcForceCloseReasonType = list(TThostFtdcForceCloseReasonType)[0], IsAutoSuspend: int = 1, BusinessUnit: str = '', RequestID: int = 1, UserForceClose: int = 1, IsSwapOrder: int = 1, ExchangeID: str = '', InvestUnitID: str = '', AccountID: str = '', CurrencyID: str = '', ClientID: str = '', IPAddress: str = '', MacAddress: str = ''):
    ...
    def ReqParkedOrderInsert(self, BrokerID: str = '', InvestorID: str = '', InstrumentID: str = '', OrderRef: str = '', UserID: str = '', OrderPriceType: TThostFtdcOrderPriceTypeType = list(TThostFtdcOrderPriceTypeType)[0], Direction: TThostFtdcDirectionType = list(TThostFtdcDirectionType)[0], CombOffsetFlag: str = '', CombHedgeFlag: str = '', LimitPrice: float = .0, VolumeTotalOriginal: int = 1, TimeCondition: TThostFtdcTimeConditionType = list(TThostFtdcTimeConditionType)[0], GTDDate: str = '', VolumeCondition: TThostFtdcVolumeConditionType = list(TThostFtdcVolumeConditionType)[0], MinVolume: int = 1, ContingentCondition: TThostFtdcContingentConditionType = list(TThostFtdcContingentConditionType)[0], StopPrice: float = .0, ForceCloseReason: TThostFtdcForceCloseReasonType = list(TThostFtdcForceCloseReasonType)[0], IsAutoSuspend: int = 1, BusinessUnit: str = '', RequestID: int = 1, UserForceClose: int = 1, ExchangeID: str = '', ParkedOrderID: str = '', UserType: TThostFtdcUserTypeType = list(TThostFtdcUserTypeType)[0], Status: TThostFtdcParkedOrderStatusType = list(TThostFtdcParkedOrderStatusType)[0], ErrorID: int = 1, ErrorMsg: str = '', IsSwapOrder: int = 1, AccountID: str = '', CurrencyID: str = '', ClientID: str = '', InvestUnitID: str = '', IPAddress: str = '', MacAddress: str = ''):
    ...
    def ReqParkedOrderAction(self, BrokerID: str = '', InvestorID: str = '', OrderActionRef: int = 1, OrderRef: str = '', RequestID: int = 1, FrontID: int = 1, SessionID: int = 1, ExchangeID: str = '', OrderSysID: str = '', ActionFlag: TThostFtdcActionFlagType = list(TThostFtdcActionFlagType)[0], LimitPrice: float = .0, VolumeChange: int = 1, UserID: str = '', InstrumentID: str = '', ParkedOrderActionID: str = '', UserType: TThostFtdcUserTypeType = list(TThostFtdcUserTypeType)[0], Status: TThostFtdcParkedOrderStatusType = list(TThostFtdcParkedOrderStatusType)[0], ErrorID: int = 1, ErrorMsg: str = '', InvestUnitID: str = '', IPAddress: str = '', MacAddress: str = ''):
    ...
    def ReqOrderAction(self, BrokerID: str = '', InvestorID: str = '', OrderActionRef: int = 1, OrderRef: str = '', RequestID: int = 1, FrontID: int = 1, SessionID: int = 1, ExchangeID: str = '', OrderSysID: str = '', ActionFlag: TThostFtdcActionFlagType = list(TThostFtdcActionFlagType)[0], LimitPrice: float = .0, VolumeChange: int = 1, UserID: str = '', InstrumentID: str = '', InvestUnitID: str = '', IPAddress: str = '', MacAddress: str = ''):
    ...
    def ReqSettlementInfoConfirm(self, BrokerID: str = '', InvestorID: str = '', ConfirmDate: str = '', ConfirmTime: str = '', SettlementID: int = 1, AccountID: str = '', CurrencyID: str = ''):
    ...
    def ReqExecOrderAction(self, BrokerID: str = '', InvestorID: str = '', ExecOrderActionRef: int = 1, ExecOrderRef: str = '', RequestID: int = 1, FrontID: int = 1, SessionID: int = 1, ExchangeID: str = '', ExecOrderSysID: str = '', ActionFlag: TThostFtdcActionFlagType = list(TThostFtdcActionFlagType)[0], UserID: str = '', InstrumentID: str = '', InvestUnitID: str = '', IPAddress: str = '', MacAddress: str = ''):
    ...
    def ReqQuoteAction(self, BrokerID: str = '', InvestorID: str = '', QuoteActionRef: int = 1, QuoteRef: str = '', RequestID: int = 1, FrontID: int = 1, SessionID: int = 1, ExchangeID: str = '', QuoteSysID: str = '', ActionFlag: TThostFtdcActionFlagType = list(TThostFtdcActionFlagType)[0], UserID: str = '', InstrumentID: str = '', InvestUnitID: str = '', ClientID: str = '', IPAddress: str = '', MacAddress: str = ''):
    ...
    def ReqBatchOrderAction(self, BrokerID: str = '', InvestorID: str = '', OrderActionRef: int = 1, RequestID: int = 1, FrontID: int = 1, SessionID: int = 1, ExchangeID: str = '', UserID: str = '', InvestUnitID: str = '', IPAddress: str = '', MacAddress: str = ''):
    ...
    def ReqOptionSelfCloseInsert(self, BrokerID: str = '', InvestorID: str = '', InstrumentID: str = '', OptionSelfCloseRef: str = '', UserID: str = '', Volume: int = 1, RequestID: int = 1, BusinessUnit: str = '', HedgeFlag: TThostFtdcHedgeFlagType = list(TThostFtdcHedgeFlagType)[0], OptSelfCloseFlag: TThostFtdcOptSelfCloseFlagType = list(TThostFtdcOptSelfCloseFlagType)[0], ExchangeID: str = '', InvestUnitID: str = '', AccountID: str = '', CurrencyID: str = '', ClientID: str = '', IPAddress: str = '', MacAddress: str = ''):
    ...
    def ReqOptionSelfCloseAction(self, BrokerID: str = '', InvestorID: str = '', OptionSelfCloseActionRef: int = 1, OptionSelfCloseRef: str = '', RequestID: int = 1, FrontID: int = 1, SessionID: int = 1, ExchangeID: str = '', OptionSelfCloseSysID: str = '', ActionFlag: TThostFtdcActionFlagType = list(TThostFtdcActionFlagType)[0], UserID: str = '', InstrumentID: str = '', InvestUnitID: str = '', IPAddress: str = '', MacAddress: str = ''):
    ...
    def ReqCombActionInsert(self, BrokerID: str = '', InvestorID: str = '', InstrumentID: str = '', CombActionRef: str = '', UserID: str = '', Direction: TThostFtdcDirectionType = list(TThostFtdcDirectionType)[0], Volume: int = 1, CombDirection: TThostFtdcCombDirectionType = list(TThostFtdcCombDirectionType)[0], HedgeFlag: TThostFtdcHedgeFlagType = list(TThostFtdcHedgeFlagType)[0], ExchangeID: str = '', IPAddress: str = '', MacAddress: str = '', InvestUnitID: str = ''):
    ...
    def ReqFromBankToFutureByFuture(self, TradeCode: str = '', BankID: str = '', BankBranchID: str = '', BrokerID: str = '', BrokerBranchID: str = '', TradeDate: str = '', TradeTime: str = '', BankSerial: str = '', TradingDay: str = '', PlateSerial: int = 1, LastFragment: TThostFtdcLastFragmentType = list(TThostFtdcLastFragmentType)[0], SessionID: int = 1, CustomerName: str = '', IdCardType: TThostFtdcIdCardTypeType = list(TThostFtdcIdCardTypeType)[0], IdentifiedCardNo: str = '', CustType: TThostFtdcCustTypeType = list(TThostFtdcCustTypeType)[0], BankAccount: str = '', BankPassWord: str = '', AccountID: str = '', Password: str = '', InstallID: int = 1, FutureSerial: int = 1, UserID: str = '', VerifyCertNoFlag: TThostFtdcYesNoIndicatorType = list(TThostFtdcYesNoIndicatorType)[0], CurrencyID: str = '', TradeAmount: float = .0, FutureFetchAmount: float = .0, FeePayFlag: TThostFtdcFeePayFlagType = list(TThostFtdcFeePayFlagType)[0], CustFee: float = .0, BrokerFee: float = .0, Message: str = '', Digest: str = '', BankAccType: TThostFtdcBankAccTypeType = list(TThostFtdcBankAccTypeType)[0], DeviceID: str = '', BankSecuAccType: TThostFtdcBankAccTypeType = list(TThostFtdcBankAccTypeType)[0], BrokerIDByBank: str = '', BankSecuAcc: str = '', BankPwdFlag: TThostFtdcPwdFlagType = list(TThostFtdcPwdFlagType)[0], SecuPwdFlag: TThostFtdcPwdFlagType = list(TThostFtdcPwdFlagType)[0], OperNo: str = '', RequestID: int = 1, TID: int = 1, TransferStatus: TThostFtdcTransferStatusType = list(TThostFtdcTransferStatusType)[0], LongCustomerName: str = ''):
    ...
    def ReqQueryBankAccountMoneyByFuture(self, TradeCode: str = '', BankID: str = '', BankBranchID: str = '', BrokerID: str = '', BrokerBranchID: str = '', TradeDate: str = '', TradeTime: str = '', BankSerial: str = '', TradingDay: str = '', PlateSerial: int = 1, LastFragment: TThostFtdcLastFragmentType = list(TThostFtdcLastFragmentType)[0], SessionID: int = 1, CustomerName: str = '', IdCardType: TThostFtdcIdCardTypeType = list(TThostFtdcIdCardTypeType)[0], IdentifiedCardNo: str = '', CustType: TThostFtdcCustTypeType = list(TThostFtdcCustTypeType)[0], BankAccount: str = '', BankPassWord: str = '', AccountID: str = '', Password: str = '', FutureSerial: int = 1, InstallID: int = 1, UserID: str = '', VerifyCertNoFlag: TThostFtdcYesNoIndicatorType = list(TThostFtdcYesNoIndicatorType)[0], CurrencyID: str = '', Digest: str = '', BankAccType: TThostFtdcBankAccTypeType = list(TThostFtdcBankAccTypeType)[0], DeviceID: str = '', BankSecuAccType: TThostFtdcBankAccTypeType = list(TThostFtdcBankAccTypeType)[0], BrokerIDByBank: str = '', BankSecuAcc: str = '', BankPwdFlag: TThostFtdcPwdFlagType = list(TThostFtdcPwdFlagType)[0], SecuPwdFlag: TThostFtdcPwdFlagType = list(TThostFtdcPwdFlagType)[0], OperNo: str = '', RequestID: int = 1, TID: int = 1, LongCustomerName: str = ''):
