...
class BGBB(BetaGeoBetaBinomFitter):
    ...
    # fit_ = frt(BetaGeoBetaBinomFitter.fit)
    # palive = frt(BetaGeoBetaBinomFitter.conditional_probability_alive)
    # samp = multi_samp
    # pred = _pred
    _loglikelihood = staticmethod(nb_loglikelihood)
    # _loglikelihood_df = staticmethod(nb_loglikelihood_df)
    old_loglikelihood = BetaGeoBetaBinomFitter._loglikelihood
    # palive = frt(conditional_probability_alive_)
