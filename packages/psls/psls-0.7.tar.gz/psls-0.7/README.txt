...
The simulator includes planetary transits, stochastically-excited oscillations, granulation and activity background components, as well as instrumental systematic errors and random noises representative for PLATO. The program also manages the existence of a time shift between groups of cameras.
...
The data package provides the code and two files storing the parameters describing the PLATO systematic errors:
