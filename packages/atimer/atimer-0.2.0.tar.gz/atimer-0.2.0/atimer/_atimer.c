...
#define __PYX_HAVE__atimer___atimer
#define __PYX_HAVE_API__atimer___atimer
/* Early includes */
#include <sys/types.h>
#include <unistd.h>
#include <stddef.h>
...
static PyObject *__pyx_pf_6atimer_7_atimer_atimer_init(CYTHON_UNUSED PyObject *__pyx_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("atimer_init", 0);

  /* "atimer/_atimer.pyx":43
 *     # do not block on file descriptor, so in case of some error, we do not
 *     # block in event loop callback
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(timerfd_create(CLOCK_MONOTONIC, TFD_NONBLOCK)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 43, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_AddTraceback("atimer._atimer.atimer_init", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
...
static PyObject *__pyx_pw_6atimer_7_atimer_3atimer_start(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("atimer_start (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_interval)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("atimer_start", 1, 2, 2, 1); __PYX_ERR(0, 45, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "atimer_start") < 0)) __PYX_ERR(0, 45, __pyx_L3_error)
      }
    ...
    __pyx_v_fd = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_fd == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 45, __pyx_L3_error)
    __pyx_v_interval = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_interval == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 45, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("atimer_start", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 45, __pyx_L3_error)
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_6atimer_7_atimer_2atimer_start(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_fd, double __pyx_v_interval) {
  struct itimerspec __pyx_v_ts;
  time_t __pyx_v_sec;
  long __pyx_v_nsec;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
 ...
 * 
 */
  __pyx_v_sec = ((int)__pyx_v_interval);

  /* "atimer/_atimer.pyx":51
 * 
 *     sec = <int> interval
 *     nsec = (interval - sec) * int(1e9)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = PyFloat_FromDouble((__pyx_v_interval - __pyx_v_sec)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyNumber_Int(__pyx_float_1e9); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = PyNumber_Multiply(__pyx_t_1, __pyx_t_2); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_4 = __Pyx_PyInt_As_long(__pyx_t_3); if (unlikely((__pyx_t_4 == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_nsec = __pyx_t_4;

  /* "atimer/_atimer.pyx":53
 *     nsec = (interval - sec) * int(1e9)
 * 
 *     ts.it_value.tv_sec = sec             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_ts.it_value.tv_sec = __pyx_v_sec;

  /* "atimer/_atimer.pyx":54
 * 
 *     ts.it_value.tv_sec = sec
 *     ts.it_value.tv_nsec = nsec             # <<<<<<<<<<<<<<
 *     ts.it_interval.tv_sec = sec
 ...
 */
  __pyx_v_ts.it_value.tv_nsec = __pyx_v_nsec;

  /* "atimer/_atimer.pyx":55
 *     ts.it_value.tv_sec = sec
 *     ts.it_value.tv_nsec = nsec
 *     ts.it_interval.tv_sec = sec             # <<<<<<<<<<<<<<
 *     ts.it_interval.tv_nsec = nsec
 * 
 */
  __pyx_v_ts.it_interval.tv_sec = __pyx_v_sec;
 ...
 */
  __pyx_v_ts.it_interval.tv_nsec = __pyx_v_nsec;
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_3 = __Pyx_PyInt_From_int(timerfd_settime(__pyx_v_fd, 0, (&__pyx_v_ts), NULL)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 58, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_r = __pyx_t_3;
  __pyx_t_3 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pw_6atimer_7_atimer_5atimer_close(PyObject *__pyx_self, PyObject *__pyx_arg_fd) {
  ...
  assert(__pyx_arg_fd); {
    __pyx_v_fd = __Pyx_PyInt_As_int(__pyx_arg_fd); if (unlikely((__pyx_v_fd == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 60, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_6atimer_7_atimer_4atimer_close(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_fd) {
  ...
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("atimer_close", 0);

  /* "atimer/_atimer.pyx":64
 *     cdef itimerspec ts
 * 
 ...
 */
  __pyx_v_ts.it_interval.tv_sec = 0;
 ...
 */
  __pyx_v_ts.it_interval.tv_nsec = 0;

  /* "atimer/_atimer.pyx":66
 *     ts.it_interval.tv_sec = 0
 *     ts.it_interval.tv_nsec = 0
 *     ts.it_value.tv_sec = 0             # <<<<<<<<<<<<<<
 *     ts.it_value.tv_nsec = 0
 * 
 */
  __pyx_v_ts.it_value.tv_sec = 0;

  /* "atimer/_atimer.pyx":67
 *     ts.it_interval.tv_nsec = 0
 *     ts.it_value.tv_sec = 0
 *     ts.it_value.tv_nsec = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_ts.it_value.tv_nsec = 0;

  /* "atimer/_atimer.pyx":69
 *     ts.it_value.tv_nsec = 0
 * 
 *     r = timerfd_settime(fd, 0, &ts, NULL)             # <<<<<<<<<<<<<<
 *     close(fd)
 * 
 */
  __pyx_v_r = timerfd_settime(__pyx_v_fd, 0, (&__pyx_v_ts), NULL);

  /* "atimer/_atimer.pyx":70
 * 
 *     r = timerfd_settime(fd, 0, &ts, NULL)
 *     close(fd)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_r); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 *     cdef time_t sec
 */
  __pyx_tuple__2 = PyTuple_Pack(5, __pyx_n_s_fd, __pyx_n_s_interval, __pyx_n_s_ts, __pyx_n_s_sec, __pyx_n_s_nsec); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__2);
  __Pyx_GIVEREF(__pyx_tuple__2);
  __pyx_codeobj__3 = (PyObject*)__Pyx_PyCode_New(2, 0, 5, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__2, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_atimer__atimer_pyx, __pyx_n_s_atimer_start, 45, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__3)) __PYX_ERR(0, 45, __pyx_L1_error)
 ...
 *     cdef itimerspec ts
 */
  __pyx_tuple__4 = PyTuple_Pack(4, __pyx_n_s_fd, __pyx_n_s_fd, __pyx_n_s_r, __pyx_n_s_ts); if (unlikely(!__pyx_tuple__4)) __PYX_ERR(0, 60, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__4);
  __Pyx_GIVEREF(__pyx_tuple__4);
  __pyx_codeobj__5 = (PyObject*)__Pyx_PyCode_New(1, 0, 4, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__4, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_atimer__atimer_pyx, __pyx_n_s_atimer_close, 60, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__5)) __PYX_ERR(0, 60, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_atimer(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_atimer(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__atimer(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__atimer(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__atimer(void)", 0);
 ...
 *     # block in event loop callback
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6atimer_7_atimer_1atimer_init, NULL, __pyx_n_s_atimer__atimer); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_atimer_init, __pyx_t_1) < 0) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     cdef time_t sec
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6atimer_7_atimer_3atimer_start, NULL, __pyx_n_s_atimer__atimer); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_atimer_start, __pyx_t_1) < 0) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     cdef itimerspec ts
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6atimer_7_atimer_5atimer_close, NULL, __pyx_n_s_atimer__atimer); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 60, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_atimer_close, __pyx_t_1) < 0) __PYX_ERR(0, 60, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
