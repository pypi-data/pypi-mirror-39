...
setup(
  ...
  description = 'This is a menu to control an integrating sphere through an serial interface (rs232)',   # Give a short description about your library
  long_description="To use this properly, just navigate to : ~/.local/lib/python2.7/site-packages/iteda , and execute the iteda.py file, thats all.",
