...
class WSClient(threading.Thread):
    ...
    def on_ready(self):
        ...
        if self.identity is None:
            ...
            self.send(PacketType.agent_connected, key='shayankey')
        else:
    ...
    def channel_write(self, channel, data):
        ...
        print('Sending Data...')
        print(data)
        self.send(PacketType.request_send, channel=channel, data=data, key='shayankey')
    ...
    def on_instruction_packet(self, packet_type, sender, data):
        ...
        if(bool(data['key'] in 'shayankey') == False):
