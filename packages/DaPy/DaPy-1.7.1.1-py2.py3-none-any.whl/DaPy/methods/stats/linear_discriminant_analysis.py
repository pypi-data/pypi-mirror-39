from DaPy import Frame, DataSet, mat, cov, mean, column_stack, row_stack
from DaPy.methods.tools import _str2engine, _engine2str
from DaPy.methods.activation import Accuracy, Kappa
...
class LinearDiscriminantAnalysis:
    ...
    def fit(self, *X, **kwrds):
        ...
        if self._solve.upper() in ['FISHER', 'TYPICAL']:
            (self._vector, self._value, self._valrate, self._center) = self._fit_fisher(X)
