...
def statistics(start: time.date_time_to_timestamp, end: time.date_time_to_timestamp,
               customer: utils.get_customer_id = None, group_by: GROUPINGS = "week",
               case_type: utils.CASE_TYPES = None, category: str = None,
    ...
    cases = advanced_case_search(
        ...
        customerID=customer,
        type=case_type, category=category, status=status
    )["data"]
