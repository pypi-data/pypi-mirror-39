...
from feqdyn.analysis._unit_conversions import conversion_factors as cf


def draw_dipole_velocity():
    """Draws the dipole velocity, its spectrum, and
    spectrogram."""

    parser = argparse.ArgumentParser(
        description=("Draws the dipole velocity, its fourier "
    ...
    ax1.set_ylabel(r'$\mel*{\psi(t)}{\hat{p}_z}{\psi(t)}$ (a.u.)')
    ...
    ax2.set_ylabel(r'$\vert \dot{D}_z(\omega) \vert^2$ (a.u.)')
    ...
    if args['save']:
        ...
        plt.savefig("data/figures/dipole_velocity.pdf")
    else:
        plt.show()


if __name__ == '__main__':
    draw_dipole_velocity()
