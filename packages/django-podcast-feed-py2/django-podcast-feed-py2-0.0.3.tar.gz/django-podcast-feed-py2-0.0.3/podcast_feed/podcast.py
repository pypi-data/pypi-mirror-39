...
class ItunesPodcastRssFeed(Rss201rev2Feed):
    def __init__(self, title, link, description, language=None, author_email=None,
                 ...
                 **kwargs):
        super(ItunesPodcastRssFeed, self).__init__(title, link, description, language, author_email,
    ...
    def root_attributes(self):
        attrs = super(ItunesPodcastRssFeed, self).root_attributes()
        attrs['xmlns:itunes'] = 'http://www.itunes.com/dtds/podcast-1.0.dtd'
        return attrs

    def add_root_elements(self, handler):
        super(ItunesPodcastRssFeed, self).add_root_elements(handler)
    ...
    def add_item_elements(self, handler, item):
        super(ItunesPodcastRssFeed, self).add_item_elements(handler, item)
...
class PodcastFeed(Feed):
    ...
    def get_feed(self, obj, request):
        feed = super(PodcastFeed, self).get_feed(obj, request)
    ...
    def item_extra_kwargs(self, item):
        extra_kwargs = super(PodcastFeed, self).item_extra_kwargs(item)
