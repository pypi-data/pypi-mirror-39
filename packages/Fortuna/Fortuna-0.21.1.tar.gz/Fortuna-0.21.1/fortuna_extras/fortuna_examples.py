from Fortuna import CumulativeWeightedChoice, FlexCat
...
class RandomSpell:
    ...
    def __call__(self, spell_level: str = None) -> str:
...
if __name__ == "__main__":
    from Fortuna import distribution_timer

    print(note)

    print("Treasure Table A Distribution:")
    treasure_table_a = TreasureTable_A()
    distribution_timer(treasure_table_a, call_sig="treasure_table_a()")

    print("Treasure Table E Distribution:")
    treasure_table_e = TreasureTable_E()
    distribution_timer(treasure_table_e, call_sig="treasure_table_e()")
