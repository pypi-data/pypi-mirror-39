...
if __name__ == "__main__":
    t0 = datetime.now()
    print("\nFortuna Pure 0.20.6 Sample Distribution and Performance Test Suite\n")
    ...
    print(f"monty.mostly_flat(n_samples=10) -> {monty.mostly_flat(n_samples=10)}")
    print(f"monty.mostly_middle(n_samples=10) -> {monty.mostly_middle(n_samples=10)}")
    print(f"monty.mostly_center(n_samples=10) -> {monty.mostly_center(n_samples=10)}")
    print(f"monty.mostly_front(n_samples=10) -> {monty.mostly_front(n_samples=10)}")
    print(f"monty.mostly_back(n_samples=10) -> {monty.mostly_back(n_samples=10)}")
    print(f"monty.mostly_first(n_samples=10) -> {monty.mostly_first(n_samples=10)}")
    print(f"monty.mostly_last(n_samples=10) -> {monty.mostly_last(n_samples=10)}")
    print(f"monty.mostly_cycle(n_samples=10) -> {monty.mostly_cycle(n_samples=10)}\n")
    ...
    print(f"random_cycle(n_samples=10) -> {random_cycle(n_samples=10)}\n")
    ...
    print(f"cumulative_choice(n_samples=10) -> {cumulative_choice(n_samples=10)}\n")
    ...
    print(f"relative_choice(n_samples=10) -> {relative_choice(n_samples=10)}\n")
    ...
    print(f"flex_cat(n_samples=10) -> {flex_cat(n_samples=10)}")
    print(f"flex_cat(cat_key='Cat_A', n_samples=10) -> {flex_cat(cat_key='Cat_A', n_samples=10)}")
    print(f"flex_cat(cat_key='Cat_B', n_samples=10) -> {flex_cat(cat_key='Cat_B', n_samples=10)}")
    print(f"flex_cat(cat_key='Cat_C', n_samples=10) -> {flex_cat(cat_key='Cat_C', n_samples=10)}")
    print(f"\n{'-' * 73}")
