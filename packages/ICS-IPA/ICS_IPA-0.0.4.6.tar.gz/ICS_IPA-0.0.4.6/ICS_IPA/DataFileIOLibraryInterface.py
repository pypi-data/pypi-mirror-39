...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_DataFileIOLibraryInterface')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_DataFileIOLibraryInterface')
    _DataFileIOLibraryInterface = swig_import_helper()
    ...
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_DataFileIOLibraryInterface', [dirname(__file__)])
        except ImportError:
            import _DataFileIOLibraryInterface
            return _DataFileIOLibraryInterface
        try:
            _mod = imp.load_module('_DataFileIOLibraryInterface', fp, pathname, description)
        finally:
            if fp is not None:
                fp.close()
        return _mod
