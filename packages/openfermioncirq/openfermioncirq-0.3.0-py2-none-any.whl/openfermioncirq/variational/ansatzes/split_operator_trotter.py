...
u"""A variational ansatz based on a split-operator Trotter step."""
...
class SplitOperatorTrotterAnsatz(VariationalAnsatz):
    u"""An ansatz based on a split-operator Trotter step.
    ...
    def __init__(self,
        ...
        super(SplitOperatorTrotterAnsatz, self).__init__(qubits)

    def params(self):
        u"""The names of the parameters of the ansatz."""
