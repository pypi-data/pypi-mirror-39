...
from getuipy.google.protobuf import (
...
_VERSION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='major', full_name='google.protobuf.compiler.Version.major',
            index=0,
        ...
        _descriptor.FieldDescriptor(
            name='minor', full_name='google.protobuf.compiler.Version.minor',
            index=1,
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='patch', full_name='google.protobuf.compiler.Version.patch',
            index=2,
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='suffix', full_name='google.protobuf.compiler.Version.suffix',
            index=3,
...
Version = _reflection.GeneratedProtocolMessageType('Version',
...
CodeGeneratorRequest = _reflection.GeneratedProtocolMessageType(
    'CodeGeneratorRequest', (_message.Message,), dict(
...
CodeGeneratorResponse = _reflection.GeneratedProtocolMessageType(
    'CodeGeneratorResponse', (_message.Message,), dict(

        File=_reflection.GeneratedProtocolMessageType('File',
                                                      (_message.Message,),
                                                      dict(
