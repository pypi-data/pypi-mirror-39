...
class DatabricksStep(PipelineStep):
    ...
    def __init__(self, name, inputs=None, outputs=None, existing_cluster_id=None, spark_version=None, node_type=None,
                 num_workers=None, autoscale=None, spark_env_variables=None, notebook_path=None, notebook_params=None,
                 python_script_path=None, python_script_params=None, main_class_name=None,
