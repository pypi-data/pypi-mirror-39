...
def prep(datfile,Vsamp,S,CT,PT,SiT,Tk_force=None):
    ...
    Macid = Vacid * dens.acid(Tk)      * 1e-3 # acid mass   / kg
...
def halfGran(datfile,Vsamp,Cacid,S,CT,PT, Tk_force=None):
    
    Macid,EMF,Tk,Msamp,XT,KX = prep(datfile,Vsamp,S,CT,PT,0,Tk_force)
    
    return solve.halfGran(Macid,EMF,Tk,Msamp,Cacid,*XT,*KX)


def halfGran_CRM(datfile,Vsamp,AT_cert,S,CT,PT, Tk_force=None):
...
def MPH(datfile,Vsamp,Cacid,S,CT,PT,SiT, Tk_force=None):
    
    Macid,EMF,Tk,Msamp,XT,KX = prep(datfile,Vsamp,S,CT,PT,SiT,Tk_force)
        
    return solve.MPH(Macid,EMF,Tk,Msamp,Cacid,*XT,KX)


def MPH_CRM(datfile,Vsamp,AT_cert,S,CT,PT,SiT, Tk_force=None):
