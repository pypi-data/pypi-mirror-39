...
from zmei_cli.deploy import generate_setting, generate_req_prod, generate_dockerfile, generate_dockerignore
...
#
#
# @main.group(help='Docker utilities')
# @click.pass_context
# def docker(context, **args):
#     pass
#
#
# @docker.command(help='Generate docker config files', name='config')
