...
#. Install *pcrunner* as Windows Service
    ...
    * Go to folder ``C:\Python27\Lib\site-packages\pcrunner-0.4.6-py2.7.egg\pcrunner``
    * Shift-right-click
    * Click *Open command window here*
    * Run::
...
#. Configure *pcrunner* as Windows Service
    ...
    * Edit ``C:\Python27\Lib\site-packages\pcrunner-0.4.6-py2.7.egg\pcrunner\etc\pcrunner.yml``
        * *nsca_web_url*
        * *nsca_web_username*
        * *nsca_web_password*
...
#. Download pcrunner-0.4.6.tar.gz from `GitHub`::

    $ curl -L -o pcrunner-0.4.6.tar.gz https://github.com/maartenq/pcrunner/archive/v0.4.6.tar.gz


#. Build RPM from tarball::

    $ rpmbuild -tb pcrunner-0.4.6.tar.gz


#. Install RPM::

   $ sudo yum install ~/rpmbuild/RPMS/noarch/pcrunner-0.4.6-1.noarch.rpm
