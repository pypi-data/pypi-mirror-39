...
# define the partition fucntion to divide the list using pivots
...
def partition(slist, low, high):
    ...
    return (i + 1)
# Function to do Quick sort using the same parameters as partition
...
# define the driving fucntion for the algorithm.
# note: low and high are specified in this function too.
