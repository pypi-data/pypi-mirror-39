...
from ica import CryptoICA
from pgp import CryptoPGP
from postsignum import CryptoPostSignum
import logging
...
class Register(object):
    ...
    def get_service(cmd_params=None):
        if cmd_params['signer'].lower() == 'ica':
            ...
            logger.error("Unknown signing service requested: %s" % cmd_params['signer'])
            exit(3)
