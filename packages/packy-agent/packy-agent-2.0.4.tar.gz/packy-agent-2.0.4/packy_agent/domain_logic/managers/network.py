...
from packy_agent.utils.platforms import (get_os_id_and_version, LINUX_MINT_18_1, UBUNTU_16_04,
                                         UBUNTU_18_04, RASPBIAN_9_4, is_inside_docker_container)
from packy_agent.configuration.settings import settings
from packy_agent.utils.network import get_interfaces, get_machine_ip_address, get_hostname_from_url
...
OPERATING_SYSTEM_TEMPLATES = {
    ...
    RASPBIAN_9_4: UBUNTU_DEBIAN_TEMPLATES,
}
