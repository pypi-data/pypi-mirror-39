...
from .util import print_this, throw_this, base_url, base_return_url, isinstance_usertype, try_catch
...
class Table:
    ...
    def column(self, index_or_name):
        ...
        return self._column_with_name(str(index_or_name))
    ...
    def _head(self, n, end_at = None):
        ...
        for i in range(0,min(limit,size)):
            row_output = ["{0:>6}".format(str(i + offset))]
            for col in col_data:
