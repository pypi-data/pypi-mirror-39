...
class MyTestCase(unittest.TestCase):
    ...
    def test_buy_protection(self):
        ...
        self.assertAlmostEqual(-1.23099324435, pv_dirty, 6)
        self.assertAlmostEqual(-1.19210435546, pv_clean, 6)
        self.assertAlmostEqual(0.0388888888889, ai, 6)
        self.assertAlmostEqual(14014.5916905, cs01 * 1.0e6, 6)
        self.assertAlmostEqual(131.61798715, dv01 * 1.0e6, 6)
