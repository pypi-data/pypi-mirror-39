...
class BasicTests(TestBase):
    ...
    def test_set_with_valid_xml(self):
        ...
        self.assertEqual(xml2.strip().endswith('<hello>world</hello>'), True)
    ...
    def test_xpath_field(self):
        self.doc.xml_set('xml_content',
                         u'<root><a>hello</a><a>world</a></root>')
        ...
        self.assertEqual(self.doc.xml_xpath,
                         u'field=xml_content,xpath=//a/text()')
