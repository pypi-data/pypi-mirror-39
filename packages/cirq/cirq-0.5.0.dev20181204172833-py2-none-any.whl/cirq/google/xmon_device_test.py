...
def test_validate_circuit_repeat_measurement_keys():
    ...
    circuit.append([cirq.MeasurementGate(u'a').on(cirq.GridQubit(0, 0)),
                    cirq.MeasurementGate(u'a').on(cirq.GridQubit(0, 1))])
