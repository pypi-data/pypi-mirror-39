...
class SupportsChannel(Protocol):
    ...
    def _channel_(self):
        u"""A list of matrices describing the quantum channel.
...
def channel(val,
    ...
    u"""Returns a list of matrices describing the channel for the given value.
    ...
    if channel_getter is None and unitary_getter is None:
        raise TypeError(u"object of type '{}' has no _channel_ or "
                        u"_unitary_ method.".format(type(val)))
    raise TypeError(u"object of type '{}' does have a _channel_  or _unitary_ "
