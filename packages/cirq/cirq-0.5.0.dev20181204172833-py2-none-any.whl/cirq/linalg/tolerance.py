...
u"""A type for specifying thresholds for doing approximate equality."""
...
class Tolerance(object):
    u"""Specifies thresholds for doing approximate equality."""
    ...
    def __init__(self,
                 ...
                 atol = 1e-8,
                 equal_nan = False):
        u"""Initializes a Tolerance instance with the specified parameters.
    ...
    def __repr__(self):
        return u"Tolerance(rtol={}, atol={}, equal_nan={})".format(
