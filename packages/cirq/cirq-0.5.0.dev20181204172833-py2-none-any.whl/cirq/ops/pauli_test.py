...
def test_equals():
    ...
    eq.add_equality_group(cirq.Pauli.X, cirq.Pauli(_index=0, _name=u'X'))
    eq.add_equality_group(cirq.Pauli.Y, cirq.Pauli(_index=1, _name=u'Y'))
    eq.add_equality_group(cirq.Pauli.Z, cirq.Pauli(_index=2, _name=u'Z'))
...
def test_str():
    assert unicode(cirq.Pauli.X) == u'X'
    assert unicode(cirq.Pauli.Y) == u'Y'
    assert unicode(cirq.Pauli.Z) == u'Z'


def test_repr():
    assert repr(cirq.Pauli.X) == u'cirq.Pauli.X'
    assert repr(cirq.Pauli.Y) == u'cirq.Pauli.Y'
    assert repr(cirq.Pauli.Z) == u'cirq.Pauli.Z'
