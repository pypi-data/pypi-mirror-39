...
def _all_operations(q0, q1, q2, q3, q4, include_measurments=True):
    ...
    return (
        ...
        (
            cirq.MeasurementGate(u'xX')(q0),
            cirq.MeasurementGate(u'x_a')(q2),
            cirq.MeasurementGate(u'x?')(q1),
            cirq.MeasurementGate(u'X')(q3),
            cirq.MeasurementGate(u'_x')(q4),
            cirq.MeasurementGate(u'x_a')(q2),
            cirq.MeasurementGate(u'multi', (False, True))(q1, q2, q3),
