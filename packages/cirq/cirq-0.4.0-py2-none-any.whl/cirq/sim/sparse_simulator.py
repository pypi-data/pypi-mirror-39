...
class Simulator(simulator.SimulatesSamples,
    ...
    def _run(
        ...
        param_resolver,
        repetitions):
        u"""See definition in `sim.SimulatesSamples`."""
    ...
    def _simulator_iterator(
        ...
        u"""See definition in `sim.SimulatesIntermediateWaveFunction`."""
        param_resolver = param_resolver or study.ParamResolver({})
        resolved_circuit = protocols.resolve_parameters(circuit, param_resolver)
    ...
    def _base_iterator(
        ...
        def on_stuck(bad_op):
            return TypeError(
                ...
                u"_unitary_ method, a _decompose_ method, or "
            ...
            for op in unitary_ops_and_measurements:
                ...
                if ops.MeasurementGate.is_measurement(op):
                    ...
                    if perform_measurements:
                        ...
                        measurements[cast(unicode, gate.key)].extend(corrected)
                else:
...
class SimulatorStep(simulator.StepResult):
    ...
    def __init__(self, state, measurements, qubit_map, dtype):
        ...
        """
        super(SimulatorStep, self).__init__(qubit_map, measurements)
        self._dtype = dtype
