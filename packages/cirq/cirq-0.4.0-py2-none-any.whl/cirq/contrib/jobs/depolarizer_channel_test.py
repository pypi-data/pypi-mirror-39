...
def test_depolarizer_all_errors():
    ...
    p0 = cirq.Symbol(DepolarizerChannel._parameter_name + u'0')
    p1 = cirq.Symbol(DepolarizerChannel._parameter_name + u'1')
...
def test_depolarizer_different_gate():
    ...
    p0 = cirq.Symbol(DepolarizerChannel._parameter_name + u'0')
    p1 = cirq.Symbol(DepolarizerChannel._parameter_name + u'1')
    p2 = cirq.Symbol(DepolarizerChannel._parameter_name + u'2')
    p3 = cirq.Symbol(DepolarizerChannel._parameter_name + u'3')
...
def test_depolarizer_parameterized_gates():
    q1 = cirq.NamedQubit(u'q1')
    q2 = cirq.NamedQubit(u'q2')
    cnot_param = cirq.Symbol(u'cnot_turns')
    cnot_gate = cirq.CZ(q1, q2)**cnot_param

    job_sweep = cirq.Points(u'cnot_turns', [0.5])
