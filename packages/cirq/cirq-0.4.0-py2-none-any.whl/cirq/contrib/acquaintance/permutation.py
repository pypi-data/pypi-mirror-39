...
LogicalIndex = TypeVar(u'LogicalIndex', int, ops.QubitId)
LogicalGates = Dict[Tuple[LogicalIndex, ...], ops.Gate]
LogicalMappingKey = TypeVar(u'LogicalMappingKey', bound=ops.QubitId)
...
class LinearPermutationGate(PermutationGate):
    ...
    def __init__(self,
        ...
        """
        super(LinearPermutationGate, self).__init__(swap_gate)
