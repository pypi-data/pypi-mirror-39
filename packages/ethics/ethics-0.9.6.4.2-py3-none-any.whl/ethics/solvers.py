            ...
            if b != None:
                while not b.isClosed() and not b.isSaturated():
                    ...
                    if isinstance(f, Not) and isinstance(f.f1, Not):
                        ...
                        b.addFormula(Or(Consequence(term), Choice(term)))
                        ...
                        b.unexpanded.remove(f)
                        b.addFormula(Or(Not(Exists("x", And(Goal("_x_"), AffectsPos("_x_", f.f1)))), Exists("_x_", And(Goal("_x_"), AffectsNeg("_x_", f.f1.f1)))))
                        ...
                        b.unexpanded.remove(f)
                        b.addFormula(Not(Patient(f.f1.f1)))
                        b.addFormula(Not(Consequence(f.f1.f1)))
                        ...
                        b.unexpanded.remove(f)
                        b.addFormula(Not(Choice(f.f1.f1)))
                        b.addFormula(Not(Consequence(f.f1.f1)))
...
if __name__ == '__main__':
    ...
    f = [Choice("a"), Causes("a", "c1"), Forall("_x_", Impl(Means("Reading-1", "_x_"), End("_x_")))]
