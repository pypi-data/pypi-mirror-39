...
from prudence.__version__ import __version__, _version_min_python_
...
setup(
    ...
    url='https://pypi.org/project/prudence/',
    author="Brian Farrell",
    author_email="one.chillindude@me.com",
    description="simple, stable, managable command-line apps.",
