...
if __name__=="__main__":
  setup(name="clusgeo",
      ...
      "dscribe",
      "ase", 
      "soaplite"], python_requires='>=2.2, <4', keywords="descriptor materials science machine learning soap local environment materials physics symmetry reduction adsorption sites",
