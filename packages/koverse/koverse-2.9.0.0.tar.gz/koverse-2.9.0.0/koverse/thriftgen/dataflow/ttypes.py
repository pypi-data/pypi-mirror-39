...
class TJobAbstract(object):
    ...
    def __init__(self, id=None, userId=None, creationDate=None, startedDate=None, endedDate=None, status=None, errorDetail=None, statusMessage=None, userAcknowledged=None, origin=None, overrideBlockedStatus=None, type=None, progress=None, dataSetId=None, inputDataSetIds=None, outputDataSetId=None, errors=None, backendUserInterfaceUrl=None, recordCount=None, name=None,):
        self.id = id
        self.userId = userId
    ...
    def write(self, oprot):
        ...
        if self.recordCount is not None:
            oprot.writeFieldBegin('recordCount', TType.I64, 19)
...
class TExportJob(object):
    ...
    def __init__(self, jobAbstract=None, hadoopName=None, sinkId=None, sourceCollectionId=None, parameters=None, className=None, timeField=None, timeFormat=None, recordCount=None, transforms=None, inputDataWindowType=None,):
        self.jobAbstract = jobAbstract
        self.hadoopName = hadoopName
        self.sinkId = sinkId
    ...
    def write(self, oprot):
        ...
        if self.recordCount is not None:
            ...
            oprot.writeFieldEnd()
        if self.transforms is not None:
            oprot.writeFieldBegin('transforms', TType.LIST, 10)
            oprot.writeListBegin(TType.STRUCT, len(self.transforms))
            ...
            oprot.writeFieldEnd()
        if self.inputDataWindowType is not None:
            oprot.writeFieldBegin('inputDataWindowType', TType.STRING, 11)
            oprot.writeString(self.inputDataWindowType.encode('utf-8') if sys.version_info[0] == 2 else self.inputDataWindowType)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
TJobAbstract.thrift_spec = (
    ...
    (19, TType.I64, 'recordCount', None, None, ),  # 19
...
TImportJob.thrift_spec = (
    ...
    (8, TType.LIST, 'transforms', (TType.STRUCT, [TImportTransformConfiguration, None], False), None, ),  # 8
...
TImportFlow.thrift_spec = (
    ...
    (9, TType.I64, 'responsibleUserId', None, None, ),  # 9
    (10, TType.STRING, 'type', 'UTF8', None, ),  # 10
...
TTransform.thrift_spec = (
    ...
    (12, TType.STRING, 'scheduleType', 'UTF8', None, ),  # 12
    (13, TType.I64, 'minimumExecutionPeriod', None, None, ),  # 13
    (14, TType.STRING, 'inputDataWindowType', 'UTF8', None, ),  # 14
...
TExportJob.thrift_spec = (
    ...
    (10, TType.LIST, 'transforms', (TType.STRUCT, [TExportTransformConfiguration, None], False), None, ),  # 10
    (11, TType.STRING, 'inputDataWindowType', 'UTF8', None, ),  # 11
)
