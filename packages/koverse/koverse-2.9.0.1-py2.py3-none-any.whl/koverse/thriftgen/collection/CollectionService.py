            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i273 in range(_size269):
                        _elem274 = koverse.thriftgen.queryservice.ttypes.TSqlTableRow()
                        _elem274.read(iprot)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i303 in range(_size299):
                        _elem304 = koverse.thriftgen.ttypes.TLabel()
                        _elem304.read(iprot)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i317 in range(_size313):
                        _elem318 = TCollectionGroupPermission()
                        _elem318.read(iprot)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i331 in range(_size327):
                        _elem332 = TFieldMaskerDescription()
                        _elem332.read(iprot)
