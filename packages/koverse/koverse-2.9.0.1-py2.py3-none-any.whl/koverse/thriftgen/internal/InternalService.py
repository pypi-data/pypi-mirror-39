...
class Iface(object):
    ...
    def markTransformStarted(self, auth, jobId, yarnApplicationName):
        """
        Parameters:
         - auth
         - jobId
    ...
    def markTransformComplete(self, auth, jobId):
        """
        Parameters:
         - auth
         - jobId
    ...
    def updateTransformProgress(self, auth, jobId, progress):
        """
        Parameters:
         - auth
         - jobId
...
class Client(Iface):
    ...
    def markTransformStarted(self, auth, jobId, yarnApplicationName):
        ...
        Parameters:
         ...
         - yarnApplicationName
        """
        self.send_markTransformStarted(auth, jobId, yarnApplicationName)
        self.recv_markTransformStarted()

    def send_markTransformStarted(self, auth, jobId, yarnApplicationName):
        self._oprot.writeMessageBegin('markTransformStarted', TMessageType.CALL, self._seqid)
        args = markTransformStarted_args()
        args.auth = auth
        args.jobId = jobId
        args.yarnApplicationName = yarnApplicationName
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_markTransformStarted(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = markTransformStarted_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.ke is not None:
            raise result.ke
    ...
    def markTransformComplete(self, auth, jobId):
        ...
        Parameters:
         ...
         - jobId
        """
        self.send_markTransformComplete(auth, jobId)
        self.recv_markTransformComplete()

    def send_markTransformComplete(self, auth, jobId):
    ...
    def updateTransformProgress(self, auth, jobId, progress):
        ...
        Parameters:
         ...
         - progress
        """
        self.send_updateTransformProgress(auth, jobId, progress)
        self.recv_updateTransformProgress()

    def send_updateTransformProgress(self, auth, jobId, progress):
        self._oprot.writeMessageBegin('updateTransformProgress', TMessageType.CALL, self._seqid)
        args = updateTransformProgress_args()
        args.auth = auth
        args.jobId = jobId
    ...
    def recv_updateTransformProgress(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = updateTransformProgress_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.ke is not None:
            raise result.ke
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["markTransformStarted"] = Processor.process_markTransformStarted
        ...
        self._processMap["updateTransformProgress"] = Processor.process_updateTransformProgress
    ...
    def process_markTransformStarted(self, seqid, iprot, oprot):
        args = markTransformStarted_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = markTransformStarted_result()
        try:
            self._handler.markTransformStarted(args.auth, args.jobId, args.yarnApplicationName)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except koverse.thriftgen.ttypes.TKoverseException as ke:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("markTransformStarted", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_markTransformComplete(self, seqid, iprot, oprot):
        ...
        result = markTransformComplete_result()
        try:
            self._handler.markTransformComplete(args.auth, args.jobId)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except koverse.thriftgen.ttypes.TKoverseException as ke:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("markTransformComplete", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_updateTransformProgress(self, seqid, iprot, oprot):
        args = updateTransformProgress_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = updateTransformProgress_result()
        try:
            self._handler.updateTransformProgress(args.auth, args.jobId, args.progress)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except koverse.thriftgen.ttypes.TKoverseException as ke:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("updateTransformProgress", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class markTransformStarted_args(object):
    """
    Attributes:
     - auth
     - jobId
    ...
    def __init__(self, auth=None, jobId=None, yarnApplicationName=None,):
        self.auth = auth
        self.jobId = jobId
        self.yarnApplicationName = yarnApplicationName
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.yarnApplicationName = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('markTransformStarted_args')
        if self.auth is not None:
            oprot.writeFieldBegin('auth', TType.STRUCT, 1)
            self.auth.write(oprot)
            oprot.writeFieldEnd()
        if self.jobId is not None:
            ...
            oprot.writeFieldEnd()
        if self.yarnApplicationName is not None:
            oprot.writeFieldBegin('yarnApplicationName', TType.STRING, 3)
            oprot.writeString(self.yarnApplicationName.encode('utf-8') if sys.version_info[0] == 2 else self.yarnApplicationName)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(markTransformStarted_args)
markTransformStarted_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'auth', [koverse.thriftgen.security.ttypes.TAuthInfo, None], None, ),  # 1
    (2, TType.I64, 'jobId', None, None, ),  # 2
    (3, TType.STRING, 'yarnApplicationName', 'UTF8', None, ),  # 3
)


class markTransformStarted_result(object):
    """
    Attributes:
     - ke
     - ae
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('markTransformStarted_result')
        if self.ke is not None:
            oprot.writeFieldBegin('ke', TType.STRUCT, 1)
            self.ke.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(markTransformStarted_result)
markTransformStarted_result.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'ke', [koverse.thriftgen.ttypes.TKoverseException, None], None, ),  # 1
    (2, TType.STRUCT, 'ae', [koverse.thriftgen.security.ttypes.TAuthorizationException, None], None, ),  # 2
)
...
class markTransformComplete_args(object):
    """
    Attributes:
     - auth
     - jobId
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(markTransformComplete_args)
markTransformComplete_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'auth', [koverse.thriftgen.security.ttypes.TAuthInfo, None], None, ),  # 1
    (2, TType.I64, 'jobId', None, None, ),  # 2
)
...
class markTransformComplete_result(object):
    """
    Attributes:
     - ke
     - ae
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(markTransformComplete_result)
markTransformComplete_result.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'ke', [koverse.thriftgen.ttypes.TKoverseException, None], None, ),  # 1
    (2, TType.STRUCT, 'ae', [koverse.thriftgen.security.ttypes.TAuthorizationException, None], None, ),  # 2
)
...
class updateTransformProgress_args(object):
    """
    Attributes:
     - auth
     - jobId
    ...
    def __init__(self, auth=None, jobId=None, progress=None,):
        self.auth = auth
        self.jobId = jobId
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('updateTransformProgress_args')
        if self.auth is not None:
            oprot.writeFieldBegin('auth', TType.STRUCT, 1)
            self.auth.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(updateTransformProgress_args)
updateTransformProgress_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'auth', [koverse.thriftgen.security.ttypes.TAuthInfo, None], None, ),  # 1
    (2, TType.I64, 'jobId', None, None, ),  # 2
...
class updateTransformProgress_result(object):
    """
    Attributes:
     - ke
     - ae
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('updateTransformProgress_result')
        if self.ke is not None:
            oprot.writeFieldBegin('ke', TType.STRUCT, 1)
            self.ke.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(updateTransformProgress_result)
updateTransformProgress_result.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'ke', [koverse.thriftgen.ttypes.TKoverseException, None], None, ),  # 1
    (2, TType.STRUCT, 'ae', [koverse.thriftgen.security.ttypes.TAuthorizationException, None], None, ),  # 2
)
