            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i339 in range(_size335):
                        _elem340 = TImportTransformConfiguration()
                        _elem340.read(iprot)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i360 in range(_size356):
                        _elem361 = TImportTransformDescription()
                        _elem361.read(iprot)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i381 in range(_size377):
                        _elem382 = TRecordsProviderDescription()
                        _elem382.read(iprot)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i402 in range(_size398):
                        _elem403 = TSourceTypeDescription()
                        _elem403.read(iprot)
