...
import os
import random
import safewiselib.messages_pb2 as proto
import safewiselib.types_pb2 as proto_types
import safewiselib.tools as tools
import safewiselib.ckd_public as bip32

import hashlib
from safewiselib.client import SafeWISEClient
from safewiselib.tx_api import TxApiTestnet
from safewiselib.tx_api import TxApiBitcoin
from safewiselib.transport import get_transport


# This script has survived unmodified through several significant changes
# of the safewiselib library. While we want to have something like this,
# we're waiting on a couple more changes in order to implement this a little more cleanly.
# Wait for safewiselib v1.0.
