...
__doc__ = '''
    Use this script to cross-check that SafeWISE generated valid
    mnemonic sentence for given internal (SafeWISE-generated)
...
def main():
    ...
    trzr = binascii.unhexlify(input("Please enter SafeWISE-generated entropy (in hex): ").strip())
