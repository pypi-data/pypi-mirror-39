...
OP_ALLOW_TRUST = 7
OP_ACCOUNT_MERGE = 8
OP_INFLATION = 9  # Included for documentation purposes, not supported by SafeWISE
OP_MANAGE_DATA = 10
OP_BUMP_SEQUENCE = 11
...
def parse_transaction_bytes(tx_bytes):
    ...
    if unpacker.unpack_bool():
        max_timebound = 2**32 - 1  # max unsigned 32-bit int (safewise does not support the full 64-bit time value)
