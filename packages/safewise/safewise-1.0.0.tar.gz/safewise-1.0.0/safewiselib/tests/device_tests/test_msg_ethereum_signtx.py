...
class TestMsgEthereumSigntx(SafeWISETest):
    ...
    def test_ethereum_signtx_known_erc20_token(self):
        ...
        with self.client:
            ...
            # 200 000 000 in dec, divisibility of ADT = 9, safewise1 displays 0.2 ADT, SafeWISE T 200 000 000 Wei ADT
    ...
    def test_ethereum_signtx_unknown_erc20_token(self):
        ...
        with self.client:
            ...
            # since this token is unknown safewise should display "unknown token value"
