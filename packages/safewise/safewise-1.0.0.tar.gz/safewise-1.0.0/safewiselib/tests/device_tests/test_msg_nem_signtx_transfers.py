...
from safewiselib import nem
from safewiselib.tools import parse_path


# assertion data from T1
@pytest.mark.nem
class TestMsgNEMSignTx(SafeWISETest):
    ...
    def test_nem_signtx_xem_as_mosaic(self):
        ...
        # safewise should display 45 XEM (multiplied by amount)
    ...
    def test_nem_signtx_unknown_mosaic(self):
        ...
        # safewise should display warning about unknown mosaic and then dialog for 7000000 raw units of xxx.aa and 0 XEM
    ...
    def test_nem_signtx_known_mosaic(self):
        ...
        # safewise should display 0 XEM and 0.333 DIMTOK
    ...
    def test_nem_signtx_known_mosaic_with_levy(self):
        ...
        # safewise should display 0 XEM and 0.444 DIM and levy of 0.000444 DIM
    ...
    def test_nem_signtx_multiple_mosaics(self):
        ...
        # safewise should display warning, 6.06 XEM, 4000400 raw units of abc.mosaic (mosaics are merged)
        # and 222000 BREEZE
