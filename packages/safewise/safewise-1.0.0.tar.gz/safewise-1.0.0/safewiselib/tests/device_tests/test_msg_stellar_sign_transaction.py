...
#
# 7. Scroll down to the bottom and look at the "signatures" section. The SafeWISE should generate the same signature
#

from base64 import b64encode
from .common import SafeWISETest
from .conftest import SafeWISE_VERSION
from binascii import hexlify, unhexlify
from safewiselib import messages as proto
from safewiselib import stellar
from safewiselib.tools import parse_path
import pytest


@pytest.mark.stellar
@pytest.mark.xfail(SafeWISE_VERSION == 2, reason="T2 support is not yet finished")
class TestMsgStellarSignTransaction(SafeWISETest):
