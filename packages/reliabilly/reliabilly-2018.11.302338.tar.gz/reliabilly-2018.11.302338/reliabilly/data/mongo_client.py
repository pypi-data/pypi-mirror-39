...
from reliabilly.data import DataClient, get_query
from reliabilly.logger import Logger, log_exception
from reliabilly.models.base import BaseModel
from reliabilly.monitoring import monitor, MonitoringProvider
...
class MongoDataClient(DataClient):
    ...
    def __init__(self, **kwargs):
        ...
        host = kwargs.get(Constants.HOST, Settings.MONGO_URL)
        port = kwargs.get(Constants.PORT, Settings.MONGO_PORT)
        self.client = kwargs.get(Constants.CLIENT, MongoClient(host, port))
