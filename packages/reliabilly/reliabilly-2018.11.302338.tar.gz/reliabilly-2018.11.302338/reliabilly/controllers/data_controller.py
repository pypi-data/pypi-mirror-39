...
from reliabilly.controllers.data_handler import DataHandler
from reliabilly.data.mongo_client import MongoDataClient
from reliabilly.logger import LoggingProvider
...
from reliabilly.tools.version import version
...
class DataController(metaclass=Meta):
    ...
    def health(self, request):
        self.logger.info(get_log_string(request, Constants.GET_REQUEST, self.name, 'health'))
        return Constants.SUCCESS_RESPONSE_CODE, version()
