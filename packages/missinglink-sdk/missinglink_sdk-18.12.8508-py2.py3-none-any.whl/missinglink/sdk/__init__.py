...
def do_import():
    ...
    return KerasCallback, TensorFlowProject, PyTorchProject, PyCaffeCallback, ExperimentStopped, MissingLinkException
...
KerasCallback, TensorFlowProject, PyTorchProject, PyCaffeCallback, ExperimentStopped, MissingLinkException = do_import()
