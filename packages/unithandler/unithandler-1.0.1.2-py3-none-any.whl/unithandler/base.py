...
def adjust_unit(original, incoming):
    """
...
def _unit_bounded(boundary, value):
    """
...
class Unit(object):
    ...
    def _multiply_units(self, units):
        """
    ...
    def contains_inverse_unit(self, other):
        """
...
class UnitFloat(Unit, Real):
    ...
    def specified_representation(self):
        """
    ...
    def optimal_representation(self):
        """
    ...
    def specific_prefix(self, newprefix):
        """
...
class Constant(UnitFloat):
    ...
    @property
    def real(self):  # only define retrieval, not modification of real value
        return self._real
