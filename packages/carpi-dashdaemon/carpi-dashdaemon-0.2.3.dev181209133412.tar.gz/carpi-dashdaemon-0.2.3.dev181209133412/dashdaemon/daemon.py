...
class DashDaemon(Daemon):
    ...
    def __init__(self):
        ...
        self._current_values = ExpiringDict(max_len=100, max_age_seconds=5)
        self._running = False
    ...
    def startup(self):
        ...
        channels = [
            ...
            LIVE_INPUT_DATA_KEYS['car_state']
        ]
    ...
    def _process_vehicle_data(self, config: ConfigStore) -> dict:
        ...
        data = {
            ...
            LIVE_OUTPUT_DATA_KEYS['car_state']: values.get(LIVE_INPUT_DATA_KEYS['car_state'], 0x0)
        }
