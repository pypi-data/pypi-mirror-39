...
class TestHarmonicOscillator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        pm.sys.grid = 81                  #: Number of grid points (must be odd)
    ...
    def test_non_interacting_system_1(self):
        ...
        nt.assert_allclose(results.gs_ext_E, 0.5000, atol=5e-4)
    ...
    def test_interacting_system_1(self):
        ...
        nt.assert_allclose(results.gs_ext_E, 0.7532, atol=5e-4)
    ...
    def test_time_dependence(self):
        ...
        nt.assert_allclose(deltan, 5.43e-5, atol=1e-7)
        nt.assert_allclose(deltac, 4.94e-3, atol=1e-5)
...
class TestDoubleWell(unittest.TestCase):                                                         
    ...
    def test_stencil_three(self):
        ...
        nt.assert_allclose(results.gs_ext_E, -1.701, atol=5e-3)
    ...
    def test_stencil_five(self):                    
        ...
        nt.assert_allclose(results.gs_ext_E, -1.7006, atol=5e-4)
    ...
    def test_stencil_seven(self):                    
        ...
        nt.assert_allclose(results.gs_ext_E, -1.7006, atol=1e-4)
