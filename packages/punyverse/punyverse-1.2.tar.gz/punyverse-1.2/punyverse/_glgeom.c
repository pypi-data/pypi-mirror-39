...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "punyverse._glgeom", 
        "sources": [
            "punyverse/_glgeom.pyx"
        ]
    }, 
    "module_name": "punyverse._glgeom"
}
END: Cython Metadata */
...
static PyObject *__pyx_f_9punyverse_7_glgeom_flip_vertical(PyObject *, int, int, int __pyx_skip_dispatch); /*proto*/
#define __Pyx_MODULE_NAME "punyverse._glgeom"
extern int __pyx_module_is_main_punyverse___glgeom;
...
static PyObject *__pyx_pf_9punyverse_7_glgeom_bgr_to_rgb(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_buffer, int __pyx_v_width, int __pyx_v_height, int __pyx_v_alpha); /* proto */
static PyObject *__pyx_pf_9punyverse_7_glgeom_2flip_vertical(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_buffer, int __pyx_v_width, int __pyx_v_height); /* proto */
/* Late includes */
...
static PyObject *__pyx_pw_9punyverse_7_glgeom_1bgr_to_rgb(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
 ...
 */
  ...
  __pyx_t_1 = PyBytes_GET_SIZE(__pyx_v_buffer); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 13, __pyx_L1_error)
  __pyx_v_length = __pyx_t_1;

  /* "punyverse/_glgeom.pyx":14
 * cpdef bytes bgr_to_rgb(bytes buffer, int width, int height, bint alpha=0):
 *     cdef int length = len(buffer)
 *     cdef int depth = length / (width * height)             # <<<<<<<<<<<<<<
 *     cdef int depth2 = depth - alpha
 ...
 */
  ...
  else if (sizeof(int) == sizeof(long) && (!(((int)-1) > 0)) && unlikely(__pyx_t_2 == (int)-1)  && unlikely(UNARY_NEG_WOULD_OVERFLOW(__pyx_v_length))) {
 ...
 */
  __pyx_t_3 = PyBytes_FromStringAndSize(NULL, __pyx_v_length); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_v_final = __pyx_t_3;
  __pyx_t_3 = 0;

  /* "punyverse/_glgeom.pyx":17
 *     cdef int depth2 = depth - alpha
 *     cdef object final = PyBytes_FromStringAndSize(NULL, length)
 *     cdef char *result = PyBytes_AsString(final)             # <<<<<<<<<<<<<<
 *     cdef const char *source = PyBytes_AsString(buffer)
 ...
 */
  if (!(likely(PyBytes_CheckExact(__pyx_v_final))||((__pyx_v_final) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "bytes", Py_TYPE(__pyx_v_final)->tp_name), 0))) __PYX_ERR(0, 17, __pyx_L1_error)
  __pyx_v_result = PyBytes_AsString(((PyObject*)__pyx_v_final));

  /* "punyverse/_glgeom.pyx":18
 *     cdef object final = PyBytes_FromStringAndSize(NULL, length)
 *     cdef char *result = PyBytes_AsString(final)
 *     cdef const char *source = PyBytes_AsString(buffer)             # <<<<<<<<<<<<<<
 *     cdef int x, y, offset, i, row = width * depth
 ...
 */
      __pyx_v_offset = ((__pyx_v_y * __pyx_v_row) + (__pyx_v_x * __pyx_v_depth));

      /* "punyverse/_glgeom.pyx":23
 *         for x in xrange(width):
 *             offset = y * row + x * depth
 *             for i in xrange(depth2):             # <<<<<<<<<<<<<<
 *                 result[offset+i] = source[offset+depth2-i-1]
 ...
 */
        (__pyx_v_result[(__pyx_v_offset + __pyx_v_i)]) = (__pyx_v_source[(((__pyx_v_offset + __pyx_v_depth2) - __pyx_v_i) - 1)]);
      }
 ...
 *     return final
 */
      __pyx_t_12 = (__pyx_v_alpha != 0);
      if (__pyx_t_12) {

        /* "punyverse/_glgeom.pyx":26
 *                 result[offset+i] = source[offset+depth2-i-1]
 *             if alpha:
 *                 result[offset+depth2] = source[offset+depth2]             # <<<<<<<<<<<<<<
 *     return final
 * 
 */
        (__pyx_v_result[(__pyx_v_offset + __pyx_v_depth2)]) = (__pyx_v_source[(__pyx_v_offset + __pyx_v_depth2)]);
 ...
 */
  ...
  if (!(likely(PyBytes_CheckExact(__pyx_v_final))||((__pyx_v_final) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "bytes", Py_TYPE(__pyx_v_final)->tp_name), 0))) __PYX_ERR(0, 27, __pyx_L1_error)
...
/* Python wrapper */
static PyObject *__pyx_pw_9punyverse_7_glgeom_1bgr_to_rgb(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_9punyverse_7_glgeom_1bgr_to_rgb(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_buffer,&__pyx_n_s_width,&__pyx_n_s_height,&__pyx_n_s_alpha,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_width)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("bgr_to_rgb", 0, 3, 4, 1); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_height)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bgr_to_rgb", 0, 3, 4, 2); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "bgr_to_rgb") < 0)) __PYX_ERR(0, 12, __pyx_L3_error)
      }
    } else {
    ...
    if (values[3]) {
      __pyx_v_alpha = __Pyx_PyObject_IsTrue(values[3]); if (unlikely((__pyx_v_alpha == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 12, __pyx_L3_error)
    } else {
      __pyx_v_alpha = ((int)0);
    }
  }
  ...
  __Pyx_RaiseArgtupleInvalid("bgr_to_rgb", 0, 3, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 12, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("punyverse._glgeom.bgr_to_rgb", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_buffer), (&PyBytes_Type), 1, "buffer", 1))) __PYX_ERR(0, 12, __pyx_L1_error)
  __pyx_r = __pyx_pf_9punyverse_7_glgeom_bgr_to_rgb(__pyx_self, __pyx_v_buffer, __pyx_v_width, __pyx_v_height, __pyx_v_alpha);
...
static PyObject *__pyx_pf_9punyverse_7_glgeom_bgr_to_rgb(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_buffer, int __pyx_v_width, int __pyx_v_height, int __pyx_v_alpha) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __pyx_t_1 = __pyx_f_9punyverse_7_glgeom_bgr_to_rgb(__pyx_v_buffer, __pyx_v_width, __pyx_v_height, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 12, __pyx_L1_error)
...
static PyObject *__pyx_pw_9punyverse_7_glgeom_3flip_vertical(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_9punyverse_7_glgeom_flip_vertical(PyObject *__pyx_v_buffer, CYTHON_UNUSED int __pyx_v_width, int __pyx_v_height, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_length;
  PyObject *__pyx_v_final = 0;
  char *__pyx_v_result;
  char const *__pyx_v_source;
 ...
 */
  ...
  __pyx_t_1 = PyBytes_GET_SIZE(__pyx_v_buffer); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 31, __pyx_L1_error)
  __pyx_v_length = __pyx_t_1;

  /* "punyverse/_glgeom.pyx":32
 * cpdef bytes flip_vertical(bytes buffer, int width, int height):
 *     cdef int length = len(buffer)
 *     cdef object final = PyBytes_FromStringAndSize(NULL, length)             # <<<<<<<<<<<<<<
 *     cdef char *result = PyBytes_AsString(final)
 ...
 */
  if (!(likely(PyBytes_CheckExact(__pyx_v_final))||((__pyx_v_final) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "bytes", Py_TYPE(__pyx_v_final)->tp_name), 0))) __PYX_ERR(0, 33, __pyx_L1_error)
  __pyx_v_result = PyBytes_AsString(((PyObject*)__pyx_v_final));
 ...
 */
  ...
  else if (sizeof(int) == sizeof(long) && (!(((int)-1) > 0)) && unlikely(__pyx_v_height == (int)-1)  && unlikely(UNARY_NEG_WOULD_OVERFLOW(__pyx_v_length))) {
    PyErr_SetString(PyExc_OverflowError, "value too large to perform division");
    __PYX_ERR(0, 35, __pyx_L1_error)
  }
  __pyx_v_row = __Pyx_div_int(__pyx_v_length, __pyx_v_height);
 ...
 *     return final
 */
    __pyx_v_y2 = ((__pyx_v_height - __pyx_v_y1) - 1);
 ...
 *     return final
 */
    (void)(memcpy((__pyx_v_result + (__pyx_v_y1 * __pyx_v_row)), (__pyx_v_source + (__pyx_v_y2 * __pyx_v_row)), __pyx_v_row));
  }
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  if (!(likely(PyBytes_CheckExact(__pyx_v_final))||((__pyx_v_final) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "bytes", Py_TYPE(__pyx_v_final)->tp_name), 0))) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_INCREF(__pyx_v_final);
  __pyx_r = ((PyObject*)__pyx_v_final);
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("punyverse._glgeom.flip_vertical", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_final);
  __Pyx_XGIVEREF(__pyx_r);
...
/* Python wrapper */
static PyObject *__pyx_pw_9punyverse_7_glgeom_3flip_vertical(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_9punyverse_7_glgeom_3flip_vertical(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_buffer = 0;
  int __pyx_v_width;
  int __pyx_v_height;
  PyObject *__pyx_r = 0;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_buffer,&__pyx_n_s_width,&__pyx_n_s_height,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_width)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("flip_vertical", 1, 3, 3, 1); __PYX_ERR(0, 30, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_height)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("flip_vertical", 1, 3, 3, 2); __PYX_ERR(0, 30, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "flip_vertical") < 0)) __PYX_ERR(0, 30, __pyx_L3_error)
      }
    ...
    __pyx_v_buffer = ((PyObject*)values[0]);
    __pyx_v_width = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_width == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 30, __pyx_L3_error)
    __pyx_v_height = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_height == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 30, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("flip_vertical", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 30, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("punyverse._glgeom.flip_vertical", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_buffer), (&PyBytes_Type), 1, "buffer", 1))) __PYX_ERR(0, 30, __pyx_L1_error)
  __pyx_r = __pyx_pf_9punyverse_7_glgeom_2flip_vertical(__pyx_self, __pyx_v_buffer, __pyx_v_width, __pyx_v_height);
...
static PyObject *__pyx_pf_9punyverse_7_glgeom_2flip_vertical(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_buffer, int __pyx_v_width, int __pyx_v_height) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("flip_vertical", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_9punyverse_7_glgeom_flip_vertical(__pyx_v_buffer, __pyx_v_width, __pyx_v_height, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 30, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyMethodDef __pyx_methods[] = {
  {"bgr_to_rgb", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9punyverse_7_glgeom_1bgr_to_rgb, METH_VARARGS|METH_KEYWORDS, 0},
  {"flip_vertical", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9punyverse_7_glgeom_3flip_vertical, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec__glgeom(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__glgeom},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_glgeom(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_glgeom(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__glgeom(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__glgeom(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__glgeom(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_glgeom' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__glgeom(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_glgeom", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "punyverse._glgeom")) {
      if (unlikely(PyDict_SetItemString(modules, "punyverse._glgeom", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
