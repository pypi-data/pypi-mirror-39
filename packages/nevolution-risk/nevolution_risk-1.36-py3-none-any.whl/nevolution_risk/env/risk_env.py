...
from nevolution_risk.logic.graph import Graph
from nevolution_risk.view.risk_gui import Gui
...
class RiskEnv(gym.Env):
    ...
    def step(self, action):
        ...
        """
        player2_action = self.action_space.sample()
        ...
        observation = self.__graph_to_one_hot()
