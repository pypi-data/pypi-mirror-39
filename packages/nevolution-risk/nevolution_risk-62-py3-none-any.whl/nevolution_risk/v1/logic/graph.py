...
from nevolution_risk.constants.constants import DEFAULT_POS_PLAYER_1, DEFAULT_POS_PLAYER_2
...
class Graph(object):
    ...
    def __init__(self, pos_player_1=DEFAULT_POS_PLAYER_1, pos_player_2=DEFAULT_POS_PLAYER_2):
        self.nodes = []
        self.init_graph()
        self.nodes[pos_player_1].player = self.player1
        self.nodes[pos_player_2].player = self.player2
