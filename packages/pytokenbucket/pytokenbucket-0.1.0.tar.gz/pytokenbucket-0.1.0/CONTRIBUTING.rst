...
Python Token Bucket could always use more documentation, whether as part of the
official Python Token Bucket docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
$ py.test tests.test_pytokenbucket
