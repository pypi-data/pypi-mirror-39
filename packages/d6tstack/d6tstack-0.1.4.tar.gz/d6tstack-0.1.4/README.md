...
**Currently the pypi version is slightly outdated, best to install from github. If you can't run the above command, clone and install with `pip install . ` from the clone dir** 
