...
#define SHADYLIB_MINOR_VERSION 6  /*     values, to find out the version of the code that   */
...
SHADYLIB_FUNC(  ShaDyLib_Renderer ,    ShaDyLib_Renderer_New                              ,  ( unsigned int shaderProgram )                                           ,   RETURN( NULL, ( ShaDyLib_Renderer )new ShaDyLib::Renderer( shaderProgram ) )                                  )
...
SHADYLIB_FUNC(  int               ,    ShaDyLib_Renderer_QueryDACMax                      ,  ( ShaDyLib_Renderer r )                                                  ,   RETURN( 0, ShaDyLib::QueryDACMax() )                                                                          )
...
SHADYLIB_FUNC(  ShaDyLib_Window   ,    ShaDyLib_Window_New                                ,  ( int width, int height, int left, int top, int screen, int frame, int fullScreenMode, int visible, int openglContextVersion, const char * glslDirectory, const char * substitutions )  ,   RETURN( NULL, ( ShaDyLib_Window )new ShaDyLib::Window( width, height, left, top, screen, frame, fullScreenMode, visible, openglContextVersion, INPUTSTRING( glslDirectory ), INPUTSTRING( substitutions ) ) )       )
