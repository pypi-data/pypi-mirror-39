...
if __name__ == '__main__':
	...
	if sys.argv[ 1: ]:
		...
		cmdline = Shady.WorldConstructorCommandLine( width=720, height=720, top=0, fullScreenMode=False, frame=False, canvas=True )
		fakeTiming = cmdline.Option( 'fakeTiming', default='', type=str )
