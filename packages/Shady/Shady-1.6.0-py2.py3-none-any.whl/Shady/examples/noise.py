...
are not quite as beautiful and the noise will occasionally look
spatially correlated---this has been the case on Macs for us so far, 
because Macs do not allow our legacy GLSL 1.2 code to be mixed with
more modern OpenGL code.  In future versions of Shady we will aim to
break away from legacy OpenGL.
"""#.
import sys
import Shady
