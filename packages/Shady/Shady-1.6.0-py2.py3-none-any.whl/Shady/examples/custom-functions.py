...
if __name__ == '__main__':
	...
	sourceFileName = Shady.PackagePath( 'glsl/FragmentShader.c' )
	...
	float SquarewaveSignal( vec2 coords )
	{
		...
		for( float harmonic = 1.0; ; harmonic += 2.0 )
		{
			...
			y += sinusoid( coords, cyclesPerPixel, uSignalParameters[ 2 ], harmonic * uSignalParameters[ 3 ] ) * uSignalParameters[ 0 ] / harmonic;
		}
		return y;
	}
	""")
