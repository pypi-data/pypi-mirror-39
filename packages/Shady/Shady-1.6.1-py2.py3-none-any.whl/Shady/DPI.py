...
set frame to selectedScreen's frame()
set origin to item 1 of frame
set dimensions to item 2 of frame
return "{{\
...
'backingScaleFactor':" & selectedScreen's backingScaleFactor() & "\
	...
	out, err = [ x.decode( 'utf-8', errors='replace' ) for x in sp.communicate( applescript.encode( 'utf-8' ) ) ]
