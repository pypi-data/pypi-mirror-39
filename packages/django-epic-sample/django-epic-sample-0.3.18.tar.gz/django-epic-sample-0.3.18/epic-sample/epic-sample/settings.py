...
# Where to store cached data.  For development, we use the DummyCache
# (which doesn't cache anything).  For production, you'd want to use
# a real cache such as Memcached or Redis.
CACHES = {
    'default': {
