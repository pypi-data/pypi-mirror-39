...
from .constants import MODEL_TYPE, EXPLAINER_TYPE, CLASSIFICATION_TYPE, REGRESSION_TYPE, TABULAR
...
class TabularExplainer(BaseExplainer):
    ...
    def explain_model(self, model, initialization_examples, evaluation_examples=None,
        ...
        if self.run is not None:
            ...
            model_type = CLASSIFICATION_TYPE if classification else REGRESSION_TYPE
            self.run.add_properties({MODEL_TYPE: model_type, EXPLAINER_TYPE: TABULAR})
            ...
            if classification:
                ...
                self.assets_client.create_asset('explanation_asset',
                                                ...
                                                properties={'type': EXPLANATION,
                                                            'version_type': EXPLANATION_ASSET_TYPE})
