...
class DataReader():
    ...
    def get_pac_summary(self):
        ...
        get_header(self.website + '/campaign-finance-data/pac-and-party-summary-file-description/', PAC_DIR, 'header.txt')
    ...
    def get_candidate_master(self):
        ...
        get_header(self.website + '/campaign-finance-data/candidate-master-file-description/', CAN_DIR, 'header.txt')
