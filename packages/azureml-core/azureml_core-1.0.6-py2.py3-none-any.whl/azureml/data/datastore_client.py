...
class _DatastoreClient:
    ...
    def register_azure_blob_container(workspace, datastore_name, container_name, account_name, sas_token=None,
        ...
        """
        Register an Azure Blob Container to the datastore. You can choose to
        use SAS Token or Storage Account Key
    ...
    def register_azure_file_share(workspace, datastore_name, file_share_name, account_name, sas_token=None,
                                  ...
                                  create_if_not_exists=False):
        """
        Register an Azure File Share to the datastore. You can choose to
        use SAS Token or Storage Account Key
    ...
    def register_azure_sql_database(workspace, datastore_name, server_name, database_name, tenant_id, client_id,
                                    ...
                                    overwrite=False):
        """
        Initializes a new Azure SQL database Datastore
    ...
    def list(workspace):
        ...
        or list[AzureSqlDatabaseDatastore]
        """
        datastores = []
        ct = None
    ...
    def get_default(workspace):
        """
        Gets the default datastore for the workspace.
    ...
    def set_default(workspace, datastore_name):
        """
        Sets the default datastore for the workspace
