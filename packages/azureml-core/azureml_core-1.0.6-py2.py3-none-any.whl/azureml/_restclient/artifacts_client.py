...
class ArtifactsClient(WorkspaceClient):
    ...
    def get_artifact_by_run_id(self, origin, run_id):
        """
    ...
    def get_artifact_uri(self, origin, run_id, attachment_name, is_async=False):
        """
    ...
    def upload_artifact_content(self, origin, run_id, attachment_name, content=None,
