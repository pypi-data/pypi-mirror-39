...
def attach_project(workspace_object, cloud_project_name, project_path="."):
    ...
    run_history_client = RunHistoryClient.create(workspace_object, experiment_name)
    run_history_client._prepare_experiment()

    scope = "{}/{}/{}".format(run_history_client.get_workspace_uri_path(), PROJECT_KEY, experiment_name)
    # End temporary fix
