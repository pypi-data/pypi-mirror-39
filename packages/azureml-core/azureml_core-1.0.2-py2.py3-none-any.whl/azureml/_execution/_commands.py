...
def _get_run_details(project_object, project_context, run_config_object, run_id, snapshot_id=None):
    ...
    client = RunHistoryClient.create(project_object.workspace_object,
                                     project_object.history.name)
    ...
    run_dto = client.patch_run(run_id, create_run_dto)
    dto_as_dict = RunHistoryClient.dto_to_dictionary(run_dto)
...
def _cancel_local(project_object, run_id, project_context):
    ...
    run_history_client = RunHistoryClient(
        project_context.get_history_service_uri(),
        project_object.workspace_object._auth,
        project_object.workspace_object.subscription_id,
        project_object.workspace_object.resource_group,
        project_object.workspace_object.name,
        project_object.history.name)
    run_history_client.post_event_run_canceled(run_id)
