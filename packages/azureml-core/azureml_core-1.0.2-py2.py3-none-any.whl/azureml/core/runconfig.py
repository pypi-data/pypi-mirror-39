...
DEFAULT_CPU_IMAGE = "mcr.microsoft.com/azureml/base:0.2.0"
DEFAULT_GPU_IMAGE = "mcr.microsoft.com/azureml/base-gpu:0.2.0"
...
class RCranLibrary(AbstractRunConfigElement):
    ...
    # This is also the order for serialization into a file.
    _field_to_info_dict = collections.OrderedDict([
        ("package", _FieldInfo(list, "Coordinates.", list_element_type=str)),
        ("repo", _FieldInfo(list, "Repo", list_element_type=str))
    ])
...
class JarLibrary(AbstractRunConfigElement):
    ...
    # This is also the order for serialization into a file.
    _field_to_info_dict = collections.OrderedDict([
        ("library", _FieldInfo(list, "Coordinates.", list_element_type=str))
    ])
...
class RunConfiguration(AbstractRunConfigElement):
    ...
    def target(self):
        ...
        function :func:`azurml.core.workspace.Workspace.compute_targets`
