...
class ContainerImage(Image):
    ...
    def run(self, input_data, gpu_enabled=None):
        """
        ...
        :param gpu_enabled: Boolean flag for local image run with GPU
        ...
        container = start_docker_container(client, self.image_location, container_name, gpu_enabled)
