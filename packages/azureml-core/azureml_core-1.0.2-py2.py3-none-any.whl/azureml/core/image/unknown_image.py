...
# ---------------------------------------------------------
"""
azureml/core/image/unknown_image.py: Subclass of Image for when actual known Images are not imported
"""
...
class UnknownImage(Image):
    """
    Unknown image handling the scenarios where the SDK doesn't know the type of image
    but needs implemented functions (Image.list).
    """
    ...
    def _initialize(self, workspace, obj_dict):
        """
        Initializes the UnknownImage object
