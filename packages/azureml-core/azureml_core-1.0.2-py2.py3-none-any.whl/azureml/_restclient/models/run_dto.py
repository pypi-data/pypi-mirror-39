...
class RunDto(Model):
    ...
    def __init__(self, run_number=None, root_run_id=None, experiment_id=None, created_utc=None, user_id=None, token=None, token_expiry_time_utc=None, run_id=None, parent_run_id=None, status=None, start_time_utc=None, end_time_utc=None, heartbeat_enabled=None, run_definition=None, name=None, description=None, hidden=None, run_type=None, properties=None, script_name=None, target=None, tags=None):
