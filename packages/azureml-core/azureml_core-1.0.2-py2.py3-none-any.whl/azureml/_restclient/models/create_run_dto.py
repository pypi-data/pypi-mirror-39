...
class CreateRunDto(Model):
    ...
    def __init__(self, run_id=None, parent_run_id=None, status=None, start_time_utc=None, end_time_utc=None, heartbeat_enabled=None, run_definition=None, name=None, description=None, hidden=None, run_type=None, properties=None, script_name=None, target=None, tags=None):
