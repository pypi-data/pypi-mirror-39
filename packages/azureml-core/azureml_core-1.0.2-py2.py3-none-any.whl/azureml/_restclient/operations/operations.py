...
class Operations(object):
    ...
    def get(
        ...
        return deserialized
    get.metadata = {'url': '/api/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspace}/operations/{id}'}
