...
class AssetOperations(object):
    ...
    :ivar api_version: The version of the Microsoft.MachineLearning resource provider API to use. Constant value: "2018-03-01-preview".
    """
    ...
    def create(
        ...
        return deserialized
    create.metadata = {'url': '/api/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspace}/assets'}

    def list_query(
            self, subscription_id, resource_group_name, workspace, runid=None, project_id=None, name=None, tag=None, count=None, skip_token=None, order_by=None, custom_headers=None, raw=False, **operation_config):
        ...
        return deserialized
    list_query.metadata = {'url': '/api/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspace}/assets'}
    ...
    def patch(
        ...
        return deserialized
    patch.metadata = {'url': '/api/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspace}/assets/{id}'}
    ...
    def query_by_id(
        ...
        return deserialized
    query_by_id.metadata = {'url': '/api/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspace}/assets/{id}'}
    ...
    def delete(
        ...
        if raw:
            ...
            return client_raw_response
    delete.metadata = {'url': '/api/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspace}/assets/{id}'}
