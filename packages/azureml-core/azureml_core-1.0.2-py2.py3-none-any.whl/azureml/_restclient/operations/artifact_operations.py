...
class ArtifactOperations(object):
    ...
    def create(
        ...
        return deserialized
    create.metadata = {'url': '/artifact/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/artifacts/metadata'}
    ...
    def get(
        ...
        return deserialized
    get.metadata = {'url': '/artifact/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/artifacts/metadata/{origin}/{container}/{path}'}
    ...
    def delete_meta_data(
        ...
        if raw:
            ...
            return client_raw_response
    delete_meta_data.metadata = {'url': '/artifact/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/artifacts/metadata/{origin}/{container}/{path}'}

    def list_in_container(
            self, subscription_id, resource_group_name, workspace_name, origin, container, custom_headers=None, raw=False, **operation_config):
        """
        ...
        return deserialized
    list_in_container.metadata = {'url': '/artifact/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/artifacts/origins/{origin}/containers/{container}'}
    ...
    def list_in_path(
        ...
        return deserialized
    list_in_path.metadata = {'url': '/artifact/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/artifacts/origins/{origin}/containers/{container}/{path}'}
    ...
    def download(
        ...
        return deserialized
    download.metadata = {'url': '/artifact/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/artifacts/content/{origin}/{container}/{path}'}
    ...
    def upload(
        ...
        return deserialized
    upload.metadata = {'url': '/artifact/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/artifacts/content/{origin}/{container}/{path}'}
    ...
    def get_content_information(
        ...
        return deserialized
    get_content_information.metadata = {'url': '/artifact/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/artifacts/contentinfo/{origin}/{container}/{path}'}
    ...
    def list_sas_by_prefix(
        ...
        return deserialized
    list_sas_by_prefix.metadata = {'url': '/artifact/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/artifacts/prefix/contentinfo/{origin}/{container}/{path}'}
    ...
    def batch_ingest_from_sas(
        ...
        return deserialized
    batch_ingest_from_sas.metadata = {'url': '/artifact/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/artifacts/batch/ingest/containersas/{origin}/{container}'}
    ...
    def batch_create_empty_artifacts(
        ...
        return deserialized
    batch_create_empty_artifacts.metadata = {'url': '/artifact/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/artifacts/batch/metadata/{origin}/{container}'}
    ...
    def delete_meta_data_in_container(
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    delete_meta_data_in_container.metadata = {'url': '/artifact/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/artifacts/batch/{origin}/{container}'}
