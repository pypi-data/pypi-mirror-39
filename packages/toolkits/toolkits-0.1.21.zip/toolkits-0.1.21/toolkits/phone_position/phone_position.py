...
__author__ = 'lovedboy'
__url__ = "SourceWeb: https://github.com/ls0f/phone"
...
class PhonePosition(object):
    ...
    def _format_phone_content(phone_num, record_content, phone_type):
        ...
        return {
            ...
            "zip_code": zip_code,
            "area_code": area_code,
            "phone_type": PhonePosition.get_phone_no_type(phone_type)
        }
    ...
    def _lookup_phone(self, phone_num):
        ...
        while left <= right:
            ...
            if cur_phone > int_phone:
                ...
                return PhonePosition._format_phone_content(phone_num, record_content,
                                                   phone_type)
