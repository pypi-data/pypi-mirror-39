...
def make_clearbit_person_gcs_payload(request=None):
    ...
    if p["gravatar_url_titles"] is not None:
    ...
    if p["gravatar_urls"] is not None:
    ...
    print(p["gravatar_avatar_urls"])
    if p["gravatar_avatar_types"] is not None:
    ...
    if p["gravatar_avatar_urls"] is not None:
