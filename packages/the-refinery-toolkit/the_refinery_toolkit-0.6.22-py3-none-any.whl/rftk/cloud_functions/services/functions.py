...
def upload_to_gcs(payload=None, project_name=None,bucket_name=None,
    ...
    try:
        ...
        with fs.open(bucket_name + "/" + file_name + file_suffix,
                     "w") as f:
...
def download_from_gcs(bucket_name=None, project_name=None,
                      file_name=None):
    """Utility function to upload the json to GCS."""
    ...
    try:
        ...
        payload = fs.cat(bucket_name + "/" + file_name)
        return payload
