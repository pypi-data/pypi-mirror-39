...
from xplant.engine import XPlant, LeafNodeMixin
from xplant.xml import XmlElement
...
class Html4Plant(XPlant):
    _root_node_type = Html4Node


class Html5Plant(XPlant):
    _root_node_type = Html5Node
