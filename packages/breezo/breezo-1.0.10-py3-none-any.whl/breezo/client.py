...
class ConfigClient:
    ...
    def __get_service_url(service_name):
        ...
        return 'https://{}/services/_name/{}?tenant={}'.format(breezo_url, quote(service_name), breezo_env)

    @staticmethod
    def __get_properties_url(service_id):
        breezo_url, breezo_env = ConfigClient.fetch_env_tuple()
        return 'https://{}/services/{}/properties?tenant={}'.format(breezo_url, service_id, breezo_env)
