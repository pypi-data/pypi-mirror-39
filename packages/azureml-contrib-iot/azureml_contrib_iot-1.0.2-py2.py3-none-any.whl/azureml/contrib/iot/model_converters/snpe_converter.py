...
from ._model_convert_request import ModelConvertRequest
from ._model_convert_client import ModelConvertClient
from .model_convert_operation import ModelConvertOperation
...
class SnpeConverter(object):
    ...
    def convert_tf_model(workspace,
        ...
        """
        Uses snpe-tensorflow-to-dlc to convert a TensorFlow model into an SNPE DLC file.
        ...
        request.compilation_options[_mirror_input_folder] = True
