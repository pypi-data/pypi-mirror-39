...
class IotImageConfig(ImageConfig):
    ...
    def validate_configuration(self):
        ...
        """
        Validates parameters to constructor.
        Validate the parameters in the order that they're passed to the constructor so the user can build up a
        valid object.
    ...
    def deserialize(workspace, image_payload):
        """
        Convert a json object into an IotContainerImage object. Will fail if the provided workspace
        is not the workspace the image is registered under.
