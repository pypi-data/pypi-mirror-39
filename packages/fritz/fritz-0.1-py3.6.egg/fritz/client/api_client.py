...
class FritzClientBase(object):
    """Fritz Client to interact with Fritz Client API."""

    def __init__(self, api_key, base_url):
        """
        Args:
            api_key (str): Account API Key for Fritz Client API.
...
class FritzClient(FritzClientBase):
    # I added this as a subclass so that we can build a public version
    # without having to include the paths of our staging/local environments.
