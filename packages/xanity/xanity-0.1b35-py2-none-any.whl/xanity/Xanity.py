...
class Xanity:
    ...
    def _parse_args(self, clargs=None):
        ...
        if hasattr(self, 'args') and hasattr(self.args, 'action'):
        ...
        if not self.action:
            if hasattr(self, 'args') and hasattr(self.args, 'action') and self.args.action in dir(self):
...
########################################################
    ...
    def experiment_parameters(self, parameters_dict):
        ...
        caller_name = file2mod(traceback.extract_stack(limit=3)[1][0])
