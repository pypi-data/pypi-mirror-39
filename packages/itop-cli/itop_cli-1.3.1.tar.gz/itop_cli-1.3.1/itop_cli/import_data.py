...
class Import:
    ...
    def __init__(self, itop, class_name, data, search_keys="name"):
        self.itop = itop
    ...
    def get_(self, element):
        ...
        if found == "0":
            return None
        return response["objects"].values()
...
def import_data(itop, class_name, data, search_keys="name"):
    """
    Imports data
    ...
    :return: None
    """
    Import(itop, class_name, data, search_keys).import_data()
