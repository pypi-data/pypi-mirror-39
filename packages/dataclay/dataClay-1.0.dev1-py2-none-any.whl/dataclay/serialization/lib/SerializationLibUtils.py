...
def serialize_for_db_gc(instance, ignore_user_types, ifacebitmaps, return_none_if_no_ref_counting=False):
    """
...
def serialize_for_db_gc_not_dirty(instance, ignore_user_types, ifacebitmaps, return_none_if_no_ref_counting=True):
    """
