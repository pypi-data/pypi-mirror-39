...
def isInteger(n, tolerance=1e-4):
    ...
    def egyptFractions(self, eF=3, lim=10):
        ...
        while k > -1:
            ...
            # si on arrive sur l'avant-dernier
                ...
                if f[eF - 1] >= 1e-10 and isInteger(1 / f[eF - 1], tolerance=self.tolerance):
                ...
                k += 1
                d, f = dvtDecimal.__augmentation(d, f, k, 1 + max(d[k - 1], int(1 / f[k])) )
